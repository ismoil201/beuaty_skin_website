    ...
    els.profileContent.innerHTML = `
      <div class="app-profile-page ${authStore.profileLoading ? "is-loading" : ""}">
        ...
        <nav class="app-profile-menu" aria-label="${escapeHtml(t("profile.settings"))}">
          ${ProfileMenuRow({ action: "promotions", icon: menuIcons.promotions, label: t("profile.promotions") })}
          ${ProfileMenuRow({ action: "help", icon: menuIcons.help, label: t("profile.help") })}
          ${ProfileMenuRow({ action: "news", icon: menuIcons.news, label: t("profile.news") })}
          ${ProfileMenuRow({ action: "language", icon: menuIcons.language, label: t("profile.language"), trailing: `<span>${escapeHtml(getLanguageLabel())}</span>` })}
          ${ProfileMenuRow({ action: "privacy", icon: menuIcons.privacy, label: t("profile.privacy") })}
          ${ProfileMenuRow({ action: "terms", icon: menuIcons.terms, label: t("profile.terms") })}
        </nav>
