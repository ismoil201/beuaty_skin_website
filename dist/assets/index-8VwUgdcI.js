import{G as Ba,s as Oa,i as xa,g as Na}from"./firebase-kble8lgk.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function r(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(s){if(s.ep)return;s.ep=!0;const l=r(s);fetch(s.href,l)}})();const S=Object.freeze({productionApiBaseUrl:"https://cosmetic-server-production.up.railway.app",defaultPageSize:24,searchDebounceMs:300,storageKeys:Object.freeze({accessToken:"zaven_token",legacyAccessToken:"accessToken",user:"zaven_user",legacyUser:"user",role:"role",baseUrl:"zaven_base_url",sessionId:"zaven_session_id",recentProducts:"zaven_recent_products",language:"beauty_skin_language"}),placeholderImage:"https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=800&q=80"});S.productionApiBaseUrl.replace(/\/+$/,"");function Fa(e){const t=String(e||"").trim().replace(/\/+$/,"").toLowerCase();return t?t.includes("localhost")||t.includes("127.0.0.1")||t.includes("0.0.0.0")||t.startsWith("file:"):!1}function vt(e){const t=String(e||"").trim().replace(/\/+$/,"");return!t||t.includes("cosmetic-server-production.up.railway.app")||Fa(t)?"":t}function za(e,t){try{return JSON.parse(localStorage.getItem(e)||"null")||t}catch{return t}}function dt(){return localStorage.getItem(S.storageKeys.accessToken)||localStorage.getItem(S.storageKeys.legacyAccessToken)||""}function Ha(){let e=localStorage.getItem(S.storageKeys.sessionId);return e||(e=`web-${Date.now()}-${Math.random().toString(36).slice(2,10)}`,localStorage.setItem(S.storageKeys.sessionId,e)),e}function Ua(){const e=localStorage.getItem(S.storageKeys.legacyAccessToken);!localStorage.getItem(S.storageKeys.accessToken)&&e&&localStorage.setItem(S.storageKeys.accessToken,e);const r=localStorage.getItem(S.storageKeys.legacyUser);!localStorage.getItem(S.storageKeys.user)&&r&&localStorage.setItem(S.storageKeys.user,r)}function Va(){const e=localStorage.getItem(S.storageKeys.baseUrl)||"",t=vt(e);t!==e.trim().replace(/\/+$/,"")&&(t?localStorage.setItem(S.storageKeys.baseUrl,t):localStorage.removeItem(S.storageKeys.baseUrl))}const o={homeView:null,languageSelect:null,grid:null,dealsGrid:null,homeApiSections:null,recentlyViewedSection:null,recentlyViewedGrid:null,banners:null,announcements:null,categoryToolbar:null,quickCategoryGrid:null,catalogButton:null,catalogDrawer:null,closeCatalog:null,catalogList:null,status:null,dealsStatus:null,productsMode:null,dealsMode:null,title:null,loadMore:null,searchForm:null,searchInput:null,cartButton:null,cartDrawer:null,closeCart:null,cartItems:null,cartCount:null,cartSummary:null,cartTotal:null,authDialog:null,authForm:null,authTitle:null,loginTab:null,registerTab:null,loginFields:null,registerFields:null,authSubmit:null,authMessage:null,googleLoginButton:null,loginButton:null,favoritesButton:null,favoritesCount:null,favoritesDialog:null,favoritesSummary:null,favoritesContent:null,refreshFavorites:null,closeFavorites:null,notificationsButton:null,notificationsCount:null,notificationsDrawer:null,notificationsSummary:null,notificationsContent:null,refreshNotifications:null,closeNotifications:null,loginEmail:null,loginPassword:null,registerFullName:null,registerEmail:null,registerPhone:null,registerPassword:null,registerConfirmPassword:null,profileDrawer:null,closeProfile:null,profileContent:null,apiDialog:null,apiForm:null,apiButton:null,baseUrl:null,detailDialog:null,detailContent:null,productDetailPage:null,productDetailPageContent:null,checkoutButton:null,checkoutDialog:null,checkoutForm:null,checkoutHint:null,receiverSelect:null,addressSelect:null,checkoutContent:null,refreshHome:null,ordersButton:null,ordersDialog:null,ordersContent:null,refreshOrders:null,closeOrders:null,myReviewsDialog:null,myReviewsContent:null,myReviewsSummary:null,refreshMyReviews:null,closeMyReviews:null,writeReviewDialog:null,writeReviewForm:null,closeWriteReview:null,writeReviewProduct:null,reviewRatingSelector:null,reviewContent:null,reviewImages:null,reviewImageFiles:null,reviewUploadStatus:null,reviewFormMessage:null,submitReviewButton:null,supportButton:null,supportDialog:null,supportContent:null,privacyDialog:null,privacyContent:null,termsDialog:null,termsContent:null,toast:null,brandViewContent:null,cartExtras:null,cartStickyProgress:null,megaMenu:null,popularSearchesChips:null},Ka={homeView:"homeView",languageSelect:"languageSelect",grid:"productGrid",dealsGrid:"dealsGrid",homeApiSections:"homeApiSections",recentlyViewedSection:"recentlyViewedSection",recentlyViewedGrid:"recentlyViewedGrid",banners:"banners",announcements:"announcements",categoryToolbar:"categoryToolbar",quickCategoryGrid:"quickCategoryGrid",catalogButton:"catalogButton",catalogDrawer:"catalogDrawer",closeCatalog:"closeCatalog",catalogList:"catalogList",status:"productStatus",dealsStatus:"dealsStatus",productsMode:"productsMode",dealsMode:"dealsMode",title:"productsTitle",loadMore:"loadMore",searchForm:"searchForm",searchInput:"searchInput",cartButton:"cartButton",cartDrawer:"cartDrawer",closeCart:"closeCart",cartItems:"cartItems",cartCount:"cartCount",cartSummary:"cartSummary",cartTotal:"cartTotal",authDialog:"authDialog",authForm:"authForm",authTitle:"authTitle",loginTab:"loginTab",registerTab:"registerTab",loginFields:"loginFields",registerFields:"registerFields",authSubmit:"authSubmit",authMessage:"authMessage",googleLoginButton:"googleLoginButton",loginButton:"loginButton",favoritesButton:"favoritesButton",favoritesCount:"favoritesCount",favoritesDialog:"favoritesDialog",favoritesSummary:"favoritesSummary",favoritesContent:"favoritesContent",refreshFavorites:"refreshFavorites",closeFavorites:"closeFavorites",notificationsButton:"notificationsButton",notificationsCount:"notificationsCount",notificationsDrawer:"notificationsDrawer",notificationsSummary:"notificationsSummary",notificationsContent:"notificationsContent",refreshNotifications:"refreshNotifications",closeNotifications:"closeNotifications",loginEmail:"loginEmail",loginPassword:"loginPassword",registerFullName:"registerFullName",registerEmail:"registerEmail",registerPhone:"registerPhone",registerPassword:"registerPassword",registerConfirmPassword:"registerConfirmPassword",profileDrawer:"profileDrawer",closeProfile:"closeProfile",profileContent:"profileContent",apiDialog:"apiDialog",apiForm:"apiForm",apiButton:"apiButton",baseUrl:"baseUrl",detailDialog:"detailDialog",detailContent:"detailContent",productDetailPage:"productDetailPage",productDetailPageContent:"productDetailPageContent",checkoutButton:"checkoutButton",checkoutDialog:"checkoutDialog",checkoutForm:"checkoutForm",checkoutHint:"checkoutHint",receiverSelect:"receiverSelect",addressSelect:"addressSelect",checkoutContent:"checkoutContent",refreshHome:"refreshHome",ordersButton:"ordersButton",ordersDialog:"ordersDialog",ordersContent:"ordersContent",refreshOrders:"refreshOrders",closeOrders:"closeOrders",myReviewsDialog:"myReviewsDialog",myReviewsContent:"myReviewsContent",myReviewsSummary:"myReviewsSummary",refreshMyReviews:"refreshMyReviews",closeMyReviews:"closeMyReviews",writeReviewDialog:"writeReviewDialog",writeReviewForm:"writeReviewForm",closeWriteReview:"closeWriteReview",writeReviewProduct:"writeReviewProduct",reviewRatingSelector:"reviewRatingSelector",reviewContent:"reviewContent",reviewImages:"reviewImages",reviewImageFiles:"reviewImageFiles",reviewUploadStatus:"reviewUploadStatus",reviewFormMessage:"reviewFormMessage",submitReviewButton:"submitReviewButton",supportButton:"supportButton",supportDialog:"supportDialog",supportContent:"supportContent",privacyDialog:"privacyDialog",privacyContent:"privacyContent",termsDialog:"termsDialog",termsContent:"termsContent",toast:"toast",brandViewContent:"brandViewContent",cartExtras:"cartExtras",cartStickyProgress:"cartStickyProgress",megaMenu:"megaMenu",popularSearchesChips:"popularSearchesChips"};function Ga(){Object.entries(Ka).forEach(([e,t])=>{o[e]=document.getElementById(t)})}function Te(e){const t={...e},r={};for(const a of Object.keys(t)){Object.defineProperty(r,a,{get(){return t[a]},set(l){t[a]=l},enumerable:!0,configurable:!0});const s=`set${a.charAt(0).toUpperCase()}${a.slice(1)}`;r[s]=l=>{t[a]=l}}return r}const h=Te({baseUrl:vt(localStorage.getItem(S.storageKeys.baseUrl)||""),lastApiError:"",currentRoute:"home",sessionId:Ha(),impressionsSent:new Set,impressionObserver:null,isLoading:!1,searchTimer:null,supportFaqOpen:0,flashSaleEnd:null,currentSearchQuery:"",currentGridScreen:"home",orders:[],ordersLoading:!1,ordersError:"",selectedOrder:null,selectedOrderHistory:[],orderDetailLoading:!1,orderDetailError:"",orderHistoryWarning:"",savedForLater:[]});function jr(){var e;try{return((e=import.meta)==null?void 0:e.env)??{}}catch{return{}}}function ot(){return!!jr().DEV}function ja(e){try{return JSON.parse(e)}catch{return e}}function Wa(e,t){return typeof e=="string"&&e.trim()?e:(e==null?void 0:e.message)||(e==null?void 0:e.error)||`API xatosi: HTTP ${t}`}let xe={onUnauthorized:()=>{},onLoginRequired:()=>{},showToast:()=>{}};function Ya(e={}){xe={...xe,...e}}function _a(e,t){const r=e.startsWith("/")?e:`/${e}`,a=h.baseUrl?h.baseUrl.replace(/\/+$/,""):"",s=new URL(`${a}${r}`,window.location.origin);return t&&Object.entries(t).forEach(([l,d])=>{d!=null&&d!==""&&s.searchParams.set(l,d)}),s.toString()}async function $(e,t={}){const{query:r,showError:a=!0,requireAuth:s=!1,silentAuth:l=!1,timeoutMs:d=0,signal:u,...p}=t,m=_a(e,r),f={Accept:"application/json",...p.body?{"Content-Type":"application/json"}:{},...p.headers||{}},k=dt();if(k&&(f.Authorization=`Bearer ${k}`),s&&!k)return h.lastApiError="Please login to continue",xe.onLoginRequired(),null;if(ot()){const E=jr();console.info("[API REQUEST]",{path:e,requestUrl:m,method:p.method||"GET",query:r,baseUrl:h.baseUrl,host:window.location.host,mode:E.MODE,envBase:E.VITE_API_BASE_URL})}const I=new AbortController;let v=!1;const R=d>0?setTimeout(()=>{v=!0,I.abort()},d):null;u&&(u.aborted?I.abort():u.addEventListener("abort",()=>I.abort(),{once:!0}));try{h.lastApiError="";const E=await fetch(m,{...p,headers:f,signal:I.signal}),N=await E.text(),x=N?ja(N):null;if(ot()&&console.info("[API RESPONSE]",{requestUrl:m,status:E.status,ok:E.ok,payload:x}),E.status===401)return h.lastApiError="Session expired. Please login again.",l||xe.onUnauthorized(),null;if(!E.ok){const U=Wa(x,E.status);return h.lastApiError=U,a&&xe.showToast(U,"error"),null}return x}catch(E){return(E==null?void 0:E.name)==="AbortError"?h.lastApiError=v?"So‘rov vaqti tugadi. Qayta urinib ko‘ring.":"So‘rov bekor qilindi.":h.lastApiError="Server bilan aloqa bo‘lmadi",ot()&&console.error("[API ERROR]",{requestUrl:m,error:E}),a&&(E==null?void 0:E.name)!=="AbortError"&&xe.showToast("Server bilan aloqa vaqtincha ishlamayapti.","error"),null}finally{R&&clearTimeout(R)}}const Ja=4200,Qa=4;let Z=null;function Za(){return Z||(Z=document.getElementById("toast"),Z?(Z.classList.add("toast-host"),Z.setAttribute("aria-relevant","additions")):(Z=document.createElement("div"),Z.id="toast",Z.className="toast-host",Z.setAttribute("role","status"),Z.setAttribute("aria-live","polite"),Z.setAttribute("aria-relevant","additions"),document.body.appendChild(Z)),Z)}const Sr={success:"✓",error:"✕",warning:"!",info:"i"};function T(e,t="info"){var k;const r=String(e||"").trim();if(!r)return;const a=Za(),s=Sr[t]?t:"info",l=document.createElement("div");l.className=`toast-item toast-${s}`,l.setAttribute("role","status");const d=document.createElement("span");d.className="toast-icon",d.setAttribute("aria-hidden","true"),d.textContent=Sr[s];const u=document.createElement("span");u.className="toast-message",u.textContent=r;const p=document.createElement("button");for(p.type="button",p.className="toast-close",p.setAttribute("aria-label","Close"),p.textContent="×",l.append(d,u,p),a.appendChild(l);a.children.length>Qa;)(k=a.firstElementChild)==null||k.remove();let m=0;const f=()=>{clearTimeout(m),l.classList.remove("show"),window.setTimeout(()=>l.remove(),220)};p.addEventListener("click",f),m=window.setTimeout(f,Ja),requestAnimationFrame(()=>{requestAnimationFrame(()=>l.classList.add("show"))})}const P=Te({accessToken:dt(),user:za(S.storageKeys.user,null),role:localStorage.getItem(S.storageKeys.role)||"",authMode:"login",authLoading:!1,profileEditing:!1,profileLoading:!1,profileMenuOpen:!1,profileLoadSeq:0}),c=Te({products:[],todayDeals:[],categories:[],banners:[],announcements:[],recommendedProducts:[],recommendedSimilar:[],recommendedOthers:[],recommendationsLoading:!1,recommendationsError:"",selectedCategory:"ALL",selectedDetailProduct:null,selectedVariantId:null,selectedBrand:null,sourceProducts:[],filterFacets:{brands:[],colors:[],sizes:[],maxPrice:5e6},filters:null,recentlyViewed:[],productReviewsByProductId:{},productReviewsLoading:{},productReviewsError:{},myReviews:[],myReviewsLoading:!1,myReviewsError:"",reviewSubmitting:!1,reviewDraft:null,reviewRating:5,reviewSort:"newest",reviewFilterRating:0,reviewSearchQuery:"",reviewHelpfulIds:new Set,uploadingReviewImages:!1,detailLoading:!1,detailError:"",pdpGalleryIndex:0,pdpActiveTab:"description",selectedQuantity:1,homeLoadedFromApi:!1,demoCategories:!1,demoProducts:!1,demoDeals:!1,homeApiSections:null,compareIds:[],compareProducts:[],feedLoading:!1,feedPage:0}),b=Te({cart:[],cartItems:[],cartLoading:!1,cartError:"",cartCount:0,cartTotal:0,cartUpdatingIds:new Set,cartSelectedIds:new Set,cartKnownItemIds:new Set,addingProductIds:new Set,cartCoupon:"",cartCouponDiscount:0}),C=Te({favoriteProducts:[],favoriteIds:new Set,favoritesLoading:!1,favoritesError:"",favoritesCount:0}),D=Te({notifications:[],notificationsLoading:!1,notificationsError:"",unreadCount:0,unreadCountLoading:!1,notificationUpdatingIds:new Set}),g=Te({receivers:[],addresses:[],selectedReceiverId:null,selectedAddressId:null,checkoutLoading:!1,orderSubmitting:!1,checkoutError:"",orderSuccess:null,checkoutStep:1,checkoutAddressPickerOpen:!1,checkoutReceiverPickerOpen:!1,checkoutCouponOpen:!1,checkoutConfirmOpen:!1});function Wt(){return{currentRoute:h.currentRoute,selectedDetailProduct:c.selectedDetailProduct}}const Wr={SKINCARE:"Skincare",MAKEUP:"Makeup",COLLAGEN:"Collagen",HAIR_CARE:"Hair Care",FRAGRANCE:"Fragrance",TOP:"Top",OUTER:"Outer",PANTS:"Pants",SHOES:"Shoes",BAG:"Bag",ACCESSORY:"Accessory"},Yt=Object.freeze(["uz","en","ru","ko"]),Ze="uz",Cr=Object.freeze([{category:"SKINCARE",icon:"S"},{category:"MAKEUP",icon:"M"},{category:"COLLAGEN",icon:"C"},{category:"HAIR_CARE",icon:"H"},{category:"FRAGRANCE",icon:"F"},{category:"BAG",icon:"B"},{category:"SHOES",icon:"S"},{category:"ACCESSORY",icon:"A"}]),Yr={"header.location":"📍 Toshkent","header.extraLinks":"Qo‘shimcha havolalar","header.pickupPoints":"Punktlar","header.sell":"Sotuvchi bo‘lish","header.support":"Savol-javob","header.orders":"Buyurtmalar","header.language":"Til","header.currency":"Valyuta","header.theme":"Mavzu","header.homeAria":"BEAUTY SKIN KOREA bosh sahifa","header.openCatalog":"Katalogni ochish","header.catalog":"Katalog","header.search":"Qidirish","header.searchPlaceholder":"Mahsulot va kategoriyalarni qidirish","header.mainMenu":"Asosiy menyu","header.loginProfile":"Profil yoki kirish","auth.login":"Kirish","auth.register":"Ro‘yxatdan o‘tish","auth.email":"Email","auth.password":"Parol","auth.confirmPassword":"Parolni tasdiqlang","auth.fullName":"To‘liq ism","auth.phone":"Telefon","auth.signIn":"Kirish","auth.createAccount":"Hisob yaratish","auth.continueWithGoogle":"Google bilan kirish","auth.or":"yoki","auth.logout":"Chiqish","auth.loginRequired":"Davom etish uchun kiring","auth.sessionExpired":"Sessiya tugadi. Qayta kiring.","auth.emailRequired":"Email majburiy.","auth.passwordMin":"Parol kamida 6 ta belgi bo‘lsin.","auth.fullNameRequired":"To‘liq ism majburiy.","auth.phoneRequired":"Telefon majburiy.","auth.passwordMismatch":"Parollar mos emas.","home.all":"Hammasi","home.categories":"Kategoriyalar","home.quickCategories":"Tezkor kategoriyalar","home.lowPriceGuarantee":"Past narx kafolati","home.seeAll":"Hammasi","home.todayDeals":"Bugungi takliflar","home.discounts":"Chegirmalar","home.newArrivals":"Yangi mahsulotlar","home.popular":"Ommabop mahsulotlar","home.recommended":"Siz uchun tavsiyalar","home.similar":"O‘xshash mahsulotlar","home.others":"Boshqalar ham ko‘rgan","home.demoMode":"Demo rejim","home.todayOnly":"Faqat bugun","home.startShopping":"Xaridni boshlash","home.showAll":"Barcha mahsulotlar","home.loadMore":"Yana yuklash","home.noProducts":"Mahsulot topilmadi","home.loading":"Yuklanmoqda...","product.addToCart":"Savatga","product.addToCartFull":"Savatga qo‘shish","product.adding":"Qo‘shilmoqda...","product.sold":"{count} dona sotilgan","product.stock":"Omborda: {count}","product.outOfStock":"Omborda yo‘q","product.save":"Saqlash","product.saved":"Saqlangan","product.viewDetails":"Batafsil","product.quickView":"Tez ko‘rish","product.compare":"Solishtirish","product.compareSoon":"Solishtirish tez orada","product.lowStock":"Kam qoldi","product.freeShipping":"Bepul yetkazish","product.reviews":"Sharhlar","product.home":"Bosh sahifa","product.description":"Tavsif","product.detailImages":"Batafsil rasmlar","product.details":"Tafsilotlar","product.delivery":"O‘zbekiston bo‘ylab yetkazib berish","product.secure":"Xavfsiz to‘lov","product.original":"Asl koreys mahsulotlari","product.quantity":"Miqdor","product.notFound":"Mahsulot topilmadi","product.backToShopping":"Xaridga qaytish","product.variantUnavailable":"Variant mavjud emas","cart.title":"Savat","cart.empty":"Savatingiz bo‘sh","cart.subtotal":"Jami","cart.checkout":"Rasmiylashtirish","cart.remove":"O‘chirish","cart.quantity":"Miqdor","cart.added":"Savatga qo‘shildi","cart.itemRemoved":"Mahsulot o‘chirildi","cart.quantityUpdated":"Miqdor yangilandi","cart.unavailable":"Savat mavjud emas","cart.deliveryCourier":"Kuryer orqali yetkazib berish","cart.deliveryEta":"3 kun ichida yetkazamiz","cart.selectAll":"Hammasini tanlash ({selected}/{total})","cart.selectItem":"Mahsulotni tanlash","cart.deleteSelected":"O‘chirish","cart.yourOrder":"Sizning buyurtmangiz","cart.goodsCount":"{count} ta mahsulot","cart.discount":"Chegirma","cart.deliveryCost":"Yetkazib berish narxi","cart.freeDelivery":"Bepul","cart.products":"Mahsulot","cart.freeToHome":"Uyga bepul yetkazish","cart.shipsToday":"Bugun jo‘natiladi","cart.emptyHint":"Yoqtirgan mahsulotlaringizni qo‘shing — ular shu yerda ko‘rinadi.","checkout.title":"Rasmiylashtirish","checkout.receiver":"Qabul qiluvchi","checkout.address":"Yetkazib berish manzili","checkout.orderSummary":"Buyurtma xulosasi","checkout.placeOrder":"Buyurtma berish","checkout.orderCreated":"Buyurtma yaratildi","checkout.continueShopping":"Xaridni davom ettirish","checkout.viewOrders":"Buyurtmalarni ko‘rish","orders.title":"Buyurtmalar tarixi","orders.order":"Buyurtma","orders.details":"Buyurtma tafsilotlari","orders.history":"Status tarixi","orders.none":"Hali buyurtmalar yo‘q","orders.refresh":"Yangilash","orders.viewDetails":"Batafsil","orders.items":"{count} ta mahsulot","orders.itemsCount":"{count} ta tovar","orders.totalLabel":"Jami:","orders.addressLabel":"Manzil:","orders.products":"Mahsulotlar","orders.emptyHint":"Xaridlar qilgandan so‘ng buyurtmalar shu yerda ko‘rinadi.","orders.unavailable":"Buyurtmalar yuklanmadi","orders.detailUnavailable":"Buyurtma tafsilotlari yuklanmadi","orders.noItems":"Mahsulotlar topilmadi.","orders.deliveryInfo":"Yetkazib berish ma'lumotlari","orders.openOnMap":"Xaritada ochish","orders.orderActions":"Buyurtma amallari","orders.goodsLabel":"Mahsulotlar","orders.totalAmount":"Jami summa","orders.feedback":"Fikr-mulohaza","orders.statusMessage.NEW":"Buyurtma qabul qilindi va tez orada tasdiqlanadi.","orders.statusMessage.CONFIRMED":"Buyurtma tasdiqlandi va tayyorlanmoqda.","orders.statusMessage.PACKED":"Buyurtma qadoqlandi va tez orada yuboriladi.","orders.statusMessage.SHIPPED":"Buyurtma yo'lda. Yetkazish vaqtida aloqada bo'ling.","orders.statusMessage.DELIVERED":"Buyurtma yetkazildi. Xaridingiz uchun rahmat!","orders.statusMessage.CANCELED":"Buyurtma bekor qilindi.","orders.statusMessage.default":"Buyurtma holati yangilanmoqda.","favorites.title":"Saralangan","favorites.empty":"Saralanganlar hozircha bo‘sh","favorites.emptyHint":"Yoqtirgan mahsulotlaringiz shu yerda saqlanadi. Yoqqanlarini qo‘shing.","favorites.browse":"Mahsulotlarga","favorites.count":"{count} ta mahsulot","favorites.unavailable":"Saralanganlar yuklanmadi","favorites.added":"Saralanganlarga qo‘shildi","favorites.removed":"Saralangandan olib tashlandi","profile.myProfile":"Profil","profile.edit":"Profilni tahrirlash","profile.save":"Saqlash","profile.myOrders":"Buyurtmalarim","profile.myReviews":"Sharhlarim","profile.tierWhite":"White","profile.ordersStat":"Buyurtmalar","profile.reviewsStat":"Sharhlar","profile.couponsStat":"Kupon","profile.feedbackStat":"Fikr-mulohaza","profile.seeAll":"Hammasini ko‘rish","profile.promotions":"Aksiyalar va kuponlar","profile.help":"Yordam va qo‘llab-quvvatlash","profile.news":"Yangiliklar","profile.language":"Til / Til / Language","profile.privacy":"Maxfiylik siyosati","profile.terms":"Foydalanish shartlari","profile.licenses":"Ochiq kod litsenziyalari","profile.settings":"Sozlamalar","profile.menu":"Menyu","profile.logout":"Chiqish","profile.loggedOut":"Tizimdan chiqildi","profile.comingSoon":"Bu bo‘lim tez orada qo‘shiladi","profile.helpMessage":"Qo‘llab-quvvatlash: support@beautyskin.uz","profile.fullName":"To‘liq ism","profile.phone":"Telefon","profile.imageUrl":"Profil rasmi URL","profile.loadUserFailed":"Profil ma’lumotlari yuklanmadi","profile.loadOrdersFailed":"Buyurtmalar yuklanmadi","profile.loadReviewsFailed":"Sharhlar yuklanmadi","profile.loadFailed":"Profil ma’lumotlari yuklanmadi","support.title":"Qo‘llab-quvvatlash xizmati","support.intro":"Savollaringiz bormi? Biz sizga yordam beramiz.","support.faqTitle":"Ko‘p beriladigan savollar","support.faq.delivery.q":"Buyurtmam qachon keladi?","support.faq.delivery.a":"Buyurtmalar odatda 3–5 ish kuni ichida yetkazib beriladi. Yetkazib berish muddati hudud va tanlangan kuryer xizmatiga bog‘liq. Tabiiy ofatlar yoki boshqa kutilmagan holatlar yuzaga kelmagan taqdirda, buyurtmangiz belgilangan muddatda yetib keladi.","support.faq.cancel.q":"Buyurtmani qanday bekor qilaman?","support.faq.cancel.a":"Buyurtma faqat jo‘natilmaguncha bekor qilinishi mumkin. Buyurtma kuryer xizmatiga topshirilgandan so‘ng uni bekor qilish imkoniyati mavjud emas. Bekor qilish uchun profil bo‘limi yoki mijozlarga xizmat orqali murojaat qilishingiz mumkin.","support.faq.return.q":"Mahsulotni qaytarish mumkinmi?","support.faq.return.a":"Mahsulotni qaytarish faqat u ishlatilmagan, qadoqlanishi buzilmagan va to‘liq holatda saqlangan taqdirda amalga oshiriladi. Qaytarish jarayonida mahsulotni kargo orqali yuborish xarajatlari mijoz zimmasiga yuklanadi.","support.originalTitle":"100% original va Koreyadan to‘g‘ridan-to‘g‘ri yetkazib berish","support.originalText":"Ilovamizdagi mahsulotlar to‘g‘ridan-to‘g‘ri Janubiy Koreyadagi rasmiy ishlab chiqaruvchilar va sertifikatlangan distribyutorlardan import qilinadi. Soxta mahsulot sotish qat’iyan taqiqlanadi.","support.whyTitle":"Nega biz?","support.why1":"Koreyadan to‘g‘ridan-to‘g‘ri import","support.why2":"Hech qanday soxta mahsulot yo‘q","support.why3":"Zavod qadog‘i va original plombalar","support.why4":"Har bir buyurtma jo‘natishdan oldin tekshiriladi","support.why5":"Minglab mamnun mijozlar tanlovi","support.guarantee":"Agar mahsulot original bo‘lmasa — biz 100% qiymatini qaytaramiz.","support.contactTitle":"Biz bilan bog‘laning","support.phoneLabel":"Telefon:","support.hoursLabel":"Ish vaqti:","support.hoursValue":"09:00 – 18:00 (Du–Ju)","support.contactNote":"Murojaatlaringizni qadrlaymiz va imkon qadar tezroq javob berishga harakat qilamiz.","privacy.title":"Maxfiylik siyosati","privacy.updated":"Oxirgi yangilanish: 2025 y.","privacy.intro":"Biz foydalanuvchilarning shaxsiy ma’lumotlarini hurmat qilamiz va himoya qilamiz. Ushbu Maxfiylik siyosati ma’lumotlaringiz qanday to‘planishi, ishlatilishi va saqlanishini tushuntiradi.","privacy.s1title":"1. Qanday ma’lumotlar to‘planadi","privacy.s1a":"Ism va profil ma’lumotlari","privacy.s1b":"Telefon raqami yoki email","privacy.s1c":"Buyurtmalar va savat ma’lumotlari","privacy.s1d":"Qurilma haqidagi texnik ma’lumotlar","privacy.s2title":"2. Ma’lumotlardan foydalanish","privacy.s2intro":"To‘plangan ma’lumotlar quyidagi maqsadlarda ishlatiladi:","privacy.s2a":"Buyurtmalarni bajarish","privacy.s2b":"Akkauntni boshqarish","privacy.s2c":"Xizmat sifatini yaxshilash","privacy.s2d":"Xavfsizlikni ta’minlash","privacy.s3title":"3. Ma’lumotlarni himoya qilish","privacy.s3text":"Biz shaxsiy ma’lumotlaringizni ruxsatsiz kirish, o‘zgartirish yoki tarqatishdan himoya qilish uchun zamonaviy xavfsizlik choralarini qo‘llaymiz.","privacy.s4title":"4. Uchinchi tomon xizmatlari","privacy.s4text":"Ilovamiz to‘lov, yetkazib berish va autentifikatsiya uchun uchinchi tomon xizmatlaridan foydalanishi mumkin. Bu xizmatlarning o‘z maxfiylik siyosati mavjud.","privacy.s5title":"5. Aloqa","privacy.s5text":"Agar Maxfiylik siyosati bo‘yicha savollaringiz bo‘lsa, biz bilan bog‘laning:","terms.title":"Foydalanish shartlari","terms.updated":"Oxirgi yangilanish: 2025 y.","terms.intro":"Ushbu mobil ilovadan foydalanish orqali siz ushbu Foydalanish shartlariga rozilik bildirasiz. Agar shartlarga rozi bo‘lmasangiz, iltimos, ilovadan foydalanmang.","terms.s1title":"1. Umumiy qoidalar","terms.s1text":"Ushbu ilova kosmetika va boshqa mahsulotlarni onlayn sotib olish uchun mo‘ljallangan. Barcha materiallar, logotiplar va kontent mualliflik huquqi bilan himoyalangan.","terms.s2title":"2. Akkaunt ro‘yxatdan o‘tkazish","terms.s2text":"Buyurtma berish uchun foydalanuvchi akkaunt yaratishi va ishonchli ma’lumotlarni taqdim etishi kerak. Foydalanuvchi o‘z akkauntining xavfsizligi uchun javobgardir.","terms.s3title":"3. Buyurtmalar va to‘lov","terms.s3text":"Buyurtmalar ilova orqali rasmiylashtiriladi. Mahsulot narxlari oldindan ogohlantirmasdan o‘zgarishi mumkin. To‘lov tanlangan usul bo‘yicha amalga oshiriladi.","terms.s4title":"4. Yetkazib berish","terms.s4text":"Yetkazib berish muddatlari hudud va tanlangan usulga bog‘liq. Uchinchi tomon yetkazib berish xizmatlari sababli yuzaga kelgan kechikishlar uchun javobgar emasmiz.","terms.s5title":"5. Qaytarish va bekor qilish","terms.s5text":"Buyurtmalarni qaytarish va bekor qilish siyosati tegishli bo‘limda va yordam hamda qo‘llab-quvvatlash sahifasida tavsiflangan.","terms.s6title":"6. Javobgarlikni cheklash","terms.s6text":"Ilovadan foydalanish bilan bog‘liq bilvosita zarar uchun javobgar emasmiz.","terms.s7title":"7. Shartlarni o‘zgartirish","terms.s7text":"Biz ushbu shartnomani istalgan vaqtda o‘zgartirish huquqini o‘zimizda saqlaymiz. Joriy versiya doimo ilovada mavjud.","licenses.title":"Open Source Libraries & Technologies","licenses.intro":"Ushbu ilova quyidagi ochiq kodli texnologiyalar yordamida qurilgan","licenses.frontendTitle":"Android Frontend","licenses.fe1":"Android Jetpack – hayot sikli, navigatsiya, ViewBinding va arxitektura komponentlarini boshqarish uchun ishlatiladigan zamonaviy Android kutubxonalari to‘plami, barqaror foydalanuvchi interfeysini ta’minlaydi.","licenses.fe2":"Retrofit – backend REST API bilan samarali aloqa qilish uchun ishlatiladigan Android uchun tip-xavfsiz HTTP-mijoz.","licenses.fe3":"Glide – silliq skroll va samarali xotira ishlatilishi uchun optimallashtirilgan rasmlarni yuklash va keshlash kutubxonasi.","licenses.fe4":"Firebase Authentication – Google orqali xavfsiz foydalanuvchi autentifikatsiyasi va telefon raqamini tekshirish (OTP) ni ta’minlaydi.","licenses.fe5":"Facebook Shimmer – foydalanuvchi tajribasini yaxshilash uchun animatsiyali yuklash zaxira o‘rinlarini ko‘rsatadi.","licenses.backendTitle":"Backend & Server Technologies","licenses.be1":"Spring Boot – masshtablanadigan RESTful API yaratish uchun ishlatiladigan Java asosidagi freymvork.","licenses.be2":"Spring Security + JWT – foydalanuvchi sessiyalari va API endpointlarini himoya qilish uchun JSON Web Tokens yordamida autentifikatsiyani amalga oshiradi.","licenses.be3":"Spring Data JPA – ORM va repozitoriy patterni yordamida ma’lumotlar bazasiga kirishni soddalashtiradi.","licenses.be4":"MySQL – hisob yozuvlari, buyurtmalar va tovarlarni saqlash uchun ishonchli relatsion ma’lumotlar bazasini boshqarish tizimi.","licenses.be5":"Eskiz SMS API – telefon raqamini tekshirish va bir martalik parollarni (OTP) yetkazish uchun ishlatiladi.","licenses.infraTitle":"Infrastructure & Deployment","licenses.inf1":"Docker – ilovani barcha bog‘liqliklari bilan barqaror joylashtirish uchun paketlash konteynerizatsiya texnologiyasi.","licenses.inf2":"Railway Cloud – backend xizmatlarini joylashtirish, masshtablash va monitoring qilish uchun bulutli platforma.","licenses.securityTitle":"Security & Data Protection","licenses.sec1":"HTTPS – foydalanuvchi ma’lumotlarini himoya qilish uchun barcha tarmoq aloqasi HTTPS yordamida shifrlangan.","licenses.sec2":"Xavfsiz parol bilan ishlash – foydalanuvchi hisob ma’lumotlari hech qachon ochiq holda saqlanmaydi.","licenses.sec3":"Token asosidagi avtorizatsiya – barcha himoyalangan so‘rovlar yaroqli JWT tokenlarini talab qiladi.","licenses.footer":"Biz ochiq kod hamjamiyatini hurmat qilamiz va barcha litsenziya talablari hamda ilg‘or xavfsizlik amaliyotlariga qat’iy rioya qilamiz.","reviews.my":"Mening sharhlarim","reviews.write":"Sharh yozish","reviews.submit":"Sharh yuborish","reviews.rating":"Reyting","reviews.content":"Sharh matni","reviews.none":"Hali sharhlar yo‘q","reviews.noText":"Matnli sharh yo‘q.","reviews.submitted":"Sharh yuborildi","notifications.title":"Bildirishnomalar","notifications.alerts":"Xabarlar","notifications.none":"Hali bildirishnomalar yo‘q","notifications.markRead":"O‘qildi deb belgilash","notifications.read":"O‘qilgan","notifications.unread":"O‘qilmagan","common.tryAgain":"Qayta urinish","common.somethingWrong":"Nimadir xato ketdi","common.serverFailed":"Server bilan aloqa bo‘lmadi","common.saving":"Saqlanmoqda...","common.total":"Jami","common.unknown":"Noma’lum","common.unavailable":"Mavjud emas","status.NEW":"Yangi","status.PENDING":"Kutilmoqda","status.CONFIRMED":"Tasdiqlangan","status.PACKED":"Qadoqlangan","status.SHIPPED":"Yuborilgan","status.DELIVERED":"Yetkazilgan","status.CANCELED":"Bekor qilingan","notification.ORDER":"Buyurtma","notification.PROMO":"Aksiya","notification.SYSTEM":"Tizim","category.SKINCARE":"Teri parvarishi","category.MAKEUP":"Makiyaj","category.COLLAGEN":"Kollagen","category.HAIR_CARE":"Soch parvarishi","category.FRAGRANCE":"Atirlar","category.TOP":"Ustki kiyim","category.OUTER":"Tashqi kiyim","category.PANTS":"Shimlar","category.SHOES":"Poyabzal","category.BAG":"Sumka","category.ACCESSORY":"Aksessuar","hero.eyebrow":"Eng yaxshi kunlik takliflar","hero.title":"Koreys go‘zallik mahsulotlari","hero.subtitle":"O‘zbekiston bo‘ylab tez yetkazib berish — kosmetika, teri parvarishi, atir va aksessuarlar.","hero.viewProducts":"Mahsulotlarni ko‘rish","hero.fastDelivery":"Tez yetkazib berish","hero.fastDeliverySub":"O‘zbekiston bo‘ylab","home.history":"Tarix","home.recentlyViewed":"Yaqinda ko‘rilgan","api.title":"API sozlamasi","api.save":"Saqlash","search.results":"Natijalar","search.noResults":"Hech narsa topilmadi","search.recent":"So‘nggi qidiruvlar","search.trending":"Trendda","search.clear":"Tozalash","search.aiHint":"AI qidiruv — tezroq toping","search.voice":"Ovozli qidiruv","search.image":"Rasm bo‘yicha qidiruv","search.imagePlaceholder":"Rasm tanlandi — qidiruv tez orada","search.popularSearches":"Ommabop qidiruvlar","trust.secure":"Xavfsiz to‘lov","trust.authentic":"100% asl mahsulot","trust.delivery":"Tez yetkazib berish","trust.verified":"Tasdiqlangan sotuvchilar","filter.title":"Filtrlar","filter.clearAll":"Hammasini tozalash","filter.brand":"Brend","filter.price":"Narx","filter.discount":"Chegirma","filter.color":"Rang","filter.size":"O'lcham","filter.rating":"Reyting","filter.availability":"Mavjudlik","filter.fastDelivery":"Tez yetkazish","filter.origin":"Kelib chiqishi","filter.seller":"Sotuvchi","filter.onSaleOnly":"Faqat chegirmali","filter.inStock":"Omborda bor","filter.apply":"Qo'llash","filter.noOptions":"Variant yo'q","sort.title":"Saralash","sort.popular":"Ommabop","sort.priceAsc":"Narx: arzon → qimmat","sort.priceDesc":"Narx: qimmat → arzon","sort.rating":"Yuqori reyting","sort.newest":"Yangi","sort.discount":"Eng katta chegirma","compare.title":"Solishtirish","compare.empty":"Solishtirish ro'yxati bo'sh","compare.added":"Solishtirishga qo'shildi","compare.removed":"Solishtirishdan olib tashlandi","compare.full":"Maksimum {max} ta mahsulot","compare.viewAll":"Solishtirishni ko'rish","compare.clearAll":"Hammasini tozalash","compare.price":"Narx","compare.brand":"Brend","compare.rating":"Reyting","compare.stock":"Ombor","compare.discount":"Chegirma","product.authentic":"Asl mahsulot","product.officialStore":"Rasmiy do'kon","product.fullscreen":"To'liq ekran","product.video360Placeholder":"Video va 360° tez orada","product.listPrice":"Ro'yxat narxi","product.discount":"Chegirma","product.installmentPlaceholder":"Bo'lib to'lash tez orada","product.estimatedDelivery":"Taxminiy yetkazish","product.frequentlyBought":"Ko'pincha birga sotib olinadi","cart.saveForLater":"Keyinroq uchun saqlash","cart.couponPlaceholder":"Kupon kodi","cart.applyCoupon":"Qo'llash","cart.couponApplied":"Kupon qo'llandi","cart.couponInvalid":"Kupon noto'g'ri","cart.freeShippingUnlocked":"Bepul yetkazish!","cart.freeShippingRemaining":"Bepul yetkazish uchun yana {amount}","cart.restored":"Saqlangan mahsulot","cart.moveToCart":"Savatga qaytarish","checkout.stepShipping":"Yetkazish","checkout.stepAddress":"Manzil","checkout.stepPayment":"To'lov","checkout.stepReview":"Tekshirish","checkout.back":"Orqaga","checkout.continue":"Davom etish","checkout.placing":"Yuborilmoqda...","checkout.paymentPlaceholder":"Xavfsiz to'lov (COD / karta tez orada)","checkout.receiverRequired":"Qabul qiluvchini tanlang","checkout.addressRequired":"Manzilni tanlang","checkout.deliveryTitle":"Yetkazib berish","checkout.deliveryEta":"Buyurtma 3–5 ish kuni ichida yetkaziladi","checkout.addressNotSelected":"Manzil tanlanmagan","checkout.selectAddress":"Manzilni tanlash","checkout.receiverNotSelected":"Qabul qiluvchi tanlanmagan","checkout.paymentMethod":"To‘lov usuli","checkout.paymentCod":"Qabul qilganda to‘lash","checkout.paymentCodHint":"To‘lov faqat naqd pul yoki bank kartasiga o‘tkazma orqali amalga oshiriladi","checkout.deliveryInfo":"Buyurtma kuryer orqali manzilga yetkaziladi. Yetkazish vaqtida aloqada bo‘ling.","checkout.couponTitle":"Chegirma kuponi","checkout.applyCoupon":"Kupon qo‘llash","checkout.yourOrder":"Sizning buyurtmangiz","checkout.deliveryFee":"Yetkazish","checkout.totalToPay":"To‘lov uchun jami","checkout.confirm":"Tasdiqlash","checkout.legalNotice":"Buyurtmani tasdiqlash orqali Foydalanish shartlari va Maxfiylik siyosatiga rozilik bildirasiz.","checkout.deliveryOn":"Yetkazish {dates}","checkout.itemsCount":"{count} ta mahsulot","checkout.confirmTitle":"Buyurtmani tasdiqlash","checkout.confirmQuestion":"Buyurtmani yubormoqchimisiz?","checkout.confirmName":"Ism: {name}","checkout.confirmAddress":"Manzil: {address}","checkout.confirmDisclaimer":"Tasdiqlangandan keyin buyurtmani faqat qo‘llab-quvvatlash xizmati orqali o‘zgartirish mumkin.","checkout.cancel":"Bekor qilish","checkout.successTitle":"Buyurtma muvaffaqiyatli rasmiylashtirildi!","checkout.successSubtitle":"Buyurtma muvaffaqiyatli qabul qilindi","checkout.orderFailed":"Buyurtma yuborilmadi. Qayta urinib ko‘ring.","checkout.noItems":"Savatda tanlangan mahsulot yo‘q.","checkout.invalidItems":"Savatdagi mahsulot identifikatorlari noto‘g‘ri.","reviews.verified":"Tasdiqlangan xarid","reviews.helpful":"Foydali","reviews.search":"Sharhlarni qidirish","reviews.sortNewest":"Eng yangi","reviews.sortRatingHigh":"Yuqori reyting","reviews.sortRatingLow":"Past reyting","reviews.sortHelpful":"Eng foydali","reviews.allRatings":"Barcha reytinglar","brand.official":"Rasmiy brend","brand.story":"Koreys go'zallik brendi","brand.popular":"Ommabop mahsulotlar","home.trendingNow":"Hozir trendda","home.recommendedForYou":"Siz uchun tavsiya","home.continueShopping":"Xaridni davom ettirish","home.becauseYouViewed":"Siz ko'rganingiz uchun"},_t={...Yr,"header.location":"📍 Tashkent","header.pickupPoints":"Pickup points","header.sell":"Sell on Beauty Skin Korea","header.support":"Support","header.orders":"Orders","header.language":"Language","header.catalog":"Catalog","header.searchPlaceholder":"Search products and categories","header.search":"Search","auth.login":"Login","auth.register":"Register","auth.signIn":"Sign in","auth.createAccount":"Create account","auth.continueWithGoogle":"Continue with Google","auth.or":"or","auth.email":"Email","auth.password":"Password","auth.confirmPassword":"Confirm password","auth.fullName":"Full name","auth.phone":"Phone","auth.logout":"Logout","auth.loginRequired":"Please login to continue","auth.emailRequired":"Email is required.","auth.passwordMin":"Password must be at least 6 characters.","auth.fullNameRequired":"Full name is required.","auth.phoneRequired":"Phone is required.","auth.passwordMismatch":"Passwords do not match.","home.all":"All","home.categories":"Categories","home.quickCategories":"Quick categories","home.lowPriceGuarantee":"Low price guarantee","home.seeAll":"All","home.todayDeals":"Today deals","home.discounts":"Discounts","home.newArrivals":"New arrivals","home.popular":"Popular products","home.recommended":"Recommended for you","home.similar":"Similar products","home.others":"Others also viewed","home.demoMode":"Demo mode","home.todayOnly":"Today only","home.startShopping":"Start shopping","home.showAll":"Show all products","home.loadMore":"Load more","home.noProducts":"No products found","home.loading":"Loading...","product.addToCart":"Add to cart","product.addToCartFull":"Add to cart","product.adding":"Adding...","product.sold":"{count} sold","product.stock":"Stock: {count}","product.save":"Save","product.saved":"Saved","product.viewDetails":"View details","product.reviews":"Reviews","product.description":"Description","product.detailImages":"Detail images","product.delivery":"Delivery across Uzbekistan","product.secure":"Secure checkout","product.original":"Original Korean products","product.notFound":"Product not found","product.backToShopping":"Back to shopping","cart.title":"Cart","cart.empty":"Your cart is empty","cart.subtotal":"Subtotal","cart.checkout":"Checkout","cart.added":"Added to cart","cart.itemRemoved":"Removed from cart","cart.quantityUpdated":"Quantity updated","cart.deliveryCourier":"Courier delivery","cart.deliveryEta":"Delivered in 3 days","cart.selectAll":"Select all ({selected}/{total})","cart.selectItem":"Select item","cart.deleteSelected":"Delete","cart.yourOrder":"Your order","cart.goodsCount":"{count} items","cart.discount":"Discount","cart.deliveryCost":"Delivery cost","cart.freeDelivery":"Free","cart.products":"Products","cart.freeToHome":"Free home delivery","cart.shipsToday":"Ships today","cart.emptyHint":"Add products you like and they will appear here.","cart.remove":"Remove","cart.unavailable":"Cart unavailable","orders.title":"Order history","orders.itemsCount":"{count} items","orders.totalLabel":"Total:","orders.addressLabel":"Address:","orders.products":"Products","orders.emptyHint":"Your purchases will appear here.","orders.unavailable":"Orders could not be loaded","orders.detailUnavailable":"Order details unavailable","orders.noItems":"No items found.","orders.deliveryInfo":"Delivery information","orders.openOnMap":"Open on map","orders.orderActions":"Order actions","orders.goodsLabel":"Products","orders.totalAmount":"Total amount","orders.feedback":"Feedback","orders.statusMessage.NEW":"Order received and will be confirmed soon.","orders.statusMessage.CONFIRMED":"Order confirmed and being prepared.","orders.statusMessage.PACKED":"Order packed and will ship soon.","orders.statusMessage.SHIPPED":"Order is on the way. Please stay in touch.","orders.statusMessage.DELIVERED":"Order delivered. Thank you for your purchase!","orders.statusMessage.CANCELED":"Order was canceled.","orders.statusMessage.default":"Order status is being updated.","orders.order":"Order","orders.viewDetails":"Details","orders.items":"{count} items","orders.details":"Order details","orders.history":"Status history","favorites.title":"Favorites","favorites.empty":"No favorites yet","favorites.emptyHint":"Your favorite products will be stored here. Add the ones you like.","favorites.browse":"Browse products","favorites.count":"{count} items","favorites.unavailable":"Favorites could not be loaded","reviews.none":"No reviews yet","notifications.title":"Notifications","notifications.alerts":"Alerts","notifications.none":"No notifications yet","common.tryAgain":"Try again","common.serverFailed":"Server connection failed","common.total":"Total","checkout.title":"Checkout","orders.refresh":"Refresh","reviews.my":"My reviews","reviews.write":"Write review","reviews.submit":"Submit review","hero.eyebrow":"Best daily offers","hero.title":"Korean beauty products","hero.subtitle":"Fast delivery across Uzbekistan — cosmetics, skincare, fragrance and accessories.","hero.viewProducts":"View products","hero.fastDelivery":"Fast delivery","hero.fastDeliverySub":"Across Uzbekistan","home.history":"History","home.recentlyViewed":"Recently viewed","profile.myProfile":"My Profile","profile.edit":"Edit profile","profile.save":"Save","profile.myOrders":"My orders","profile.myReviews":"My reviews","profile.tierWhite":"White","profile.ordersStat":"Orders","profile.reviewsStat":"Reviews","profile.couponsStat":"Coupons","profile.feedbackStat":"Feedback","profile.seeAll":"See all","profile.promotions":"Promotions & coupons","profile.help":"Help & support","profile.news":"News","profile.language":"Language / Til / Language","profile.privacy":"Privacy policy","profile.terms":"Terms of use","profile.licenses":"Open source licenses","profile.settings":"Settings","profile.menu":"Menu","profile.logout":"Log out","profile.loggedOut":"Logged out","profile.comingSoon":"This section is coming soon","profile.helpMessage":"Support: support@beautyskin.uz","profile.fullName":"Full name","profile.phone":"Phone","profile.imageUrl":"Profile image URL","profile.loadUserFailed":"Could not load profile","profile.loadOrdersFailed":"Could not load orders","profile.loadReviewsFailed":"Could not load reviews","profile.loadFailed":"Could not load profile data","support.title":"Support service","support.intro":"Have questions? We are here to help.","support.faqTitle":"Frequently asked questions","support.faq.delivery.q":"When will my order arrive?","support.faq.delivery.a":"Orders are usually delivered within 3–5 business days. Delivery time depends on your region and the chosen courier service. Unless there are natural disasters or other unforeseen circumstances, your order will arrive within the estimated time.","support.faq.cancel.q":"How do I cancel an order?","support.faq.cancel.a":"An order can only be canceled before it is shipped. Once the order has been handed over to the courier service, it can no longer be canceled. To cancel, you can reach out via the profile section or customer support.","support.faq.return.q":"Can I return a product?","support.faq.return.a":"A product can only be returned if it is unused, the packaging is intact, and the item is kept in full condition. Shipping costs for returning the product via cargo are covered by the customer.","support.originalTitle":"100% original and direct supply from Korea","support.originalText":"Products in our app are imported directly from official manufacturers and certified distributors in South Korea. Selling counterfeit goods is strictly prohibited.","support.whyTitle":"Why us?","support.why1":"Direct import from Korea","support.why2":"No counterfeits","support.why3":"Factory packaging and original seals","support.why4":"Every order is checked before shipping","support.why5":"Chosen by thousands of happy customers","support.guarantee":"If the product is not original — we refund 100% of the cost.","support.contactTitle":"Contact us","support.phoneLabel":"Phone:","support.hoursLabel":"Working hours:","support.hoursValue":"09:00 – 18:00 (Mon–Fri)","support.contactNote":"We value your messages and will try to respond as quickly as possible.","privacy.title":"Privacy Policy","privacy.updated":"Last updated: 2025","privacy.intro":"We respect and protect users' personal data. This Privacy Policy explains how your data is collected, used, and stored.","privacy.s1title":"1. What data is collected","privacy.s1a":"Name and profile details","privacy.s1b":"Phone number or email","privacy.s1c":"Order and cart data","privacy.s1d":"Technical device information","privacy.s2title":"2. Use of data","privacy.s2intro":"The collected data is used for the following purposes:","privacy.s2a":"Fulfilling orders","privacy.s2b":"Account management","privacy.s2c":"Improving service quality","privacy.s2d":"Ensuring security","privacy.s3title":"3. Data protection","privacy.s3text":"We apply modern security measures to protect your personal data from unauthorized access, alteration, or distribution.","privacy.s4title":"4. Third-party services","privacy.s4text":"Our app may use third-party services for payment, delivery, and authentication. These services have their own privacy policies.","privacy.s5title":"5. Contact","privacy.s5text":"If you have questions about the Privacy Policy, contact us:","terms.title":"Terms of Service","terms.updated":"Last updated: 2025","terms.intro":"By using this mobile application, you agree to the terms of this Terms of Service. If you do not agree with the terms, please do not use the application.","terms.s1title":"1. General provisions","terms.s1text":"This application is intended for online purchase of cosmetics and other products. All materials, logos, and content are protected by copyright.","terms.s2title":"2. Account registration","terms.s2text":"To place orders, the user must create an account and provide accurate information. The user is responsible for the security of their account.","terms.s3title":"3. Orders and payment","terms.s3text":"Orders are placed through the application. Product prices may change without prior notice. Payment is made according to the selected method.","terms.s4title":"4. Delivery","terms.s4text":"Delivery times depend on the region and the selected method. We are not responsible for delays caused by third-party delivery services.","terms.s5title":"5. Returns and cancellation","terms.s5text":"The return and order cancellation policy is described in the relevant section and on the help and support page.","terms.s6title":"6. Limitation of liability","terms.s6text":"We are not liable for indirect damages related to the use of the application.","terms.s7title":"7. Changes to terms","terms.s7text":"We reserve the right to change this agreement at any time. The current version is always available in the application.","licenses.title":"Open Source Libraries & Technologies","licenses.intro":"This application is built using the following open-source technologies","licenses.frontendTitle":"Android Frontend","licenses.fe1":"Android Jetpack – a set of modern Android libraries used for lifecycle management, navigation, ViewBinding, and architectural components to ensure a stable user interface.","licenses.fe2":"Retrofit – a type-safe HTTP client for Android used for efficient interaction with the backend REST API.","licenses.fe3":"Glide – an image loading and caching library optimized for smooth scrolling and efficient memory usage.","licenses.fe4":"Firebase Authentication – provides secure user authentication via Google and phone number verification (OTP).","licenses.fe5":"Facebook Shimmer – displays animated loading placeholders to improve the user experience.","licenses.backendTitle":"Backend & Server Technologies","licenses.be1":"Spring Boot – a Java-based framework used to build scalable RESTful APIs.","licenses.be2":"Spring Security + JWT – implements authentication using JSON Web Tokens to protect user sessions and API endpoints.","licenses.be3":"Spring Data JPA – simplifies database access using ORM and the repository pattern.","licenses.be4":"MySQL – a reliable relational database management system for storing accounts, orders, and products.","licenses.be5":"Eskiz SMS API – used for phone number verification and delivery of one-time passwords (OTP).","licenses.infraTitle":"Infrastructure & Deployment","licenses.inf1":"Docker – containerization technology for packaging the application with all dependencies for stable deployment.","licenses.inf2":"Railway Cloud – a cloud platform for deploying, scaling, and monitoring backend services.","licenses.securityTitle":"Security & Data Protection","licenses.sec1":"HTTPS – all network communication is encrypted using HTTPS to protect user data.","licenses.sec2":"Secure password handling – user credentials are never stored in plain text.","licenses.sec3":"Token-based authorization – all protected requests require valid JWT tokens.","licenses.footer":"We respect the open-source community and strictly comply with all license requirements and security best practices.","status.PENDING":"Pending","api.title":"API settings","api.save":"Save","header.currency":"Currency","header.theme":"Theme","product.quickView":"Quick view","product.compare":"Compare","product.compareSoon":"Compare coming soon","product.lowStock":"Low stock","product.freeShipping":"Free shipping","search.results":"Results","search.noResults":"No results found","search.recent":"Recent searches","search.trending":"Trending","search.clear":"Clear","search.aiHint":"AI search — find products faster","search.voice":"Voice search","search.image":"Image search","search.imagePlaceholder":"Image selected — search coming soon","search.popularSearches":"Popular searches","trust.secure":"Secure payment","trust.authentic":"100% authentic","trust.delivery":"Fast delivery","trust.verified":"Verified sellers","filter.title":"Filters","filter.clearAll":"Clear all","filter.brand":"Brand","filter.price":"Price","filter.discount":"Discount","filter.color":"Color","filter.size":"Size","filter.rating":"Rating","filter.availability":"Availability","filter.fastDelivery":"Fast delivery","filter.origin":"Country of origin","filter.seller":"Seller","filter.onSaleOnly":"On sale only","filter.inStock":"In stock","filter.apply":"Apply filters","filter.noOptions":"No options","sort.title":"Sort","sort.popular":"Popular","sort.priceAsc":"Price: Low to High","sort.priceDesc":"Price: High to Low","sort.rating":"Top rated","sort.newest":"Newest","sort.discount":"Best discount","compare.title":"Compare","compare.empty":"Compare list is empty","compare.added":"Added to compare","compare.removed":"Removed from compare","compare.full":"Maximum {max} products","compare.viewAll":"View comparison","compare.clearAll":"Clear all","compare.price":"Price","compare.brand":"Brand","compare.rating":"Rating","compare.stock":"Stock","compare.discount":"Discount","product.authentic":"Authentic product","product.officialStore":"Official store","product.fullscreen":"Fullscreen","product.video360Placeholder":"Video & 360° coming soon","product.listPrice":"List price","product.discount":"Discount","product.installmentPlaceholder":"Installments coming soon","product.estimatedDelivery":"Estimated delivery","product.frequentlyBought":"Frequently bought together","cart.saveForLater":"Save for later","cart.couponPlaceholder":"Coupon code","cart.applyCoupon":"Apply","cart.couponApplied":"Coupon applied","cart.couponInvalid":"Invalid coupon","cart.freeShippingUnlocked":"Free shipping unlocked!","cart.freeShippingRemaining":"Add {amount} more for free shipping","cart.restored":"Item restored","cart.moveToCart":"Move to cart","checkout.stepShipping":"Shipping","checkout.stepAddress":"Address","checkout.stepPayment":"Payment","checkout.stepReview":"Review","checkout.back":"Back","checkout.continue":"Continue","checkout.placing":"Placing order...","checkout.paymentPlaceholder":"Secure payment (COD / card coming soon)","checkout.receiverRequired":"Please select a receiver","checkout.addressRequired":"Please select an address","checkout.deliveryTitle":"Delivery","checkout.deliveryEta":"Order will be delivered within 3–5 business days","checkout.addressNotSelected":"Address not selected","checkout.selectAddress":"Select address","checkout.receiverNotSelected":"Recipient not selected","checkout.paymentMethod":"Payment method","checkout.paymentCod":"Payment on receipt","checkout.paymentCodHint":"Payment is made only in cash or by bank card transfer","checkout.deliveryInfo":"The order will be delivered by courier to your address. Please stay in touch during delivery.","checkout.couponTitle":"Discount coupon","checkout.applyCoupon":"Apply coupon","checkout.yourOrder":"Your order","checkout.deliveryFee":"Delivery","checkout.totalToPay":"Total to pay","checkout.confirm":"Confirm","checkout.legalNotice":"By confirming the order, you agree to the Terms of Use and Privacy Policy.","checkout.deliveryOn":"Delivery {dates}","checkout.itemsCount":"{count} items","checkout.orderSummary":"Order summary","checkout.placeOrder":"Place order","checkout.orderCreated":"Order created","checkout.continueShopping":"Continue shopping","checkout.viewOrders":"View orders","checkout.receiver":"Recipient","checkout.confirmTitle":"Order confirmation","checkout.confirmQuestion":"Do you want to send the order?","checkout.confirmName":"Name: {name}","checkout.confirmAddress":"Address: {address}","checkout.confirmDisclaimer":"After confirmation, the order can only be changed through customer support.","checkout.cancel":"Cancel","checkout.successTitle":"Order placed successfully!","checkout.successSubtitle":"Order successfully accepted","checkout.orderFailed":"Order could not be sent. Please try again.","checkout.noItems":"No selected items in cart.","checkout.invalidItems":"Cart item identifiers are invalid.","reviews.verified":"Verified purchase","reviews.helpful":"Helpful","reviews.search":"Search reviews","reviews.sortNewest":"Newest","reviews.sortRatingHigh":"Highest rating","reviews.sortRatingLow":"Lowest rating","reviews.sortHelpful":"Most helpful","reviews.allRatings":"All ratings","brand.official":"Official brand","brand.story":"Korean beauty brand","brand.popular":"Popular products","home.trendingNow":"Trending now","home.recommendedForYou":"Recommended for you","home.continueShopping":"Continue shopping","home.becauseYouViewed":"Because you viewed"},Xa={..._t,"header.location":"📍 Ташкент","header.pickupPoints":"Пункты выдачи","header.sell":"Стать продавцом","header.support":"Поддержка","header.orders":"Заказы","header.language":"Язык","header.catalog":"Каталог","header.searchPlaceholder":"Искать товары и категории","auth.login":"Войти","auth.register":"Регистрация","auth.continueWithGoogle":"Войти через Google","auth.or":"или","auth.email":"Email","auth.password":"Пароль","auth.confirmPassword":"Подтвердите пароль","auth.fullName":"Полное имя","auth.phone":"Телефон","auth.logout":"Выйти","auth.loginRequired":"Войдите, чтобы продолжить","auth.emailRequired":"Email обязателен.","auth.passwordMin":"Пароль должен быть не менее 6 символов.","auth.fullNameRequired":"Полное имя обязательно.","auth.phoneRequired":"Телефон обязателен.","auth.passwordMismatch":"Пароли не совпадают.","home.all":"Все","home.categories":"Категории","home.quickCategories":"Быстрые категории","home.lowPriceGuarantee":"Гарантия низких цен","home.seeAll":"Все","home.todayDeals":"Предложения дня","home.discounts":"Скидки","home.newArrivals":"Новинки","home.popular":"Популярные товары","home.recommended":"Рекомендуем вам","home.similar":"Похожие товары","home.others":"Также смотрели","home.startShopping":"Начать покупки","home.loadMore":"Загрузить еще","product.addToCart":"В корзину","product.addToCartFull":"В корзину","product.sold":"Продано: {count}","product.save":"Сохранить","product.saved":"Сохранено","product.description":"Описание","product.detailImages":"Детальные изображения","product.details":"Детали","product.reviews":"Отзывы","product.delivery":"Доставка по Узбекистану","product.secure":"Безопасная оплата","product.original":"Оригинальная корейская косметика","cart.title":"Корзина","cart.empty":"Корзина пуста","cart.checkout":"Оформить","cart.subtotal":"Итого","cart.remove":"Удалить","cart.deliveryCourier":"Доставка курьером","cart.deliveryEta":"Доставим за 3 дня","cart.selectAll":"Выбрать все ({selected}/{total})","cart.selectItem":"Выбрать товар","cart.deleteSelected":"Удалить","cart.yourOrder":"Ваш заказ","cart.goodsCount":"{count} товаров","cart.discount":"Скидка","cart.deliveryCost":"Стоимость доставки","cart.freeDelivery":"Бесплатно","cart.products":"Товар","cart.freeToHome":"Бесплатно до дома","cart.shipsToday":"Отправка сегодня","cart.emptyHint":"Добавьте понравившиеся товары — они появятся здесь.","cart.freeShippingUnlocked":"Бесплатная доставка!","cart.freeShippingRemaining":"Добавьте ещё {amount} для бесплатной доставки","cart.couponPlaceholder":"Промокод","cart.applyCoupon":"Применить","cart.savedForLater":"Сохранённые","cart.moveToCart":"В корзину","orders.title":"История заказов","orders.order":"Заказ","orders.details":"Детали заказа","orders.history":"История статуса","orders.none":"Заказов пока нет","orders.viewDetails":"Подробнее","orders.items":"{count} товаров","orders.itemsCount":"{count} товаров","orders.totalLabel":"Итого:","orders.addressLabel":"Адрес:","orders.products":"Товары","orders.emptyHint":"Здесь появятся ваши покупки.","orders.unavailable":"Не удалось загрузить заказы","orders.detailUnavailable":"Не удалось загрузить детали заказа","orders.noItems":"Товары не найдены.","orders.deliveryInfo":"Информация о доставке","orders.openOnMap":"Открыть на карте","orders.orderActions":"Действия с заказом","orders.goodsLabel":"Товары","orders.totalAmount":"Итого сумма","orders.feedback":"Обратная связь","orders.statusMessage.NEW":"Заказ принят и скоро будет подтвержден.","orders.statusMessage.CONFIRMED":"Заказ подтвержден и готовится.","orders.statusMessage.PACKED":"Заказ упакован и скоро будет отправлен.","orders.statusMessage.SHIPPED":"Заказ в пути. Пожалуйста, будьте на связи.","orders.statusMessage.DELIVERED":"Заказ доставлен. Спасибо за покупку!","orders.statusMessage.CANCELED":"Заказ отменен.","orders.statusMessage.default":"Статус заказа обновляется.","favorites.title":"Избранное","favorites.empty":"В избранном пока пусто","favorites.emptyHint":"Ваши любимые товары будут храниться здесь. Добавляйте то, что вам нравится.","favorites.browse":"К товарам","favorites.count":"{count} товаров","favorites.unavailable":"Не удалось загрузить избранное","reviews.none":"Пока нет отзывов","notifications.title":"Уведомления","profile.myProfile":"Мой профиль","profile.edit":"Редактировать профиль","profile.save":"Сохранить","profile.myOrders":"Мои заказы","profile.myReviews":"Мои отзывы","profile.tierWhite":"White","profile.ordersStat":"Заказы","profile.reviewsStat":"Отзывы","profile.couponsStat":"Купон","profile.feedbackStat":"Обратная связь","profile.seeAll":"Посмотреть все","profile.promotions":"Акции и купоны","profile.help":"Помощь и поддержка","profile.news":"Новости","profile.language":"Язык / Til / Language","profile.privacy":"Политика конфиденциальности","profile.terms":"Условия использования","profile.licenses":"Лицензии открытого ПО","profile.settings":"Настройки","profile.menu":"Меню","profile.logout":"Выйти","profile.loggedOut":"Вы вышли из аккаунта","profile.comingSoon":"Раздел скоро появится","profile.helpMessage":"Поддержка: support@beautyskin.uz","profile.fullName":"Полное имя","profile.phone":"Телефон","profile.imageUrl":"URL фото профиля","profile.loadUserFailed":"Не удалось загрузить профиль","profile.loadOrdersFailed":"Не удалось загрузить заказы","profile.loadReviewsFailed":"Не удалось загрузить отзывы","profile.loadFailed":"Не удалось загрузить данные профиля","support.title":"Служба поддержки","support.intro":"У вас есть вопросы? Мы вам поможем.","support.faqTitle":"Часто задаваемые вопросы","support.faq.delivery.q":"Когда придет мой заказ?","support.faq.delivery.a":"Заказы обычно доставляются в течение 3–5 рабочих дней. Срок доставки зависит от региона и выбранной курьерской службы. При отсутствии стихийных бедствий или других непредвиденных обстоятельств ваш заказ прибудет в установленный срок.","support.faq.cancel.q":"Как отменить заказ?","support.faq.cancel.a":"Заказ можно отменить только до момента отправки. После передачи заказа курьерской службе его отмена невозможна. Для отмены вы можете обратиться в раздел профиля или в службу поддержки.","support.faq.return.q":"Можно ли вернуть товар?","support.faq.return.a":"Возврат товара возможен только в том случае, если он не был в использовании, упаковка не повреждена и товар сохранён в полном виде. Расходы на отправку товара через карго при возврате возлагаются на клиента.","support.originalTitle":"100% оригинал и прямые поставки из Кореи","support.originalText":"Товары в нашем приложении импортируются напрямую от официальных производителей и сертифицированных дистрибьюторов в Южной Корее. Продажа подделок строго запрещена.","support.whyTitle":"Почему мы?","support.why1":"Прямой импорт из Кореи","support.why2":"Никаких подделок","support.why3":"Заводская упаковка и оригинальные пломбы","support.why4":"Каждый заказ проверяется перед отправкой","support.why5":"Выбор тысяч довольных клиентов","support.guarantee":"Если товар не оригинальный — мы вернём 100% стоимости.","support.contactTitle":"Свяжитесь с нами","support.phoneLabel":"Телефон:","support.hoursLabel":"Время работы:","support.hoursValue":"09:00 – 18:00 (Пн–Пт)","support.contactNote":"Мы ценим ваши обращения и постараемся ответить как можно быстрее.","privacy.title":"Политика конфиденциальности","privacy.updated":"Последнее обновление: 2025 г.","privacy.intro":"Мы уважаем и защищаем личные данные пользователей. Данная Политика конфиденциальности объясняет, как ваши данные собираются, используются и хранятся.","privacy.s1title":"1. Какие данные собираются","privacy.s1a":"Имя и данные профиля","privacy.s1b":"Номер телефона или email","privacy.s1c":"Данные о заказах и корзине","privacy.s1d":"Техническая информация об устройстве","privacy.s2title":"2. Использование данных","privacy.s2intro":"Собранные данные используются для следующих целей:","privacy.s2a":"Выполнение заказов","privacy.s2b":"Управление аккаунтом","privacy.s2c":"Улучшение качества сервиса","privacy.s2d":"Обеспечение безопасности","privacy.s3title":"3. Защита данных","privacy.s3text":"Мы применяем современные меры безопасности для защиты ваших личных данных от несанкционированного доступа, изменения или распространения.","privacy.s4title":"4. Сторонние сервисы","privacy.s4text":"Наше приложение может использовать сторонние сервисы для оплаты, доставки и аутентификации. У этих сервисов есть своя политика конфиденциальности.","privacy.s5title":"5. Контакты","privacy.s5text":"Если у вас есть вопросы по Политике конфиденциальности, свяжитесь с нами:","terms.title":"Пользовательское соглашение","terms.updated":"Последнее обновление: 2025 г.","terms.intro":"Используя данное мобильное приложение, вы соглашаетесь с условиями настоящего Пользовательского соглашения. Если вы не согласны с условиями, пожалуйста, не используйте приложение.","terms.s1title":"1. Общие положения","terms.s1text":"Данное приложение предназначено для онлайн-покупки косметических и других товаров. Все материалы, логотипы и контент защищены авторским правом.","terms.s2title":"2. Регистрация аккаунта","terms.s2text":"Для оформления заказов пользователь должен создать аккаунт и предоставить достоверные данные. Пользователь несет ответственность за безопасность своего аккаунта.","terms.s3title":"3. Заказы и оплата","terms.s3text":"Заказы оформляются через приложение. Цены на товары могут изменяться без предварительного уведомления. Оплата производится согласно выбранному способу.","terms.s4title":"4. Доставка","terms.s4text":"Сроки доставки зависят от региона и выбранного метода. Мы не несем ответственности за задержки, вызванные сторонними доставочными сервисами.","terms.s5title":"5. Возврат и отмена","terms.s5text":"Политика возврата и отмены заказов описана в соответствующем разделе и на странице помощи и поддержки.","terms.s6title":"6. Ограничение ответственности","terms.s6text":"Мы не несем ответственности за косвенный ущерб, связанный с использованием приложения.","terms.s7title":"7. Изменения условий","terms.s7text":"Мы оставляем за собой право изменять данное соглашение в любое время. Актуальная версия всегда доступна в приложении.","licenses.title":"Open Source Libraries & Technologies","licenses.intro":"This application is built using the following open-source technologies","licenses.frontendTitle":"Android Frontend","licenses.fe1":"Android Jetpack – набор современных библиотек Android, используемых для управления жизненным циклом, навигации, ViewBinding и архитектурных компонентов для обеспечения стабильного пользовательского интерфейса.","licenses.fe2":"Retrofit – типобезопасный HTTP-клиент для Android, используемый для эффективного взаимодействия с REST API бэкенда.","licenses.fe3":"Glide – библиотека для загрузки и кэширования изображений, оптимизированная для плавной прокрутки и эффективного использования памяти.","licenses.fe4":"Firebase Authentication – обеспечивает безопасную аутентификацию пользователей через Google и проверку номера телефона (OTP).","licenses.fe5":"Facebook Shimmer – отображает анимированные заглушки загрузки для улучшения пользовательского опыта.","licenses.backendTitle":"Backend & Server Technologies","licenses.be1":"Spring Boot – фреймворк на базе Java, используемый для создания масштабируемых RESTful API.","licenses.be2":"Spring Security + JWT – реализует аутентификацию с использованием JSON Web Tokens для защиты пользовательских сессий и эндпоинтов API.","licenses.be3":"Spring Data JPA – упрощает доступ к базе данных с использованием ORM и паттерна репозитория.","licenses.be4":"MySQL – надёжная система управления реляционными базами данных для хранения учётных записей, заказов и товаров.","licenses.be5":"Eskiz SMS API – используется для верификации номера телефона и доставки одноразовых паролей (OTP).","licenses.infraTitle":"Infrastructure & Deployment","licenses.inf1":"Docker – технология контейнеризации для упаковки приложения со всеми зависимостями для стабильного развёртывания.","licenses.inf2":"Railway Cloud – облачная платформа для развёртывания, масштабирования и мониторинга бэкенд-сервисов.","licenses.securityTitle":"Security & Data Protection","licenses.sec1":"HTTPS – вся сетевая коммуникация зашифрована с использованием HTTPS для защиты данных пользователей.","licenses.sec2":"Безопасная обработка паролей – учётные данные пользователей никогда не хранятся в открытом виде.","licenses.sec3":"Авторизация на основе токенов – все защищённые запросы требуют валидных JWT токенов.","licenses.footer":"Мы уважаем сообщество open-source и строго соблюдаем все лицензионные требования и передовые практики безопасности.","status.NEW":"Новый","status.PENDING":"Ожидает","status.CONFIRMED":"Подтвержден","status.PACKED":"Упакован","status.SHIPPED":"Отправлен","status.DELIVERED":"Доставлен","status.CANCELED":"Отменен","category.SKINCARE":"Уход за кожей","category.MAKEUP":"Макияж","category.COLLAGEN":"Коллаген","category.HAIR_CARE":"Уход за волосами","category.FRAGRANCE":"Парфюм","category.TOP":"Верх","category.OUTER":"Верхняя одежда","category.PANTS":"Брюки","category.SHOES":"Обувь","category.BAG":"Сумки","category.ACCESSORY":"Аксессуары","home.todayOnly":"Только сегодня","checkout.title":"Оформление заказа","checkout.deliveryTitle":"Доставка","checkout.deliveryEta":"Заказ будет доставлен в течение 3–5 рабочих дней","checkout.addressNotSelected":"Адрес не выбран","checkout.selectAddress":"Выбрать адрес","checkout.receiverNotSelected":"Получатель не выбран","checkout.receiver":"Получатель","checkout.paymentMethod":"Способ оплаты","checkout.paymentCod":"Оплата при получении","checkout.paymentCodHint":"Оплата производится только наличными или переводом на банковскую карту","checkout.deliveryInfo":"Заказ будет доставлен курьером по адресу. Просим вас быть на связи во время доставки.","checkout.couponTitle":"Купон на скидку","checkout.applyCoupon":"Применить купон","checkout.yourOrder":"Ваш заказ","checkout.deliveryFee":"Доставка","checkout.totalToPay":"Итого к оплате","checkout.confirm":"Подтвердить","checkout.legalNotice":"Подтверждая заказ, вы соглашаетесь с Условиями использования и Политикой конфиденциальности.","checkout.deliveryOn":"Доставка {dates}","checkout.itemsCount":"{count} товаров","checkout.addressRequired":"Выберите адрес","checkout.receiverRequired":"Выберите получателя","checkout.back":"Назад","checkout.placing":"Оформление...","checkout.orderCreated":"Заказ создан","checkout.continueShopping":"Продолжить покупки","checkout.viewOrders":"Мои заказы","checkout.confirmTitle":"Подтверждение заказа","checkout.confirmQuestion":"Вы хотите отправить заказ?","checkout.confirmName":"Имя: {name}","checkout.confirmAddress":"Адреса: {address}","checkout.confirmDisclaimer":"После подтверждения изменить заказ можно только через службу поддержки.","checkout.cancel":"Отмена","checkout.successTitle":"Заказ успешно оформлен!","checkout.successSubtitle":"Заказ успешно принят","checkout.orderFailed":"Не удалось отправить заказ. Попробуйте снова.","checkout.noItems":"В корзине нет выбранных товаров.","checkout.invalidItems":"Некорректные идентификаторы товаров в корзине.","orders.refresh":"Обновить","reviews.my":"Мои отзывы","reviews.write":"Написать отзыв","reviews.submit":"Отправить отзыв","hero.eyebrow":"Лучшие предложения дня","hero.title":"Корейская косметика","hero.subtitle":"Быстрая доставка по Узбекистану — косметика, уход, парфюм и аксессуары.","hero.viewProducts":"Смотреть товары","hero.fastDelivery":"Быстрая доставка","hero.fastDeliverySub":"По всему Узбекистану","home.history":"История","home.recentlyViewed":"Недавно просмотренные","api.title":"Настройки API","api.save":"Сохранить"},ei={..._t,"header.location":"📍 타슈켄트","header.pickupPoints":"픽업 지점","header.sell":"판매자 되기","header.support":"고객 지원","header.orders":"주문","header.language":"언어","header.catalog":"카탈로그","header.searchPlaceholder":"상품 및 카테고리 검색","auth.login":"로그인","auth.register":"회원가입","auth.continueWithGoogle":"Google로 로그인","auth.or":"또는","auth.email":"이메일","auth.password":"비밀번호","auth.confirmPassword":"비밀번호 확인","auth.fullName":"이름","auth.phone":"전화번호","auth.logout":"로그아웃","auth.loginRequired":"계속하려면 로그인하세요","auth.emailRequired":"이메일은 필수입니다.","auth.passwordMin":"비밀번호는 6자 이상이어야 합니다.","auth.fullNameRequired":"이름은 필수입니다.","auth.phoneRequired":"전화번호는 필수입니다.","auth.passwordMismatch":"비밀번호가 일치하지 않습니다.","home.all":"전체","home.categories":"카테고리","home.quickCategories":"빠른 카테고리","home.lowPriceGuarantee":"최저가 보장","home.seeAll":"전체","home.quickCategories":"빠른 카테고리","home.todayDeals":"오늘의 특가","home.discounts":"할인","home.newArrivals":"신상품","home.popular":"인기 상품","home.recommended":"추천 상품","home.similar":"비슷한 상품","home.others":"함께 본 상품","home.startShopping":"쇼핑 시작","home.loadMore":"더 보기","product.addToCart":"장바구니","product.addToCartFull":"장바구니 담기","product.sold":"{count}개 판매","product.save":"저장","product.saved":"저장됨","product.description":"설명","product.detailImages":"상세 이미지","product.details":"상세 정보","product.reviews":"리뷰","product.delivery":"우즈베키스탄 전역 배송","product.secure":"안전한 결제","product.original":"정품 한국 제품","cart.title":"장바구니","cart.empty":"장바구니가 비어 있습니다","cart.checkout":"결제","cart.deliveryCourier":"택배 배송","cart.deliveryEta":"3일 내 배송","cart.selectAll":"전체 선택 ({selected}/{total})","cart.selectItem":"상품 선택","cart.deleteSelected":"삭제","cart.yourOrder":"주문 내역","cart.goodsCount":"상품 {count}개","cart.discount":"할인","cart.deliveryCost":"배송비","cart.freeDelivery":"무료","cart.products":"상품","cart.freeToHome":"무료 홈 배송","cart.shipsToday":"오늘 발송","cart.emptyHint":"마음에 드는 상품을 추가하면 여기에 표시됩니다.","orders.title":"주문 내역","orders.order":"주문","orders.details":"주문 상세","orders.history":"상태 기록","orders.none":"주문이 없습니다","orders.viewDetails":"자세히","orders.items":"상품 {count}개","orders.itemsCount":"상품 {count}개","orders.totalLabel":"합계:","orders.addressLabel":"주소:","orders.products":"상품","orders.emptyHint":"구매한 주문이 여기에 표시됩니다.","orders.unavailable":"주문을 불러올 수 없습니다","orders.detailUnavailable":"주문 상세를 불러올 수 없습니다","orders.noItems":"상품을 찾을 수 없습니다.","orders.deliveryInfo":"배송 정보","orders.openOnMap":"지도에서 열기","orders.orderActions":"주문 작업","orders.goodsLabel":"상품","orders.totalAmount":"총 금액","orders.feedback":"피드백","orders.statusMessage.NEW":"주문이 접수되었으며 곧 확인됩니다.","orders.statusMessage.CONFIRMED":"주문이 확인되어 준비 중입니다.","orders.statusMessage.PACKED":"주문이 포장되어 곧 발송됩니다.","orders.statusMessage.SHIPPED":"주문이 배송 중입니다. 연락 가능하도록 해 주세요.","orders.statusMessage.DELIVERED":"주문이 배송되었습니다. 구매해 주셔서 감사합니다!","orders.statusMessage.CANCELED":"주문이 취소되었습니다.","orders.statusMessage.default":"주문 상태가 업데이트되고 있습니다.","favorites.title":"찜","favorites.empty":"찜한 상품이 없습니다","favorites.emptyHint":"좋아하는 상품이 여기에 저장됩니다. 마음에 드는 상품을 추가하세요.","favorites.browse":"상품 보기","favorites.count":"상품 {count}개","favorites.unavailable":"찜 목록을 불러올 수 없습니다","reviews.none":"아직 리뷰가 없습니다","notifications.title":"알림","status.NEW":"신규","status.CONFIRMED":"확인됨","status.PACKED":"포장됨","status.SHIPPED":"배송 중","status.DELIVERED":"배송 완료","status.CANCELED":"취소됨","category.SKINCARE":"스킨케어","category.MAKEUP":"메이크업","category.COLLAGEN":"콜라겐","category.HAIR_CARE":"헤어 케어","category.FRAGRANCE":"향수","category.TOP":"상의","category.OUTER":"아우터","category.PANTS":"바지","category.SHOES":"신발","category.BAG":"가방","category.ACCESSORY":"액세서리","home.todayOnly":"오늘 한정","checkout.title":"주문하기","checkout.deliveryTitle":"배송","checkout.deliveryEta":"주문은 3–5 영업일 내에 배송됩니다","checkout.addressNotSelected":"주소가 선택되지 않음","checkout.selectAddress":"주소 선택","checkout.receiverNotSelected":"수령인이 선택되지 않음","checkout.receiver":"수령인","checkout.paymentMethod":"결제 방법","checkout.paymentCod":"착불 결제","checkout.paymentCodHint":"현금 또는 계좌 이체로만 결제할 수 있습니다","checkout.deliveryInfo":"주문은 주소로 택배 배송됩니다. 배송 중 연락 가능하도록 해 주세요.","checkout.couponTitle":"할인 쿠폰","checkout.applyCoupon":"쿠폰 적용","checkout.yourOrder":"주문 내역","checkout.deliveryFee":"배송비","checkout.totalToPay":"결제 금액","checkout.confirm":"확인","checkout.legalNotice":"주문을 확인하면 이용 약관 및 개인정보 처리방침에 동의하게 됩니다.","checkout.deliveryOn":"배송 {dates}","checkout.itemsCount":"상품 {count}개","checkout.addressRequired":"주소를 선택해 주세요","checkout.receiverRequired":"수령인을 선택해 주세요","checkout.back":"뒤로","checkout.placing":"주문 중...","checkout.orderCreated":"주문이 완료되었습니다","checkout.continueShopping":"쇼핑 계속하기","checkout.viewOrders":"주문 내역 보기","checkout.confirmTitle":"주문 확인","checkout.confirmQuestion":"주문을 보내시겠습니까?","checkout.confirmName":"이름: {name}","checkout.confirmAddress":"주소: {address}","checkout.confirmDisclaimer":"확인 후에는 고객 지원을 통해서만 주문을 변경할 수 있습니다.","checkout.cancel":"취소","checkout.successTitle":"주문이 완료되었습니다!","checkout.successSubtitle":"주문이 성공적으로 접수되었습니다","checkout.orderFailed":"주문을 보낼 수 없습니다. 다시 시도해 주세요.","checkout.noItems":"장바구니에 선택된 상품이 없습니다.","checkout.invalidItems":"장바구니 상품 ID가 올바르지 않습니다.","orders.refresh":"새로고침","reviews.my":"내 리뷰","reviews.write":"리뷰 작성","reviews.submit":"리뷰 제출","hero.eyebrow":"오늘의 베스트 특가","hero.title":"한국 뷰티 제품","hero.subtitle":"우즈베키스탄 전역 빠른 배송 — 화장품, 스킨케어, 향수, 액세서리.","hero.viewProducts":"상품 보기","hero.fastDelivery":"빠른 배송","hero.fastDeliverySub":"우즈베키스탄 전역","home.history":"기록","home.recentlyViewed":"최근 본 상품","profile.myProfile":"내 프로필","profile.edit":"프로필 수정","profile.save":"저장","profile.myOrders":"내 주문","profile.myReviews":"내 리뷰","profile.tierWhite":"White","profile.ordersStat":"주문","profile.reviewsStat":"리뷰","profile.couponsStat":"쿠폰","profile.feedbackStat":"피드백","profile.seeAll":"전체 보기","profile.promotions":"프로모션 및 쿠폰","profile.help":"도움말 및 지원","profile.news":"뉴스","profile.language":"언어 / Til / Language","profile.privacy":"개인정보 처리방침","profile.terms":"이용 약관","profile.licenses":"오픈소스 라이선스","profile.settings":"설정","profile.menu":"메뉴","profile.logout":"로그아웃","profile.loggedOut":"로그아웃되었습니다","profile.comingSoon":"곧 제공될 예정입니다","profile.helpMessage":"지원: support@beautyskin.uz","profile.fullName":"이름","profile.phone":"전화번호","profile.imageUrl":"프로필 이미지 URL","profile.loadUserFailed":"프로필을 불러오지 못했습니다","profile.loadOrdersFailed":"주문을 불러오지 못했습니다","profile.loadReviewsFailed":"리뷰를 불러오지 못했습니다","profile.loadFailed":"프로필 데이터를 불러오지 못했습니다","support.title":"고객 지원 센터","support.intro":"궁금한 점이 있으신가요? 저희가 도와드리겠습니다.","support.faqTitle":"자주 묻는 질문","support.faq.delivery.q":"주문한 상품은 언제 도착하나요?","support.faq.delivery.a":"주문은 보통 영업일 기준 3~5일 이내에 배송됩니다. 배송 기간은 지역과 선택한 택배 서비스에 따라 달라집니다. 자연재해나 기타 예기치 못한 상황이 없는 한 주문하신 상품은 예정된 기간 내에 도착합니다.","support.faq.cancel.q":"주문을 어떻게 취소하나요?","support.faq.cancel.a":"주문은 발송 전에만 취소할 수 있습니다. 주문이 택배 서비스로 전달된 후에는 취소가 불가능합니다. 취소하려면 프로필 섹션이나 고객 지원을 통해 문의하시면 됩니다.","support.faq.return.q":"상품을 반품할 수 있나요?","support.faq.return.a":"상품은 사용하지 않았고 포장이 손상되지 않았으며 온전한 상태로 보관된 경우에만 반품이 가능합니다. 반품 시 택배를 통한 상품 발송 비용은 고객이 부담합니다.","support.originalTitle":"100% 정품 및 한국 직배송","support.originalText":"저희 앱의 상품은 대한민국의 공식 제조사와 인증된 유통업체로부터 직접 수입됩니다. 위조품 판매는 엄격히 금지되어 있습니다.","support.whyTitle":"왜 저희인가요?","support.why1":"한국 직수입","support.why2":"위조품 없음","support.why3":"공장 포장 및 정품 봉인","support.why4":"모든 주문은 발송 전 검수","support.why5":"수천 명의 만족한 고객이 선택","support.guarantee":"상품이 정품이 아닐 경우 — 전액 100% 환불해 드립니다.","support.contactTitle":"문의하기","support.phoneLabel":"전화:","support.hoursLabel":"운영 시간:","support.hoursValue":"09:00 – 18:00 (월–금)","support.contactNote":"여러분의 문의를 소중히 여기며 최대한 빠르게 답변드리겠습니다.","privacy.title":"개인정보 처리방침","privacy.updated":"최종 업데이트: 2025년","privacy.intro":"저희는 사용자의 개인정보를 존중하고 보호합니다. 본 개인정보 처리방침은 귀하의 데이터가 어떻게 수집, 사용, 저장되는지 설명합니다.","privacy.s1title":"1. 수집하는 데이터","privacy.s1a":"이름 및 프로필 정보","privacy.s1b":"전화번호 또는 이메일","privacy.s1c":"주문 및 장바구니 데이터","privacy.s1d":"기기 기술 정보","privacy.s2title":"2. 데이터 사용","privacy.s2intro":"수집된 데이터는 다음 목적으로 사용됩니다:","privacy.s2a":"주문 처리","privacy.s2b":"계정 관리","privacy.s2c":"서비스 품질 개선","privacy.s2d":"보안 유지","privacy.s3title":"3. 데이터 보호","privacy.s3text":"저희는 귀하의 개인정보를 무단 접근, 변경 또는 유포로부터 보호하기 위해 최신 보안 조치를 적용합니다.","privacy.s4title":"4. 제3자 서비스","privacy.s4text":"저희 앱은 결제, 배송 및 인증을 위해 제3자 서비스를 사용할 수 있습니다. 이러한 서비스에는 자체 개인정보 처리방침이 있습니다.","privacy.s5title":"5. 연락처","privacy.s5text":"개인정보 처리방침에 대해 궁금한 점이 있으시면 저희에게 연락해 주세요:","terms.title":"이용약관","terms.updated":"최종 업데이트: 2025년","terms.intro":"본 모바일 애플리케이션을 사용함으로써 귀하는 본 이용약관에 동의하게 됩니다. 약관에 동의하지 않으시면 앱을 사용하지 마십시오.","terms.s1title":"1. 일반 조항","terms.s1text":"본 앱은 화장품 및 기타 상품의 온라인 구매를 위해 제공됩니다. 모든 자료, 로고 및 콘텐츠는 저작권으로 보호됩니다.","terms.s2title":"2. 계정 등록","terms.s2text":"주문을 하려면 사용자는 계정을 생성하고 정확한 정보를 제공해야 합니다. 사용자는 자신의 계정 보안에 대한 책임이 있습니다.","terms.s3title":"3. 주문 및 결제","terms.s3text":"주문은 앱을 통해 이루어집니다. 상품 가격은 사전 통지 없이 변경될 수 있습니다. 결제는 선택한 방법에 따라 진행됩니다.","terms.s4title":"4. 배송","terms.s4text":"배송 기간은 지역 및 선택한 방법에 따라 달라집니다. 제3자 배송 서비스로 인한 지연에 대해서는 책임지지 않습니다.","terms.s5title":"5. 반품 및 취소","terms.s5text":"반품 및 주문 취소 정책은 해당 섹션 및 도움말 및 지원 페이지에 설명되어 있습니다.","terms.s6title":"6. 책임 제한","terms.s6text":"앱 사용과 관련된 간접적 손해에 대해서는 책임지지 않습니다.","terms.s7title":"7. 약관 변경","terms.s7text":"저희는 언제든지 본 약관을 변경할 권리를 보유합니다. 최신 버전은 항상 앱에서 확인할 수 있습니다.","licenses.title":"Open Source Libraries & Technologies","licenses.intro":"이 애플리케이션은 다음 오픈소스 기술을 사용하여 제작되었습니다","licenses.frontendTitle":"Android Frontend","licenses.fe1":"Android Jetpack – 라이프사이클 관리, 내비게이션, ViewBinding 및 아키텍처 구성 요소에 사용되는 최신 Android 라이브러리 모음으로 안정적인 사용자 인터페이스를 보장합니다.","licenses.fe2":"Retrofit – 백엔드 REST API와 효율적으로 통신하기 위해 사용되는 Android용 타입 안전 HTTP 클라이언트입니다.","licenses.fe3":"Glide – 부드러운 스크롤과 효율적인 메모리 사용에 최적화된 이미지 로딩 및 캐싱 라이브러리입니다.","licenses.fe4":"Firebase Authentication – Google을 통한 안전한 사용자 인증과 전화번호 확인(OTP)을 제공합니다.","licenses.fe5":"Facebook Shimmer – 사용자 경험 향상을 위해 애니메이션 로딩 플레이스홀더를 표시합니다.","licenses.backendTitle":"Backend & Server Technologies","licenses.be1":"Spring Boot – 확장 가능한 RESTful API를 구축하는 데 사용되는 Java 기반 프레임워크입니다.","licenses.be2":"Spring Security + JWT – 사용자 세션과 API 엔드포인트를 보호하기 위해 JSON Web Tokens를 사용한 인증을 구현합니다.","licenses.be3":"Spring Data JPA – ORM 및 리포지토리 패턴을 사용하여 데이터베이스 접근을 단순화합니다.","licenses.be4":"MySQL – 계정, 주문 및 상품을 저장하기 위한 안정적인 관계형 데이터베이스 관리 시스템입니다.","licenses.be5":"Eskiz SMS API – 전화번호 인증 및 일회용 비밀번호(OTP) 전달에 사용됩니다.","licenses.infraTitle":"Infrastructure & Deployment","licenses.inf1":"Docker – 안정적인 배포를 위해 모든 종속성과 함께 애플리케이션을 패키징하는 컨테이너화 기술입니다.","licenses.inf2":"Railway Cloud – 백엔드 서비스를 배포, 확장 및 모니터링하기 위한 클라우드 플랫폼입니다.","licenses.securityTitle":"Security & Data Protection","licenses.sec1":"HTTPS – 사용자 데이터를 보호하기 위해 모든 네트워크 통신이 HTTPS로 암호화됩니다.","licenses.sec2":"안전한 비밀번호 처리 – 사용자 자격 증명은 절대 평문으로 저장되지 않습니다.","licenses.sec3":"토큰 기반 인증 – 모든 보호된 요청은 유효한 JWT 토큰을 요구합니다.","licenses.footer":"저희는 오픈소스 커뮤니티를 존중하며 모든 라이선스 요구 사항과 보안 모범 사례를 엄격히 준수합니다.","status.PENDING":"대기 중","api.title":"API 설정","api.save":"저장"},je={uz:Yr,en:_t,ru:Xa,ko:ei};let et=ti();function ti(){const e=localStorage.getItem(S.storageKeys.language);return Yt.includes(e)?e:Ze}function De(){return et}function n(e,t={}){var l;const r=je[et]||je[Ze],a=je.en||je[Ze],s=(r==null?void 0:r[e])??(a==null?void 0:a[e])??((l=je[Ze])==null?void 0:l[e])??e;return String(s).replace(/\{(\w+)\}/g,(d,u)=>t[u]??"")}let _r=()=>{};function ri(e){_r=e}function Jr(e){const t=Yt.includes(e)?e:Ze;et=t,localStorage.setItem(S.storageKeys.language,t),_r()}function Jt(e){var r;document.documentElement.lang=et,document.title=(e==null?void 0:e.currentRoute)==="product"&&((r=e==null?void 0:e.selectedDetailProduct)!=null&&r.name)?`${e.selectedDetailProduct.name} - BEAUTY SKIN KOREA`:"BEAUTY SKIN KOREA";const t=document.getElementById("languageSelect");t&&(t.value=et),document.querySelectorAll("[data-i18n]").forEach(a=>{a.textContent=n(a.dataset.i18n)}),document.querySelectorAll("[data-i18n-placeholder]").forEach(a=>{a.setAttribute("placeholder",n(a.dataset.i18nPlaceholder))}),document.querySelectorAll("[data-i18n-title]").forEach(a=>{a.setAttribute("title",n(a.dataset.i18nTitle))}),document.querySelectorAll("[data-i18n-aria-label]").forEach(a=>{a.setAttribute("aria-label",n(a.dataset.i18nAriaLabel))})}const It=e=>$("/api/products",{query:e,showError:!1}),ai=e=>$(`/api/products/${e}`),$r=(e,t)=>$("/api/products/category",{query:{category:e,...t},showError:!1}),qt=(e,t)=>$("/api/products/search",{query:{q:e,...t},showError:!1}),ii=()=>$("/api/products/today-deals",{showError:!1}),oi=e=>$("/api/products/by-ids",{method:"POST",body:JSON.stringify(e),showError:!1}),si=e=>$("/api/home",{query:e,showError:!1}),ni=e=>$("/api/home/feed",{query:e,showError:!1}),ci=(e,t)=>$(`/api/products/${e}/recommend`,{query:t,showError:!1});S.defaultPageSize;const li=()=>$("/api/categories",{showError:!1}),di=()=>$("/api/banners",{showError:!1}),ui=()=>$("/api/announcements",{showError:!1});function w(e){const t=Number(e);return Number.isFinite(t)?t:0}function yt(e){return e?typeof e=="string"?e:e.imageUrl||e.url||"":""}function ut(e){return Array.isArray(e)?e.map(t=>yt(t)).filter(Boolean):[]}function M(e){return Array.isArray(e==null?void 0:e.content)?e.content:Array.isArray(e)?e:[]}function V(e={}){const t=Array.isArray(e.variants)?e.variants:[],r=t.find(m=>Number(m.stock||0)>0)||t[0]||null,a=ut(e.images),s=ut(e.detailImages),l=yt(e.mainImageUrl)||a[0]||e.imageUrl||S.placeholderImage,d=w(e.price??(r==null?void 0:r.price)),u=w((r==null?void 0:r.discountPrice)??e.discountPrice??e.price),p=d>u&&d>0?Math.round((d-u)/d*100):0;return{id:e.id,name:e.name||"Mahsulot",description:e.description||"",brand:e.brand||"",category:e.category||"",image:l,images:a.length?a:[l],detailImages:s,price:w(e.price),originalPrice:d,discountPrice:w(e.discountPrice),finalPrice:u,discountPercent:p,stock:w(e.stock),ratingAvg:w(e.ratingAvg),reviewCount:w(e.reviewCount),soldCount:w(e.soldCount),todayDeal:!!e.todayDeal,favorite:!!e.favorite,variants:t,raw:e}}function pi(e={}){var l,d,u,p;const t=V(e.product||((l=e.variant)==null?void 0:l.product)||e),r=w(e.quantity)||1,a=w(e.unitPrice||t.finalPrice),s=w(e.lineTotal||a*r);return{id:e.id||e.cartItemId,productId:t.id,product:t,image:yt(e.image||e.imageUrl||e.mainImageUrl)||t.image,name:t.name,brand:t.brand,variantId:e.variantId||((d=e.variant)==null?void 0:d.id),variantLabel:e.variantLabel||((u=e.variant)==null?void 0:u.label)||"",unitPrice:a,lineTotal:s,quantity:r,stock:w(e.stock??((p=e.variant)==null?void 0:p.stock)??t.stock)}}function mi(e={}){const t=e.product||e,r=V(t);if(r.id===void 0||r.id===null){const a=t.productId??e.productId;a!=null&&(r.id=a)}return r.favorite=!0,r}function hi(e){return typeof e=="string"?e:(e==null?void 0:e.code)||(e==null?void 0:e.name)||(e==null?void 0:e.title)||""}function Qt(e={}){var a,s;const t=e.product||{},r=yt(e.mainImageUrl||t.mainImageUrl);return{id:e.id||e.orderItemId,productId:e.productId||t.id||((a=e.product)==null?void 0:a.id),orderId:e.orderId,name:e.productName||e.name||t.name||"Product",image:e.imageUrl||r||t.imageUrl||ut(t.images)[0]||S.placeholderImage,variantLabel:e.variantLabel||((s=e.variant)==null?void 0:s.label)||"",quantity:w(e.quantity)||1,unitPrice:w(e.unitPrice||e.price||t.discountPrice||t.price),lineTotal:w(e.lineTotal||e.total||e.price||0)}}function Qr(e={}){var t,r,a,s,l,d;return{id:e.id||e.reviewId||`${e.productId||"product"}-${e.orderId||"order"}-${e.createdAt||""}`,productId:e.productId||((t=e.product)==null?void 0:t.id)||((r=e.orderItem)==null?void 0:r.productId),orderId:e.orderId||((a=e.order)==null?void 0:a.id)||((s=e.orderItem)==null?void 0:s.orderId),rating:Math.min(5,Math.max(0,w(e.rating))),content:e.content||e.reviewContent||e.comment||"",imageUrls:Array.isArray(e.imageUrls)?e.imageUrls.filter(Boolean):ut(e.images),createdAt:e.createdAt||e.createdDate||e.reviewedAt||"",userName:e.userName||e.fullName||((l=e.user)==null?void 0:l.fullName)||((d=e.user)==null?void 0:d.name)||"Customer"}}function gi(e={}){return{id:e.id||e.notificationId,title:e.title||e.subject||"Notification",message:e.message||e.content||"",type:String(e.type||"SYSTEM").toUpperCase(),read:!!(e.read??e.isRead),createdAt:e.createdAt||e.createdDate||"",refId:e.refId||e.referenceId||e.orderId||null,raw:e}}function fi(e=""){const t=String(e||"SYSTEM").toUpperCase();return n(`notification.${t}`)}function vi(e){return typeof e=="number"?Math.max(0,e):typeof e=="string"&&e.trim()!==""?Math.max(0,Number(e)||0):typeof(e==null?void 0:e.data)=="number"?Math.max(0,e.data):typeof(e==null?void 0:e.count)=="number"?Math.max(0,e.count):typeof(e==null?void 0:e.unreadCount)=="number"?Math.max(0,e.unreadCount):0}function yi(e){var t;return Array.isArray(e==null?void 0:e.data)?e.data:Array.isArray((t=e==null?void 0:e.data)==null?void 0:t.content)?e.data.content:Array.isArray(e==null?void 0:e.content)?e.content:Array.isArray(e)?e:[]}function bi(e={}){var p,m,f;const t=e.review||e.reviewResponse||(e.rating||e.content?e:null),r=V(e.product||e.productCard||e.productResponse||e),a=t?Qr({...t,productId:t.productId||r.id,orderId:t.orderId||e.orderId}):null,s=e.productId||(a==null?void 0:a.productId)||r.id,l=e.orderId||((p=e.order)==null?void 0:p.id)||((m=e.orderResponse)==null?void 0:m.id)||(a==null?void 0:a.orderId),d=e.status||e.orderStatus||((f=e.order)==null?void 0:f.status)||"",u=!!(a!=null&&a.content||a!=null&&a.rating);return{id:e.id||e.orderItemId||(a==null?void 0:a.id)||`${s||"product"}-${l||"order"}`,productId:s,orderId:l,product:r,image:r.image||e.imageUrl||S.placeholderImage,name:e.productName||e.name||(r.name&&r.name!=="Mahsulot"?r.name:`Product #${s||"-"}`),brand:r.brand||e.brand||"",status:d,review:a,hasReview:u,reviewable:!!(s&&l&&!u),raw:e}}function wi(e){var t,r,a,s;return Array.isArray(e==null?void 0:e.data)?e.data:Array.isArray((t=e==null?void 0:e.data)==null?void 0:t.content)?e.data.content:Array.isArray((r=e==null?void 0:e.data)==null?void 0:r.items)?e.data.items:Array.isArray((a=e==null?void 0:e.data)==null?void 0:a.reviews)?e.data.reviews:Array.isArray((s=e==null?void 0:e.data)==null?void 0:s.reviewableItems)?e.data.reviewableItems:Array.isArray(e==null?void 0:e.reviews)?e.reviews:Array.isArray(e==null?void 0:e.items)?e.items:Array.isArray(e==null?void 0:e.reviewableItems)?e.reviewableItems:Array.isArray(e==null?void 0:e.content)?e.content:Array.isArray(e)?e:[]}function de(e){if(!e)return"";const t=`category.${e}`,r=n(t);return r!==t?r:Wr[e]||e.toLowerCase().split("_").map(a=>a.charAt(0).toUpperCase()+a.slice(1)).join(" ")}const ie={async loadProducts({page:e=0,size:t=S.defaultPageSize}={}){const r=await It({page:e,size:t});return r===null?{products:[],demoProducts:!1,failed:!0}:{products:M(r).map(V),demoProducts:!1,failed:!1}},async loadMoreProducts({feedPage:e,existingProducts:t}){let r=[];const a=await ni({limit:30});r=M(a).map(V);let s=e;if(!r.length){s+=1;const u=await It({page:s,size:S.defaultPageSize});r=M(u).map(V)}const l=new Set(t.map(u=>String(u.id))),d=r.filter(u=>u.id&&!l.has(String(u.id)));return{products:[...t,...d],nextProducts:d,nextFeedPage:s}},async loadTodayDeals(){const e=await ii();return e===null?{deals:[],demoDeals:!1,failed:!0}:{deals:M(e).map(V),demoDeals:!1,failed:!1}},async loadProduct(e,t=null){const r=await ai(e);return V(r||t||{})},async loadProductsByIds(e){const t=e.map(Number).filter(Number.isFinite);if(!t.length)return[];const r=await oi(t);return M(r).map(V).filter(a=>a.id)},async search(e,t={}){const r=await qt(e,{page:0,size:S.defaultPageSize,...t});return r===null?[]:M(r).map(V)},async loadByCategory(e,t={}){const r=await $r(e,{page:0,size:S.defaultPageSize,...t});return r===null?[]:M(r).map(V)},async loadBrandProducts(e,t,r){const a=t.length?t.filter(l=>l.brand===e):r.filter(l=>l.brand===e);if(a.length)return a;const s=await qt(e,{page:0,size:24});return M(s).map(V).filter(l=>l.brand===e)},async loadRecommendations(e,t){const r=await ci(e.id,{similar:12,others:24,seed:t}),a=M((r==null?void 0:r.similar)||[]).map(V).filter(u=>String(u.id)!==String(e.id)),s=M((r==null?void 0:r.others)||[]).map(V).filter(u=>String(u.id)!==String(e.id));if(a.length||s.length)return{mode:"api",similar:a.slice(0,12),others:s.slice(0,12),fallback:[],failed:!1};let l=null;e.category&&(l=await $r(e.category,{page:0,size:12}));let d=M(l).map(V).filter(u=>String(u.id)!==String(e.id));return d.length||(l=await It({page:0,size:12}),d=M(l).map(V).filter(u=>String(u.id)!==String(e.id))),{mode:"fallback",similar:[],others:[],fallback:d.slice(0,12),failed:!d.length&&l===null}},pickDefaultVariant(e){var t,r;return((t=e.variants)==null?void 0:t.find(a=>Number(a.stock||0)>0))||((r=e.variants)==null?void 0:r[0])||null},async resolveAddToCartVariant(e,t){var s;if(t)return{variantId:t,navigateToProduct:!1};const r=await this.loadProduct(e),a=r.variants.filter(l=>Number(l.stock||0)>0);return a.length===1?{variantId:a[0].id,navigateToProduct:!1,product:r}:r.variants.length>1?{variantId:null,navigateToProduct:!0,product:r}:{variantId:((s=this.pickDefaultVariant(r))==null?void 0:s.id)||null,navigateToProduct:!1,product:r}}},ki=["SKINCARE","MAKEUP","COLLAGEN","HAIR_CARE","FRAGRANCE"];function Si(e,t,r){return(e==null?void 0:e.id)!==void 0&&r.findIndex(a=>String(a.id)===String(e.id))===t}const oe={async loadHomeApiData(e={limit:10,page:0,size:20}){const t=await si(e);if(t===null)return{loaded:!1};const r=M(t.hits||[]).map(V),a=M(t.discounts||[]).map(V),s=M(t.newArrivals||[]).map(V),l=M(t.popular).map(V);if(!(r.length||a.length||s.length||l.length))return{loaded:!1};const u=l.length?l:[...r,...a,...s].filter(Si);return{loaded:!0,hits:r,discounts:a,newArrivals:s,products:u,todayDeals:a,homeApiSections:{hits:r,discounts:a,newArrivals:s}}},async loadCategories(){const e=await li(),t=M(e).map(hi).filter(Boolean);return t.length?{categories:t,demoCategories:!1}:{categories:ki,demoCategories:!1}},async loadBanners(){const e=await di();return M(e).map(t=>({id:t.id,title:t.title||"",subtitle:t.subtitle||"",imageUrl:t.imageUrl||"",linkType:String(t.linkType||"NONE").toUpperCase(),linkId:t.linkId,position:w(t.position)})).sort((t,r)=>t.position-r.position)},async loadAnnouncements(){const e=await ui();return M(e).map(t=>({title:t.title||"",message:t.content||t.message||"",type:String(t.type||"SYSTEM").toUpperCase(),createdAt:t.createdAt||""})).filter(t=>t.title||t.message)},getRecentProductIds(){try{return JSON.parse(localStorage.getItem(S.storageKeys.recentProducts)||"[]").filter(Boolean)}catch{return[]}},addRecentProduct(e){if(!e||String(e).startsWith("demo-"))return;const t=[String(e),...this.getRecentProductIds().filter(r=>String(r)!==String(e))].slice(0,12);localStorage.setItem(S.storageKeys.recentProducts,JSON.stringify(t))},async loadRecentlyViewed(){const e=this.getRecentProductIds();return e.length?ie.loadProductsByIds(e):[]}},B={};function Ci(e){Object.assign(B,e)}function i(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function L(e){const t=De(),r={uz:"so'm",en:"UZS",ru:"сум",ko:"UZS"},a=t==="uz"?"uz-UZ":t;return`${new Intl.NumberFormat(a).format(w(e))} ${r[t]||"UZS"}`}function Zr(e){return L(e)}function Zt(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return String(e);const r=De();return new Intl.DateTimeFormat(r,{year:"numeric",month:"short",day:"2-digit",hour:"2-digit",minute:"2-digit"}).format(t)}function $i(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return String(e);const r=De(),a=new Intl.DateTimeFormat(r,{day:"2-digit",month:"short",year:"numeric"}).format(t),s=new Intl.DateTimeFormat(r,{hour:"2-digit",minute:"2-digit"}).format(t);return`${a} • ${s}`}function Pi({discountPercent:e,todayDeal:t,isNew:r,todayDealLabel:a}){return`
  ...
  `}function Ei({stock:e,lowStockLabel:t,outOfStockLabel:r}){const a=e>0&&e<=5,s=e===0;return!a&&!s?"":`<span class="ds-badge ds-badge--stock">${i(s?r:t)}</span>`}function bt({rating:e,label:t="Rating",className:r="stars"}){const a=Math.min(5,Math.max(0,Math.round(w(e))));return`
    <span class="${i(r)}" role="img" aria-label="${i(t)} ${a} out of 5">
      ${Array.from({length:5},(s,l)=>`<span class="${l<a?"filled":""}">★</span>`).join("")}
    </span>
  `}function Ii({ratingAvg:e,reviewCount:t=0,className:r="rating"}){const a=w(e);return`
    <span class="${i(r)}">
      <span class="star" aria-hidden="true">★</span>
      ${a.toFixed(1)}
      <span class="review-count">(${t})</span>
    </span>
  `}function Ai({ratingAvg:e,reviewCount:t=0}){return e?`
    <div class="rating-line">
      <span class="star" aria-hidden="true">★</span>
      ${w(e).toFixed(1)}
      <span class="review-count">(${t})</span>
    </div>
  `:""}function Li({product:e,screen:t="home",position:r=0,isFavorite:a=!1,isCompared:s=!1,isAdding:l=!1,labels:d={}}){const u=w(e.stock),p=u===0,{favoritesTitle:m="Favorites",todayOnly:f="Today only",lowStock:k="Low stock",outOfStock:I="Out of stock",freeShipping:v="Free shipping",quickView:R="Quick view",compare:E="Compare",sold:N="",adding:x="Adding...",addToCart:U="Add to cart",viewDetails:X="View details"}=d;return`
    <article class="product-card" data-product="${i(e.id)}" data-screen="${i(t)}" data-position="${i(r)}" role="link" tabindex="0" aria-label="${i(e.name)}">
      <div class="card-media">
        ${Pi({discountPercent:e.discountPercent,todayDeal:e.todayDeal,isNew:e.isNew,todayDealLabel:f})}
        ...
        <div class="card-badges-bottom">
          ${Ei({stock:u,lowStockLabel:k,outOfStockLabel:I})}
  ...
  `}function Ti({message:e,actionLabel:t="",actionAttrs:r='data-show-all type="button"'}){const a=t?`<button class="secondary-button" ${r}>${i(t)}</button>`:"";return`
    <div class="empty-state">
      <strong>${i(e)}</strong>
      ${a}
    </div>
  `}function Xr(e,t){e&&(e.innerHTML=Ti(t))}function Di({products:e,renderCard:t}){return e.map((r,a)=>t(r,a)).join("")}function Ri(e,{products:t,emptyMessage:r,emptyActionLabel:a,renderCard:s}){return t.length?(e.innerHTML=Di({products:t,renderCard:s}),!0):(Xr(e,{message:r,actionLabel:a}),!1)}function Mi(){return`
  ...
  `}function qi({count:e=12}={}){return Array.from({length:e},()=>Mi()).join("")}function Bi(e,t=12){e&&(e.innerHTML=qi({count:t}))}function ge(e=document){if(e.querySelectorAll("img[data-src], img[loading='lazy']").forEach(r=>{if(r.dataset.loaded)return;r.classList.add("img-loading");const a=()=>{r.classList.remove("img-loading"),r.classList.add("img-loaded"),r.dataset.loaded="1"};if(r.complete&&r.naturalWidth){a();return}r.addEventListener("load",a,{once:!0}),r.addEventListener("error",()=>r.classList.remove("img-loading"),{once:!0})}),"IntersectionObserver"in window){const r=new IntersectionObserver(a=>{a.forEach(s=>{if(!s.isIntersecting)return;const l=s.target;l.dataset.src&&!l.src&&(l.src=l.dataset.src),r.unobserve(l)})},{rootMargin:"200px"});e.querySelectorAll("img[data-src]").forEach(a=>r.observe(a))}}const ea="beauty_skin_compare",Ve=4;function Ge(){try{return JSON.parse(localStorage.getItem(ea)||"[]").slice(0,Ve)}catch{return[]}}function Xt(e){localStorage.setItem(ea,JSON.stringify(e.slice(0,Ve)))}function Oi(e){const t=String(e);let r=Ge();if(r.includes(t))r=r.filter(a=>a!==t);else{if(r.length>=Ve)return{ids:r,added:!1,full:!0};r=[...r,t]}return Xt(r),{ids:r,added:r.includes(t),full:!1}}function xi(e){const t=Ge().filter(r=>r!==String(e));return Xt(t),t}function Ni(){return Xt([]),[]}const Fi=["red","blue","pink","black","white","green","nude","coral","beige","brown","purple","orange","yellow","gray","grey","rose","peach","ivory","gold","silver"],zi=["xs","s","m","l","xl","xxl","ml","g","oz","50ml","100ml","150ml","200ml","30ml"];function Hi(e){const t=new Set,r=new Set,a=new Set;let s=0;return e.forEach(l=>{var d;l.brand&&t.add(l.brand),s=Math.max(s,w(l.finalPrice)),(d=l.variants)==null||d.forEach(u=>{const p=String(u.label||"").toLowerCase();Fi.forEach(m=>{p.includes(m)&&r.add(m.charAt(0).toUpperCase()+m.slice(1))}),zi.forEach(m=>{p.includes(m)&&a.add(m.toUpperCase())}),u.color&&r.add(u.color),u.size&&a.add(u.size)})}),{brands:[...t].sort(),colors:[...r].sort(),sizes:[...a].sort(),maxPrice:s||5e6}}function Ui(e,t){var a,s,l;let r=[...e];return(a=t.brands)!=null&&a.length&&(r=r.filter(d=>t.brands.includes(d.brand))),(t.minPrice>0||t.maxPrice<5e6)&&(r=r.filter(d=>{const u=w(d.finalPrice);return u>=t.minPrice&&u<=t.maxPrice})),t.minRating>0&&(r=r.filter(d=>w(d.ratingAvg)>=t.minRating)),t.onSale&&(r=r.filter(d=>w(d.discountPercent)>0||d.todayDeal)),t.inStock&&(r=r.filter(d=>w(d.stock)>0)),t.fastDelivery&&(r=r.filter(d=>w(d.stock)>0)),(s=t.colors)!=null&&s.length&&(r=r.filter(d=>{const u=(d.variants||[]).map(p=>String(p.label||p.color||"").toLowerCase()).join(" ");return t.colors.some(p=>u.includes(p.toLowerCase()))})),(l=t.sizes)!=null&&l.length&&(r=r.filter(d=>{const u=(d.variants||[]).map(p=>String(p.label||p.size||"").toLowerCase()).join(" ");return t.sizes.some(p=>u.includes(p.toLowerCase()))})),Vi(r,t.sort)}function Vi(e,t){const r=[...e];switch(t){case"price-asc":return r.sort((a,s)=>w(a.finalPrice)-w(s.finalPrice));case"price-desc":return r.sort((a,s)=>w(s.finalPrice)-w(a.finalPrice));case"rating":return r.sort((a,s)=>w(s.ratingAvg)-w(a.ratingAvg));case"newest":return r.sort((a,s)=>w(s.id)-w(a.id));case"discount":return r.sort((a,s)=>w(s.discountPercent)-w(a.discountPercent));default:return r.sort((a,s)=>w(s.soldCount)-w(a.soldCount))}}const ta="beauty_skin_filters",Le={brands:[],minPrice:0,maxPrice:5e6,colors:[],sizes:[],minRating:0,onSale:!1,inStock:!1,fastDelivery:!1,origin:[],seller:[],sort:"popular",viewMode:"grid"};function Ki(){try{const e=JSON.parse(localStorage.getItem(ta)||"{}");return{...Le,...e}}catch{return{...Le}}}function Gi(e){localStorage.setItem(ta,JSON.stringify({brands:e.brands,minPrice:e.minPrice,maxPrice:e.maxPrice,colors:e.colors,sizes:e.sizes,minRating:e.minRating,onSale:e.onSale,inStock:e.inStock,fastDelivery:e.fastDelivery,origin:e.origin,seller:e.seller,sort:e.sort,viewMode:e.viewMode}))}function ji(){return{...Le}}function Wi(e){let t=0;return e.brands.length&&(t+=e.brands.length),e.colors.length&&(t+=e.colors.length),e.sizes.length&&(t+=e.sizes.length),e.origin.length&&(t+=e.origin.length),e.seller.length&&(t+=e.seller.length),e.minRating>0&&(t+=1),e.onSale&&(t+=1),e.inStock&&(t+=1),e.fastDelivery&&(t+=1),(e.minPrice>Le.minPrice||e.maxPrice<Le.maxPrice)&&(t+=1),t}const er="beauty_skin_saved_for_later";function tr(){try{return JSON.parse(localStorage.getItem(er)||"[]")}catch{return[]}}function Yi(e){const t=tr();if(t.some(a=>String(a.id)===String(e.id)))return t;const r=[...t,{id:e.id,name:e.name,image:e.image,unitPrice:e.unitPrice,brand:e.brand,variantLabel:e.variantLabel}];return localStorage.setItem(er,JSON.stringify(r)),r}function _i(e){const t=tr().filter(r=>String(r.id)!==String(e));return localStorage.setItem(er,JSON.stringify(t)),t}const Ee=5e5,Ji=3e4,Qi=["Korea","Japan","USA"],Zi=["Official Store","Beauty Skin Korea","Verified Seller"];function Xi(){c.filters||(c.filters=Ki())}function eo(e){c.sourceProducts=e,c.filterFacets=Hi(e),c.filters.maxPrice===Le.maxPrice&&c.filterFacets.maxPrice&&(c.filters.maxPrice=Math.ceil(c.filterFacets.maxPrice/1e3)*1e3)}function to(){return Ui(c.sourceProducts,c.filters)}function wt(e,t){const r=document.getElementById("filterSidebar"),a=document.getElementById("filterSheetContent"),s=ro(e);r&&(r.innerHTML=s),a&&(a.innerHTML=s),ao()}function ro(e,t){const r=c.filters,a=c.filterFacets,s=a.brands.map(u=>We("brand",u,r.brands.includes(u))).join(""),l=a.colors.map(u=>We("color",u,r.colors.includes(u))).join(""),d=a.sizes.map(u=>We("size",u,r.sizes.includes(u))).join("");return`
    ...
    ${ce(e("filter.origin"),Qi.map(u=>We("origin",u,r.origin.includes(u))).join(""))}
    ${ce(e("filter.seller"),Zi.map(u=>We("seller",u,r.seller.includes(u))).join(""))}
  ...
  `}function pt(e){const t=document.getElementById("filterChipsRow");if(!t)return;const r=[],a=c.filters;a.brands.forEach(s=>r.push(Me(s,`brand:${s}`))),a.colors.forEach(s=>r.push(Me(s,`color:${s}`))),a.sizes.forEach(s=>r.push(Me(s,`size:${s}`))),a.onSale&&r.push(Me(e("filter.onSaleOnly"),"onSale")),a.inStock&&r.push(Me(e("filter.inStock"),"inStock")),a.minRating&&r.push(Me(`${a.minRating}★+`,"rating")),t.hidden=!r.length,t.innerHTML=r.join("")}function Me(e,t){return`<span class="filter-chip-active">${i(e)}<button type="button" data-remove-chip="${i(t)}" aria-label="Remove">×</button></span>`}function ao(){const e=document.getElementById("filterBadgeCount"),t=Wi(c.filters);e&&(e.textContent=t,e.hidden=t===0)}function $e(){Gi(c.filters)}function io(){const e=c.filterFacets.maxPrice||Le.maxPrice;c.filters={...ji(),maxPrice:e},$e()}function Bt(e,t){var r,a,s,l;e&&(e.classList.toggle("list-view",t==="list"),(r=document.getElementById("gridViewBtn"))==null||r.classList.toggle("active",t==="grid"),(a=document.getElementById("listViewBtn"))==null||a.classList.toggle("active",t==="list"),(s=document.getElementById("gridViewBtn"))==null||s.setAttribute("aria-pressed",t==="grid"),(l=document.getElementById("listViewBtn"))==null||l.setAttribute("aria-pressed",t==="list"))}function oo(e){const t=document.getElementById("compareFab"),r=document.getElementById("compareFabCount");r&&(r.textContent=e),t==null||t.classList.toggle("visible",e>0)}function Pr(e,t){const r=document.getElementById("compareDrawerContent");if(r){if(!e.length){r.innerHTML=`<div class="empty-state"><strong>${i(t("compare.empty"))}</strong></div>`;return}r.innerHTML=e.map(a=>`
  ...
  `:""}function so(e,t={}){const r=document.getElementById("cartExtras");if(!r)return;const a=w(t.subtotal??b.cartTotal),s=Math.min(100,a/Ee*100),l=Math.max(0,Ee-a),d=tr(),u=t.recommendedHtml||"",p=t.recentHtml||"";r.innerHTML=`
  ...
  `}function no(e){const t=Date.now(),r=Math.max(0,e-t),a=Math.floor(r/36e5),s=Math.floor(r%36e5/6e4),l=Math.floor(r%6e4/1e3),d=u=>String(u).padStart(2,"0");return`
  ...
  `}const rr=(e,t={})=>$(e,{...t,showError:!1}),lo=e=>rr("/events/impression",{method:"POST",body:JSON.stringify(e)}),uo=e=>rr("/events/click",{method:"POST",query:{productId:e}}),po=e=>rr("/events/view",{method:"POST",query:{productId:e}}),mt={isTrackableProduct(e){return!!e&&!String(e).startsWith("demo-")},impressionKey(e,t,r){return`${e}:${t}:${r}`},shouldSendImpression(e,t,r,a){if(!this.isTrackableProduct(a))return!1;const s=this.impressionKey(t,r,a);return e.has(s)?!1:(e.add(s),!0)},sendImpression({productId:e,screen:t,position:r,sessionId:a,queryText:s}){return lo({productId:Number(e),screen:t,position:r,queryText:s||null,sessionId:a}).catch(()=>{})},sendProductClick(e){this.isTrackableProduct(e)&&uo(e).catch(()=>{})},sendProductView(e){this.isTrackableProduct(e)&&po(e).catch(()=>{})}};function Ir(e,t,r){mt.shouldSendImpression(h.impressionsSent,h.sessionId,t||"home",e)&&mt.sendImpression({productId:e,screen:t||"home",position:r,sessionId:h.sessionId,queryText:h.currentSearchQuery})}function st(e){mt.sendProductClick(e)}function mo(e){mt.sendProductView(e)}function aa(e){if(!("IntersectionObserver"in window)){e.querySelectorAll("[data-product]").forEach(t=>{Ir(t.dataset.product,t.dataset.screen||"home",Number(t.dataset.position||0))});return}h.impressionObserver||(h.impressionObserver=new IntersectionObserver(t=>{t.forEach(r=>{if(!r.isIntersecting)return;const a=r.target;Ir(a.dataset.product,a.dataset.screen||"home",Number(a.dataset.position||0)),h.impressionObserver.unobserve(a)})},{threshold:.35})),e.querySelectorAll("[data-product]").forEach(t=>h.impressionObserver.observe(t))}function ho(){return{favoritesTitle:n("favorites.title"),todayOnly:n("home.todayOnly"),lowStock:n("product.lowStock"),outOfStock:n("product.outOfStock"),freeShipping:n("product.freeShipping"),quickView:n("product.quickView"),compare:n("product.compare"),adding:n("product.adding"),addToCart:n("product.addToCart"),viewDetails:n("product.viewDetails")}}function Ke(e,t={}){const r=ho();return r.sold=n("product.sold",{count:e.soldCount}),Li({product:e,screen:t.screen||h.currentGridScreen||"home",position:t.position??0,isFavorite:C.favoriteIds.has(String(e.id))||!!e.favorite,isCompared:Ge().includes(String(e.id)),isAdding:b.addingProductIds.has(String(e.id)),labels:r})}function Ne(e,t=12){Bi(e,t)}function pe(e,t,r=n("home.showAll")){Xr(e,{message:t,actionLabel:r})}function Q(e,t,r,a={}){var l;Ri(e,{products:t,emptyMessage:r,emptyActionLabel:n("home.showAll"),renderCard:(d,u)=>Ke(d,{...a,position:u})})&&(aa(e),ge(e),Bt(e,((l=c.filters)==null?void 0:l.viewMode)||"grid"))}function ne(e,t,r={}){eo(e),wt(n),pt(n);const a=to();Q(o.grid,a,t,r);const s=document.getElementById("sortSelect");s&&s.value!==c.filters.sort&&(s.value=c.filters.sort)}function Ar(e,t){e&&(e.hidden=!t)}function Fe(){Ar(o.productsMode,c.demoProducts),Ar(o.dealsMode,c.demoDeals)}function go(e){C.favoriteProducts=e.filter(t=>t.id!==void 0&&t.id!==null),C.favoriteIds=new Set(C.favoriteProducts.map(t=>String(t.id))),C.favoritesCount=C.favoriteProducts.length,he()}function Ot(){C.favoriteProducts=[],C.favoriteIds=new Set,C.favoritesLoading=!1,C.favoritesError="",C.favoritesCount=0,he()}function he(){var e;c.products=c.products.map(t=>({...t,favorite:C.favoriteIds.has(String(t.id))})),c.todayDeals=c.todayDeals.map(t=>({...t,favorite:C.favoriteIds.has(String(t.id))})),((e=c.selectedDetailProduct)==null?void 0:e.id)!==void 0&&(c.selectedDetailProduct={...c.selectedDetailProduct,favorite:C.favoriteIds.has(String(c.selectedDetailProduct.id))})}function fo({banners:e=[]}){return e.length?`
  ...
  `:""}function vo({announcements:e=[],limit:t=3}){return e.slice(0,t).map(r=>`
    <article class="announcement-item ${r.type.toLowerCase()}">
      <strong>${i(r.title||r.type)}</strong>
      <span>${i(r.message)}</span>
    </article>
  `).join("")}const ia={search(e,t){return ie.search(e,t)},loadByCategory(e,t){return ie.loadByCategory(e,t)}};function yo({category:e,label:t,active:r=!1}){return`
    <button class="chip ${r?"active":""}" data-category="${i(e)}" type="button">
      ${i(t)}
    </button>
  `}function bo({categories:e,selectedCategory:t,labelFor:r}){return e.map(a=>yo({category:a,label:r(a),active:t===a})).join("")}const wo=["SNAIL CREAM","COSRX","SUNSCREEN","LIP TINT","VITAMIN C","COLLAGEN"],te={renderCategories(){const e=["ALL",...c.categories];o.categoryToolbar.innerHTML=bo({categories:e,selectedCategory:c.selectedCategory,labelFor:t=>t==="ALL"?n("home.all"):de(t)}),te.renderCatalogList(),te.renderQuickCategories()},renderCatalogList(){const e=["ALL",...c.categories];o.catalogList.innerHTML=e.map(t=>`
    ...
    `).join(""),te.renderMegaMenu(),te.renderPopularSearches(),te.renderMobileNav()},renderPopularSearches(){const e=document.getElementById("popularSearchesChips");e&&(e.innerHTML=wo.map(t=>`
    ...
    `},async loadMoreProducts(){if(c.feedLoading)return;c.feedLoading=!0,o.loadMore.disabled=!0,o.loadMore.textContent="Yuklanmoqda...";const{products:e,nextProducts:t,nextFeedPage:r}=await ie.loadMoreProducts({feedPage:c.feedPage,existingProducts:c.products});c.feedPage=r,c.products=e,he(),ne(c.products,"Mahsulot topilmadi.",{screen:h.currentGridScreen||"home"}),c.feedLoading=!1,o.loadMore.disabled=!1,o.loadMore.textContent=t.length?"Yana yuklash":"Boshqa mahsulot topilmadi"},async renderCategoryProducts(e,{showHomeView:t}={}){if(h.currentRoute==="product"&&(window.location.hash="#/",t==null||t()),c.selectedCategory=e,h.currentGridScreen=e==="ALL"?"home":"category",h.currentSearchQuery="",te.renderCategories(),e==="ALL"){o.title.textContent=n("home.popular"),await F.loadProducts();return}o.title.textContent=de(e),o.status.textContent=n("home.loading"),Ne(o.grid,10);const r=await ia.loadByCategory(e);c.products=r,he(),ne(c.products,n("home.noProducts"),{screen:"category"}),o.status.textContent=""}},ko=5e3;let nt=null,xt=!1,Xe=null,Lr=0;function kt(){var e;return(e=o.banners)==null?void 0:e.querySelector(".banner-track")}function St(){return c.banners.length}function ar(){const e=kt();if(!e)return 0;const t=e.clientWidth||1;return Math.max(0,Math.min(St()-1,Math.round(e.scrollLeft/t)))}function Lt(){var t;const e=ar();(t=o.banners)==null||t.querySelectorAll("[data-banner-dot]").forEach(r=>{const a=Number(r.dataset.bannerDot)===e;r.classList.toggle("active",a),r.setAttribute("aria-selected",a?"true":"false")})}function Nt(e,t="smooth"){const r=kt(),a=St();if(!r||!a)return;const s=(e%a+a)%a;r.scrollTo({left:s*r.clientWidth,behavior:t})}function oa(){Nt(ar()+1)}function ir(){nt&&(clearInterval(nt),nt=null)}function Ft(){ir(),!(xt||St()<=1)&&(nt=setInterval(()=>oa(),ko))}function So(){ir();const e=kt();e&&Xe&&e.removeEventListener("scroll",Xe),Xe=null,o.banners&&(o.banners.onmouseenter=null,o.banners.onmouseleave=null)}function Co(){So();const e=kt();if(!e||St()<=1){Lt();return}Xe=()=>{clearTimeout(Lr),Lr=setTimeout(Lt,80)},e.addEventListener("scroll",Xe,{passive:!0}),o.banners.onmouseenter=()=>{xt=!0,ir()},o.banners.onmouseleave=()=>{xt=!1,Ft()},Lt(),Ft()}function Tr(e){const t=document.querySelector(".hero-main");if(t){if(!e){t.style.removeProperty("--hero-campaign-image");return}t.style.setProperty("--hero-campaign-image",`url("${e}")`)}}const F={renderBanners(){var e;if(!c.banners.length){o.banners.hidden=!0,o.banners.innerHTML="",Tr("");return}o.banners.hidden=!1,o.banners.innerHTML=fo({banners:c.banners}),Tr(((e=c.banners[0])==null?void 0:e.imageUrl)||""),Co()},renderAnnouncements(){if(!c.announcements.length){o.announcements.hidden=!0,o.announcements.innerHTML="";return}o.announcements.hidden=!1,o.announcements.innerHTML=vo({announcements:c.announcements})},renderHomeApiSections(e){const t=e.hits||[],r=e.newArrivals||[],a=document.getElementById("personalizationSection"),s=document.getElementById("personalizationGrid");if(s){const d=t.length?t:c.products.slice(0,10);a&&(a.hidden=!d.length),d.length&&Q(s,d.slice(0,10),n("home.noProducts"),{screen:"home-for-you"})}const l=document.getElementById("newArrivalsGrid");if(l){const d=r.length?r:c.products.slice(0,10);Q(l,d.slice(0,10),n("home.noProducts"),{screen:"home-new"})}o.homeApiSections.hidden=!0,o.homeApiSections.innerHTML=""},renderPersonalizationSections(){var a,s;const e=document.getElementById("personalizationSection"),t=document.getElementById("personalizationGrid");if(!e||!t||t.children.length)return;const r=(s=(a=c.homeApiSections)==null?void 0:a.hits)!=null&&s.length?c.homeApiSections.hits:c.products.slice(0,10);e.hidden=!r.length,r.length&&Q(t,r.slice(0,10),n("home.noProducts"),{screen:"home-for-you"})},async loadCategories(){const{categories:e,demoCategories:t}=await oe.loadCategories();c.categories=e,c.demoCategories=t,Fe(),te.renderCategories()},async loadBanners(){c.banners=await oe.loadBanners(),F.renderBanners()},async loadAnnouncements(){c.announcements=await oe.loadAnnouncements(),F.renderAnnouncements()},async loadRecentlyViewed(){if(!oe.getRecentProductIds().length){c.recentlyViewed=[],o.recentlyViewedSection.hidden=!0;return}c.recentlyViewed=await oe.loadRecentlyViewed();const t=c.recentlyViewed||[];if(!t.length){o.recentlyViewedSection.hidden=!0;return}o.recentlyViewedSection.hidden=!1,Q(o.recentlyViewedGrid,t,"Recently viewed is empty.",{screen:"recent"})},async loadProducts(){try{o.status.textContent="Yuklanmoqda...",Ne(o.grid,12);const{products:e,demoProducts:t,failed:r}=await ie.loadProducts();e.length?(c.products=e,c.demoProducts=t,ne(c.products,"Mahsulot topilmadi.",{screen:h.currentGridScreen||"home"})):(c.products=[],c.demoProducts=t,pe(o.grid,r?"API data failed to load.":"Mahsulot topilmadi.")),he()}catch(e){console.error("[LOAD PRODUCTS FAILED]",e),c.demoProducts=!1,pe(o.grid,"API data failed to load.")}finally{Fe(),o.status.textContent=""}},async loadTodayDeals(){try{o.dealsStatus.textContent="Yuklanmoqda...",Ne(o.dealsGrid,5);const{deals:e,demoDeals:t,failed:r}=await ie.loadTodayDeals();c.todayDeals=e,c.demoDeals=t,r?pe(o.dealsGrid,"API data failed to load."):Q(o.dealsGrid,c.todayDeals.slice(0,8),"Mahsulot topilmadi."),he()}catch(e){console.error("[LOAD TODAY DEALS FAILED]",e),c.demoDeals=!1,pe(o.dealsGrid,"API data failed to load.")}finally{Fe(),o.dealsStatus.textContent=""}},async loadHomeApi(){const e=await oe.loadHomeApiData({limit:10,page:0,size:20});if(!e.loaded)return c.homeLoadedFromApi=!1,o.homeApiSections.hidden=!0,!1;const{hits:t,discounts:r,newArrivals:a,products:s,todayDeals:l,homeApiSections:d}=e;return c.homeLoadedFromApi=!0,c.products=s,c.todayDeals=l,c.demoProducts=!1,c.demoDeals=!1,he(),c.homeApiSections=d,F.renderHomeApiSections({hits:t,discounts:r,newArrivals:a}),ne(c.products,n("home.noProducts"),{screen:"home"}),Q(o.dealsGrid,r.slice(0,8),"Chegirmalar topilmadi.",{screen:"home-discounts"}),o.status.textContent="",o.dealsStatus.textContent="",Fe(),!0},async load({loadCart:e}={}){var t,r,a;c.selectedCategory="ALL",h.currentSearchQuery="",h.currentGridScreen="home",c.feedPage=0,o.title.textContent=n("home.recommended"),o.status.textContent=n("home.loading"),Ne(o.grid,12),Ne(o.dealsGrid,6);try{await Promise.all([F.loadCategories(),F.loadBanners(),F.loadAnnouncements()]),await F.loadHomeApi()||(await Promise.all([F.loadProducts(),F.loadTodayDeals()]),F.renderHomeApiSections({hits:c.products.slice(0,12),discounts:c.todayDeals.slice(0,10),newArrivals:c.products.slice(6,18)})),await F.loadRecentlyViewed(),F.renderPersonalizationSections(),e&&await e()}catch(s){console.error("Home loading failed:",s),c.demoProducts=!1,c.demoDeals=!1,pe(o.grid,n("common.serverFailed"),n("common.tryAgain"))}finally{((t=o.status)==null?void 0:t.textContent)===n("home.loading")&&(o.status.textContent=""),(((r=o.dealsStatus)==null?void 0:r.textContent)===n("home.loading")||((a=o.dealsStatus)==null?void 0:a.textContent)==="Yuklanmoqda...")&&(o.dealsStatus.textContent="")}},prevBanner(){Nt(ar()-1)},nextBanner:oa,scrollToBanner:Nt,resetBannerAutoSlide:Ft},$o=()=>$("/api/cart",{requireAuth:!0,showError:!1}),Po=e=>$("/api/cart",{method:"POST",body:JSON.stringify(e),requireAuth:!0}),Eo=(e,t)=>$(`/api/cart/${e}`,{method:"PUT",body:JSON.stringify(t),requireAuth:!0}),Io=e=>$(`/api/cart/${e}`,{method:"DELETE",requireAuth:!0});function zt(e=h.lastApiError){return e.includes("Session expired")||e==="Please login to continue"}function be(e){return{success:!1,sessionExpired:zt(),error:h.lastApiError||e}}function Ao(e){return e.reduce((t,r)=>{var s;const a=w((s=r.product)==null?void 0:s.originalPrice);return a>r.unitPrice?t+(a-r.unitPrice)*r.quantity:t},0)}function Dr(e,t,r=0,{checkout:a=!1}={}){const s=e.filter(f=>t.has(String(f.id))),l=s.reduce((f,k)=>f+k.lineTotal,0),d=Ao(s),u=!s.length||l>=Ee?0:Ji,p=Math.max(0,l+u-r),m=s.reduce((f,k)=>f+k.quantity,0);return a?{items:s,subtotal:l,deliveryFee:u,discount:d+r,catalogDiscount:d,couponDiscount:r,total:p,itemCount:m}:{items:s,subtotal:l,discount:d,deliveryFee:u,couponDiscount:r,total:p,itemCount:m,uniqueCount:s.length}}const se={async loadCart(){const e=await $o();return e===null?be("Cart could not be loaded."):{success:!0,items:M(e).map(pi)}},syncSelection(e,t,r){const a=t||new Set,s=e.map(u=>String(u.id)),l=new Set(s),d=r||new Set;return[...a].forEach(u=>{l.has(u)||a.delete(u)}),s.forEach(u=>{d.has(u)||a.add(u)}),s.length&&!a.size&&!d.size&&s.forEach(u=>a.add(u)),{selectedIds:a,knownItemIds:new Set(s)}},getSelectedItems(e,t){return e.filter(r=>t.has(String(r.id)))},calculateTotals(e,t,r=0){return Dr(e,t,r)},calculateCheckoutTotals(e,t,r=0){return Dr(e,t,r,{checkout:!0})},async addItem(e,t){return Po({variantId:Number(e),quantity:Math.max(1,Number(t||1))})},async updateQuantity(e,t){return Eo(e,{quantity:Math.max(1,Number(t||1))})},async removeItem(e){return Io(e)},applyCoupon(e,t){const r=String(e||"").trim().toUpperCase();return r==="BEAUTY10"?{valid:!0,coupon:r,discount:Math.round(t*.1)}:r?{valid:!1,invalid:!0}:{valid:!1,invalid:!1}}};function Lo({item:e,selected:t=!1,loading:r=!1,labels:a={}}){const s=e.product||{},l=e.image||s.image||S.placeholderImage,d=w(s.originalPrice)*e.quantity,u=s.originalPrice>e.unitPrice,p=[e.variantLabel,s.brand?`(${s.brand})`:""].filter(Boolean).join(" "),{selectItem:m="Select item",remove:f="Remove",shipsToday:k="Ships today"}=a;return`
  ...
  `}function To({totals:e,labels:t={}}){const{yourOrder:r="Your order",goodsCount:a="",discount:s="Discount",deliveryCost:l="Delivery",freeDelivery:d="Free",products:u="Products",total:p="Total"}=t;return`
  ...
  `}function Do({title:e,hint:t="",actionLabel:r="",actionAttrs:a='data-start-shopping type="button"'}){return`
    <div class="cart-empty app-cart-empty">
      <strong>${i(e)}</strong>
      ${t?`<p>${i(t)}</p>`:""}
      ${r?`<button class="primary-button" ${a}>${i(r)}</button>`:""}
    </div>
  `}function Ro({title:e,message:t,retryLabel:r="Try again"}){return`
    <div class="cart-empty app-cart-empty">
      <strong>${i(e)}</strong>
      <p>${i(t)}</p>
      <button class="secondary-button" data-cart-retry type="button">${i(r)}</button>
    </div>
  `}function tt(){return b.cartSelectedIds||(b.cartSelectedIds=new Set),b.cartSelectedIds}function or(){const{selectedIds:e,knownItemIds:t}=se.syncSelection(b.cartItems,tt(),b.cartKnownItemIds);b.cartSelectedIds=e,b.cartKnownItemIds=t}function sa(){var d,u;const e=(d=o.cartItems)==null?void 0:d.querySelector("[data-cart-select-all]");if(!e)return;const t=na().length,r=b.cartItems.length,a=r>0&&t===r,s=t>0&&t<r;e.checked=a,e.indeterminate=s;const l=((u=e.closest(".app-cart-check"))==null?void 0:u.querySelector(".app-cart-check-ui"))||e.nextElementSibling;l!=null&&l.classList.contains("app-cart-check-ui")&&(l.classList.toggle("is-indeterminate",s),l.classList.toggle("is-checked",a))}function na(){return or(),se.getSelectedItems(b.cartItems,tt())}function ca(){return se.calculateTotals(b.cartItems,tt(),b.cartCouponDiscount||0)}function la(e){return Lo({item:e,selected:tt().has(String(e.id)),loading:b.cartUpdatingIds.has(String(e.id)),labels:{selectItem:n("cart.selectItem"),remove:n("cart.remove"),shipsToday:n("cart.shipsToday")}})}function Je(e){const t=o.cartStickyProgress;if(!t)return;const r=Math.min(100,e/Ee*100),a=Math.max(0,Ee-e);t.innerHTML=e>=Ee?"":`
  ...
  `}function Mo(){c.products.length&&Q(o.grid,c.products,n("home.noProducts"),{screen:h.currentGridScreen})}function Rr(){or();const e=ca();if(o.cartCount.textContent=b.cartCount,o.cartSummary.textContent=n("orders.items",{count:e.itemCount}),o.cartTotal.textContent=L(e.subtotal),b.cartLoading){o.cartItems.innerHTML='<div class="cart-loading app-cart-loading"><div class="skeleton-card"></div><div class="skeleton-card"></div></div>',o.checkoutButton.disabled=!0,o.cartExtras&&(o.cartExtras.innerHTML=""),Je(0);return}if(b.cartError){o.cartItems.innerHTML=Ro({title:n("cart.unavailable"),message:b.cartError,retryLabel:n("common.tryAgain")}),o.checkoutButton.disabled=!0,o.cartExtras&&(o.cartExtras.innerHTML=""),Je(0);return}o.checkoutButton.disabled=!e.items.length;const t=c.products.slice(0,8).map((u,p)=>Ke(u,{screen:"cart-cross",position:p})).join(""),r=(c.recentlyViewed||[]).slice(0,6).map((u,p)=>Ke(u,{screen:"cart-recent",position:p})).join("");if(so(n,{recommendedHtml:t,recentHtml:r,subtotal:e.subtotal}),!b.cartItems.length){o.cartItems.innerHTML=Do({title:n("cart.empty"),hint:n("cart.emptyHint"),actionLabel:n("home.startShopping")}),Je(0);return}const a=e.uniqueCount,s=b.cartItems.length,l=s>0&&a===s,d=a>0&&a<s;o.cartItems.innerHTML=`
    ...
    <div class="app-cart-items">
      ${b.cartItems.map(u=>la(u)).join("")}
    </div>
    ${To({totals:e,labels:{yourOrder:n("cart.yourOrder"),goodsCount:n("cart.goodsCount",{count:e.itemCount}),discount:n("cart.discount"),deliveryCost:n("cart.deliveryCost"),freeDelivery:n("cart.freeDelivery"),products:n("cart.products"),total:n("common.total")}})}
  `,sa(),Je(e.subtotal),ge(o.cartItems),ge(o.cartExtras)}const q={render:Rr,renderCart:Rr,renderCartItemRow:la,renderCartStickyProgress:Je,renderAddToCartLoading:Mo,getSelectedCartItems:na,getCartTotals:ca,getCartSelectedIds:tt,syncCartSelection:or,applyCartCheckboxUi:sa},ht=(e={})=>$("/api/users/me",{requireAuth:!0,showError:!1,...e}),qo=(e,t={})=>$("/api/users/me",{method:"PUT",body:JSON.stringify(e),requireAuth:!0,showError:!1,...t}),sr=()=>$("/api/orders",{requireAuth:!0,showError:!1}),Tt=e=>$(`/api/orders/${e}`,{requireAuth:!0,showError:!1}),Bo=e=>$(`/api/orders/${e}/history`,{requireAuth:!0,showError:!1}),Oo=(e,t={})=>$("/api/orders",{method:"POST",body:JSON.stringify(e),requireAuth:!0,showError:!1,...t}),xo=()=>$("/api/health",{showError:!1}),le={orderStatusModifier(e=""){const t=String(e||"").toUpperCase();return t==="DELIVERED"?"delivered":t==="CANCELED"||t==="CANCELLED"?"canceled":t==="SHIPPED"?"shipped":"pending"},getItemCount(e={}){const t=Array.isArray(e.items)?e.items:[];return t.length?t.reduce((r,a)=>r+(Number(a.quantity)||1),0):Number(e.itemCount)||0},getLineCount(e={}){return(Array.isArray(e.items)?e.items:[]).length||Number(e.itemCount)||0},isProfileActiveOrder(e){const t=String((e==null?void 0:e.status)||"").toUpperCase();return!!t&&!["DELIVERED","CANCELED","CANCELLED"].includes(t)},async enrichOrdersList(e=[]){const t=e.filter(a=>!Array.isArray(a.items)||!a.items.length);if(!t.length)return e;const r=new Map;return await Promise.all(t.slice(0,30).map(async a=>{const s=await Tt(a.id);s&&typeof s=="object"&&r.set(String(a.id),s)})),e.map(a=>r.get(String(a.id))||a)},async enrichProfileOrders(e=[]){const t=e.slice(0,2);return t.length?[...await Promise.all(t.map(async a=>{if(Array.isArray(a.items)&&a.items.length)return a;const s=await Tt(a.id);return s&&typeof s=="object"?s:a})),...e.slice(2)]:e},async loadOrders(){const e=await sr();return e===null?be("Orders could not be loaded."):{success:!0,orders:await this.enrichOrdersList(M(e))}},async loadOrderDetail(e){const[t,r]=await Promise.all([Tt(e),Bo(e)]);return t===null?{success:!1,error:be("Order detail could not be loaded.").error}:{success:!0,order:t,history:r===null?[]:M(r),historyWarning:r===null?"Status history could not be loaded.":""}},async createOrder(e,t={}){const r=await Oo(e,{timeoutMs:25e3,...t});return r===null?be("Order could not be created."):{success:!0,order:r}},buildSuccessState(){return{checkoutConfirmOpen:!1,orderSuccess:null,checkoutError:"",orderSubmitting:!1}}},No=e=>$(`/api/reviews/product/${e}`,{showError:!1}),Fo=()=>$("/api/reviews/my",{requireAuth:!0,showError:!1}),zo=e=>$("/api/reviews",{method:"POST",body:JSON.stringify(e),requireAuth:!0,showError:!1}),Ho=e=>$("/api/uploads/presign",{method:"POST",requireAuth:!0,showError:!1,body:JSON.stringify(e)}),ke={reviewStats(e){const t=e.length,r=t?e.reduce((a,s)=>a+w(s.rating),0)/t:0;return{count:t,average:r}},async loadProductReviews(e){const t=await No(e);return t===null?{reviews:null,error:h.lastApiError||"Reviews could not be loaded."}:{reviews:M(t).map(Qr)}},async loadMyReviews(){const e=await Fo();return e===null?be("Reviews could not be loaded."):{success:!0,items:wi(e).map(bi)}},parseReviewImageUrls(e){return String(e||"").split(/[\n,]+/).map(t=>t.trim()).filter(Boolean).slice(0,5)},validateReviewFiles(e){const t=new Set(["image/jpeg","image/png","image/webp"]),r=Array.from(e||[]);return r.length>5?{error:"Maximum 5 image files allowed.",files:[]}:r.find(l=>!t.has(l.type))?{error:"Only JPG, PNG and WEBP images are allowed.",files:[]}:r.find(l=>l.size>10*1024*1024)?{error:"Each image must be 10MB or smaller.",files:[]}:{files:r}},validateSubmitReview({productId:e,orderId:t,rating:r,content:a,manualImageUrlsText:s,files:l}){const d=[];(!e||!t)&&d.push("Product and order are required."),(r<1||r>5)&&d.push("Choose a rating from 1 to 5."),a||d.push("Review text is required.");const u=this.parseReviewImageUrls(s),p=this.validateReviewFiles(l);return p.error&&d.push(p.error),String(s||"").split(/[\n,]+/).filter(m=>m.trim()).length>5&&d.push("Maximum 5 image URLs allowed."),u.length+p.files.length>5&&d.push("Maximum 5 review images allowed."),{valid:d.length===0,errors:d,manualImageUrls:u,fileValidation:p}},async uploadReviewImages(e,{onProgress:t}={}){const r=[];for(let a=0;a<e.length;a+=1){const s=e[a];t==null||t(`Uploading image ${a+1} of ${e.length}...`,{index:a,total:e.length});const l=await Ho({fileName:s.name,contentType:s.type,folder:"reviews",fileSizeBytes:s.size});if(!(l!=null&&l.uploadUrl)||!(l!=null&&l.publicUrl))throw new Error(h.lastApiError||"Image upload could not be prepared.");const d=await fetch(l.uploadUrl,{method:"PUT",headers:{"Content-Type":s.type},body:s});if(!d.ok)throw new Error(`Image upload failed: HTTP ${d.status}`);r.push(l.publicUrl)}return t==null||t(r.length?"Images uploaded.":"",{done:!0}),r},async submitReview({productId:e,orderId:t,rating:r,content:a,imageUrls:s}){const l=await zo({productId:Number(e),orderId:Number(t),rating:Number(r),content:a,imageUrls:s});return l===null?be("Review could not be submitted."):{success:!0,response:l}}},Pe={getOrderPreview(e){return(e||[]).filter(t=>le.isProfileActiveOrder(t)).slice(0,2)},async loadSnapshot(){const[e,t,r,a]=await Promise.all([ht(),sr(),ke.loadMyReviews(),oe.loadRecentlyViewed()]);return{userResponse:e,ordersResponse:t,reviewsResult:r,recentlyViewed:a}},async enrichProfileOrders(e){return le.enrichProfileOrders(e)},normalizeOrdersResponse(e){return e!==null?M(e):null},validateProfileUpdate({fullName:e,phone:t}){return!e||!t?{valid:!1,error:"Full name va phone majburiy."}:{valid:!0}},async updateProfile(e){return await qo(e)===null?{success:!1,error:h.lastApiError||"Profile yangilanmadi."}:{success:!0,user:await ht()||null}},async checkHealth(){return xo()}};function at({action:e,icon:t,label:r,value:a=""}){const s=a!==""&&a!==null&&a!==void 0?`<strong class="app-profile-stat-value">${i(String(a))}</strong>`:"";return`
  ...
  `}function Uo({imageUrl:e="",name:t="Profile"}){return e?`<img class="app-profile-avatar" src="${i(e)}" alt="${i(t)}" loading="eager" decoding="async" />`:`
  ...
  `}function Vo({count:e=0,className:t="app-profile-notify-badge"}){if(e<=0)return"";const r=e>99?"99+":String(e);return`<span class="${i(t)}">${i(r)}</span>`}function da(e=""){return n(`status.${e}`)||e||n("common.unknown")}function ua(e=""){const t=String(e||"").toUpperCase();return t==="NEW"||t==="CONFIRMED"||t==="PACKED"?n("status.PENDING"):da(e)}function Ko(){const e=De(),t={uz:"O'zbek",en:"English",ru:"Русский",ko:"한국어"};return t[e]||t.en}function Go(e){const t=(Array.isArray(e.items)?e.items:[]).map(s=>Qt({...s,orderId:e.id})),r=t.slice(0,4).map(s=>`
  ...
  `).join(""),a=t.length>4?`<span class="app-profile-order-more">+${t.length-4}</span>`:"";return`
    <button class="app-profile-order-card" type="button" data-profile-order="${i(e.id)}">
      <span class="app-profile-order-status">${i(ua(e.status))}</span>
  ...
  `}const re={render(){var k,I;const e=P.user||{},t=Uo({imageUrl:e.profileImage,name:e.fullName||"Profile"}),r=((k=h.orders)==null?void 0:k.length)||0,a=((I=c.myReviews)==null?void 0:I.length)||0,s=b.cartCoupon?1:0,d=(c.recentlyViewed||[]).slice(0,6).map((v,R)=>Ke(v,{screen:"profile-recent",position:R})).join(""),u=Pe.getOrderPreview(h.orders),p=Vo({count:D.unreadCount}),m={orders:'<svg viewBox="0 0 24 24"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/></svg>',reviews:'<svg viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>',coupons:'<svg viewBox="0 0 24 24"><path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-6"/><path d="M4 8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4H4z"/><path d="M12 8v8"/></svg>',feedback:'<svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>'},f={promotions:'<svg viewBox="0 0 24 24"><path d="M20 12v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-6"/><path d="M12 3 20 8v4H4V8z"/></svg>',help:'<svg viewBox="0 0 24 24"><path d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H3z"/><path d="M14 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-3z"/><path d="M8.5 11V7a3.5 3.5 0 1 1 7 0v4"/></svg>',news:'<svg viewBox="0 0 24 24"><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11 6v12"/></svg>',language:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',privacy:'<svg viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>',terms:'<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg>'};o.profileContent.innerHTML=`
      <div class="app-profile-page ${P.profileLoading?"is-loading":""}">
        ...
        <section class="app-profile-section">
          ...
          <div class="app-profile-orders-rail">
            ${P.profileLoading&&!u.length?'<div class="app-profile-order-card skeleton-card"></div><div class="app-profile-order-card skeleton-card"></div>':u.length?u.map(v=>Go(v)).join(""):`<div class="app-profile-empty-block">${i(n("orders.none"))}</div>`}
          </div>
        </section>
    ...
    `,ge(o.profileContent)},async loadSnapshot({isLoggedIn:e,loadUnreadCount:t,updateAuthUi:r}={}){if(!(e!=null&&e()))return;const a=++P.profileLoadSeq;P.profileLoading=!0,re.render();try{const[s]=await Promise.all([Pe.loadSnapshot(),t==null?void 0:t()]),{userResponse:l,ordersResponse:d,reviewsResult:u,recentlyViewed:p}=s;if(a!==P.profileLoadSeq||(l&&(P.user=l,localStorage.setItem(S.storageKeys.user,JSON.stringify(l)),r==null||r()),d!==null&&(h.orders=Pe.normalizeOrdersResponse(d),P.profileLoading=!1,re.render(),h.orders=await Pe.enrichProfileOrders(h.orders),a!==P.profileLoadSeq)))return;u.success&&(c.myReviews=u.items),p.length&&(c.recentlyViewed=p)}catch{}finally{a===P.profileLoadSeq&&(P.profileLoading=!1,o.profileDrawer.classList.contains("open")&&re.render())}},async handleAction(e,t={}){var l,d,u,p,m,f,k,I,v,R,E,N,x,U,X,rt,ur,pr,mr,hr,gr,fr,vr,yr,br,wr;const r=e.target.closest("[data-profile-order]");if(r){(l=t.closeProfile)==null||l.call(t),await((d=t.showOrders)==null?void 0:d.call(t)),await((u=t.openOrderDetail)==null?void 0:u.call(t,r.dataset.profileOrder));return}const a=e.target.closest("[data-profile-action]");if(!a)return;const s=a.dataset.profileAction;if(s==="menu"){P.profileMenuOpen=!P.profileMenuOpen,re.render();return}if(s==="edit"){P.profileMenuOpen=!1,P.profileEditing=!P.profileEditing,re.render();return}if(s==="logout"){P.profileMenuOpen=!1,(p=t.clearAuth)==null||p.call(t),(m=t.closeProfile)==null||m.call(t),(f=t.showToast)==null||f.call(t,n("profile.loggedOut"));return}if(s==="orders"){(k=t.closeProfile)==null||k.call(t),await((I=t.showOrders)==null?void 0:I.call(t));return}if(s==="favorites"){(v=t.closeProfile)==null||v.call(t),await((R=t.openFavorites)==null?void 0:R.call(t));return}if(s==="reviews"){(E=t.closeProfile)==null||E.call(t),await((N=t.openMyReviews)==null?void 0:N.call(t));return}if(s==="notifications"){(x=t.closeProfile)==null||x.call(t),await((U=t.openNotifications)==null?void 0:U.call(t));return}if(s==="language"){const Et=Yt,qa=Et.indexOf(De()),kr=Et[(qa+1)%Et.length];(X=t.setLanguage)==null||X.call(t,kr),o.languageSelect&&(o.languageSelect.value=kr),(rt=t.applyTranslations)==null||rt.call(t),re.render();return}if(s==="privacy"){P.profileMenuOpen=!1,(ur=t.closeProfile)==null||ur.call(t),(pr=t.openPrivacy)==null||pr.call(t);return}if(s==="terms"){P.profileMenuOpen=!1,(mr=t.closeProfile)==null||mr.call(t),(hr=t.openTerms)==null||hr.call(t);return}if(s==="promotions"||s==="news"){(gr=t.showToast)==null||gr.call(t,n("profile.comingSoon"),"info");return}if(s==="help"){P.profileMenuOpen=!1,(fr=t.closeProfile)==null||fr.call(t),(vr=t.openSupport)==null||vr.call(t);return}if(s==="addresses"||s==="receivers"){(yr=t.closeProfile)==null||yr.call(t),await((br=t.prepareCheckout)==null?void 0:br.call(t));return}(wr=t.showToast)==null||wr.call(t,n("profile.comingSoon"),"info")}},Wo=e=>$("/api/auth/login",{method:"POST",body:JSON.stringify(e),showError:!1}),Yo=e=>$("/api/auth/register",{method:"POST",body:JSON.stringify(e),showError:!1}),_o=e=>$("/api/auth/firebase",{method:"POST",body:JSON.stringify(e),showError:!1}),Y={extractSession(e){const t=(e==null?void 0:e.token)||(e==null?void 0:e.accessToken)||(e==null?void 0:e.jwt)||"",r={id:e==null?void 0:e.id,email:e==null?void 0:e.email,fullName:e==null?void 0:e.fullName,phone:(e==null?void 0:e.phone)||"",profileImage:(e==null?void 0:e.profileImage)||""},a=(e==null?void 0:e.role)||"";return{token:t,user:r,role:a}},persistSession({token:e,user:t,role:r}){e&&localStorage.setItem(S.storageKeys.accessToken,e),localStorage.setItem(S.storageKeys.user,JSON.stringify(t)),localStorage.setItem(S.storageKeys.role,r)},clearSession(){localStorage.removeItem(S.storageKeys.accessToken),localStorage.removeItem(S.storageKeys.legacyAccessToken),localStorage.removeItem(S.storageKeys.user),localStorage.removeItem(S.storageKeys.legacyUser),localStorage.removeItem(S.storageKeys.role)},saveAuth(e,t){const r=this.extractSession(e);return this.persistSession(r),t.accessToken=r.token,t.user=r.user,t.role=r.role,r},clearAuthState(e,t){this.clearSession(),e.accessToken="",e.user=null,e.role="",t.myReviews=[],t.myReviewsLoading=!1,t.myReviewsError=""},isLoggedIn(){return!!dt()},async validateAuthOnStartup(){if(!dt())return{authenticated:!1};const e=await ht({silentAuth:!0});return e?(localStorage.setItem(S.storageKeys.user,JSON.stringify(e)),{authenticated:!0,profile:e}):{authenticated:!1,invalid:!0}},async preloadProfileData(){const[e,t,r]=await Promise.all([ht(),sr(),ke.loadMyReviews()]);let a=null;return t!==null&&(a=await Pe.enrichProfileOrders(M(t))),{userResponse:e,orders:a,reviewsResult:r}},isValidEmail(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)},validateLoginForm(e,t){const r=[];return(!e||!this.isValidEmail(e))&&r.push({field:"loginEmail",messageKey:"auth.emailRequired"}),(!t||t.length<6)&&r.push({field:"loginPassword",messageKey:"auth.passwordMin"}),{valid:r.length===0,errors:r}},validateRegisterForm({fullName:e,email:t,phone:r,password:a,confirmPassword:s}){const l=[];return e||l.push({field:"registerFullName",messageKey:"auth.fullNameRequired"}),(!t||!this.isValidEmail(t))&&l.push({field:"registerEmail",messageKey:"auth.emailRequired"}),r||l.push({field:"registerPhone",messageKey:"auth.phoneRequired"}),(!a||a.length<6)&&l.push({field:"registerPassword",messageKey:"auth.passwordMin"}),a!==s&&l.push({field:"registerConfirmPassword",messageKey:"auth.passwordMismatch"}),{valid:l.length===0,errors:l}},async submitLogin({email:e,password:t}){const r=await Wo({email:e,password:t});return r!=null&&r.token?{success:!0,response:r}:{success:!1,error:h.lastApiError||"Email yoki parol noto‘g‘ri."}},async submitRegister({fullName:e,email:t,phone:r,password:a}){const s=await Yo({fullName:e,email:t,phone:r,password:a});return s===null?{success:!1,error:h.lastApiError||"Email allaqachon mavjud yoki server javob bermadi."}:{success:!0,response:s,email:t}},async submitFirebaseLogin(e){const t=await _o({idToken:e});return t!=null&&t.token?{success:!0,response:t}:{success:!1,error:h.lastApiError||"Server Google hisobini qabul qilmadi."}},mapFirebaseError(e){return e==="auth/popup-closed-by-user"||e==="auth/cancelled-popup-request"?{cancelled:!0}:e==="auth/popup-blocked"?{cancelled:!1,message:"Popup bloklandi. Brauzerda popup'ga ruxsat bering."}:{cancelled:!1,message:"Google bilan kirishda xatolik yuz berdi."}}},Jo={apiKey:"AIzaSyAh668pltxmHVtAi_dN1cLO2faTqRyVbUU",authDomain:"cosmetic-app-75fb9.firebaseapp.com",projectId:"cosmetic-app-75fb9",storageBucket:"cosmetic-app-75fb9.firebasestorage.app",messagingSenderId:"1075730526246",appId:"1:1075730526246:web:ac4b809f7353e4bbac36e7",measurementId:"G-KVHDLM71LR"};let it=null;function Qo(){if(!it){const e=xa(Jo);it=Na(e),it.useDeviceLanguage()}return it}async function Zo(){const e=Qo(),t=new Ba;return t.setCustomParameters({prompt:"select_account"}),(await Oa(e,t)).user.getIdToken()}function pa(e){b.cartItems=e,b.cart=e,b.cartCount=e.reduce((t,r)=>t+r.quantity,0),b.cartTotal=e.reduce((t,r)=>t+r.lineTotal,0)}function Ht(){pa([]),b.cartLoading=!1,b.cartError="",b.cartUpdatingIds=new Set,b.cartSelectedIds=new Set,b.cartKnownItemIds=new Set}function ma(e,t="Rating"){return bt({rating:e,label:t})}function Xo({stats:e,distribution:t,reviewsLabel:r="reviews"}){return`
  ...
  `}function es({review:e,helpful:t=!1,verifiedLabel:r="Verified purchase",noTextLabel:a="No text review",helpfulLabel:s="Helpful"}){var d;const l=!!e.orderId;return`
  ...
  `}function ts(e){return ke.reviewStats(e)}function rs(){return oe.getRecentProductIds()}function as(e,t){const r=String(e??"");return r.length<=t?r:`${r.slice(0,Math.max(0,t-1)).trimEnd()}…`}const A={renderDetailLoading(e=!1){const t=e?o.productDetailPageContent:o.detailContent;t.innerHTML=`
    ...
    `},renderProductDetail(e){const t=e.variants.find(R=>String(R.id)===String(c.selectedVariantId))||null,r=[...new Set([e.image,...e.images,...e.detailImages].filter(Boolean))],a=Math.min(c.pdpGalleryIndex||0,Math.max(0,r.length-1)),s=r[a]||e.image,l=(t==null?void 0:t.discountPrice)??(t==null?void 0:t.price)??e.finalPrice,d=(t==null?void 0:t.price)??e.originalPrice,u=(t==null?void 0:t.stock)??e.stock,p=C.favoriteIds.has(String(e.id))||!!e.favorite,m=Ge().includes(String(e.id)),f=h.currentRoute==="product",k=f?o.productDetailPageContent:o.detailContent,I=w(u)>0&&w(u)<=5,v=new Date(Date.now()+3*864e5).toLocaleDateString(De(),{weekday:"short",month:"short",day:"numeric"});k.innerHTML=`
      ...
      <div class="pdp-layout">
        ...
        <div class="pdp-purchase-card">
          ...
          <p class="hint">${ma(e.ratingAvg)} ${e.ratingAvg.toFixed(1)} (${e.reviewCount}) · ${i(n("product.sold",{count:e.soldCount}))}</p>
      ...
      `:""}
    `,aa(k),ge(k),A.initPdpGallerySwipe(k)},renderVariantSelectors(e){const t=[],r=[];e.variants.forEach(l=>{const u=String(l.label||"").split(/[\/,\-]/).map(p=>p.trim()).filter(Boolean);u[0]&&t.push(u[0]),u[1]&&r.push(u[1])});const a=[...new Set(t)],s=[...new Set(r)];return a.length>1||s.length>1?`
    ...
    `},renderReviewCard(e){return es({review:e,helpful:c.reviewHelpfulIds.has(String(e.id)),verifiedLabel:n("reviews.verified"),noTextLabel:n("reviews.noText"),helpfulLabel:n("reviews.helpful")})},renderVariantButtons(e){return`
    ...
    `},renderAddToCartLoading(){document.querySelectorAll("[data-detail-add]").forEach(t=>{var a;const r=b.addingProductIds.has(String((a=c.selectedDetailProduct)==null?void 0:a.id));t.disabled=r,t.textContent=r?n("product.adding"):t.closest(".mobile-buy-bar")?n("product.addToCart"):n("product.addToCartFull")}),c.products.length&&Q(o.grid,c.products,n("home.noProducts"),{screen:h.currentGridScreen})}},is=window.matchMedia("(prefers-reduced-motion: reduce)");function Ct(){return is.matches}function os(e){!e||Ct()||(e.classList.add("animating"),window.setTimeout(()=>e.classList.remove("animating"),400))}function ss(e,t){if(!e||!t||Ct())return;const r=document.getElementById("cartButton");if(!r)return;const a=r.getBoundingClientRect(),s=document.createElement("img");s.className="cart-fly",s.src=e,s.alt="",s.style.left=`${t.left}px`,s.style.top=`${t.top}px`,document.body.appendChild(s);const l=a.left+a.width/2-t.left-24,d=a.top+a.height/2-t.top-24;s.animate([{transform:"translate(0, 0) scale(1)",opacity:1},{transform:`translate(${l}px, ${d}px) scale(0.2)`,opacity:.6}],{duration:520,easing:"cubic-bezier(0.16, 1, 0.3, 1)",fill:"forwards"}).finished.then(()=>s.remove())}let Mr=0,Dt=!1;function ns(){const e=document.querySelector(".site-header");if(!e)return;e.classList.add("header-glass");const t=()=>{Dt||(Dt=!0,requestAnimationFrame(()=>{const r=window.scrollY,a=r-Mr;r>80&&a>8?e.classList.add("header-hidden"):(a<-4||r<40)&&e.classList.remove("header-hidden"),Mr=r,Dt=!1}))};window.addEventListener("scroll",t,{passive:!0})}function cs(){const e=document.getElementById("homeView"),t=document.getElementById("productDetailPage"),r=new MutationObserver(()=>{const a=(t==null?void 0:t.hidden)===!1?t:e;!a||Ct()||(a.classList.remove("page-enter"),a.offsetWidth,a.classList.add("page-enter"))});e&&r.observe(e,{attributes:!0,attributeFilter:["hidden"]}),t&&r.observe(t,{attributes:!0,attributeFilter:["hidden"]})}function ls(){let e=document.getElementById("offlineBanner");e||(e=document.createElement("div"),e.id="offlineBanner",e.className="offline-banner",e.textContent="You are offline. Some features may be unavailable.",document.body.appendChild(e));const t=()=>e.classList.toggle("visible",!navigator.onLine);window.addEventListener("online",t),window.addEventListener("offline",t),t()}function ds(e,t){if(Ct()||!t)return;const r=t.getBoundingClientRect(),a=Math.max(r.width,r.height),s=document.createElement("span");s.style.cssText=`
  ...
  `;const l=t.style.position;(!l||l==="static")&&(t.style.position="relative"),t.style.overflow="hidden",t.appendChild(s),s.animate([{transform:"scale(0)",opacity:1},{transform:"scale(2.5)",opacity:0}],{duration:500,easing:"ease-out"}).finished.then(()=>s.remove())}const K={async load(){if(!Y.isLoggedIn()){Ht(),q.render();return}b.cartLoading=!0,b.cartError="",q.render();const e=await se.loadCart();if(b.cartLoading=!1,!e.success){if(e.sessionExpired){Ht();return}b.cartError=e.error,q.render();return}pa(e.items),q.render()},async add(e,t,r,{showLoginRequired:a}={}){if(!Y.isLoggedIn()){a==null||a();return}const s=Math.max(1,Number(r||1)),l=await ie.resolveAddToCartVariant(e,t);if(l.navigateToProduct){Ie(l.product.id);return}const d=l.variantId;if(!d){T(n("product.variantUnavailable"),"warning");return}b.addingProductIds.add(String(e)),A.renderAddToCartLoading(!0);const u=await se.addItem(d,s);if(b.addingProductIds.delete(String(e)),A.renderAddToCartLoading(!1),u!==null){const p=document.querySelector(`[data-product="${e}"] .product-image`);p&&ss(p.src,p.getBoundingClientRect()),T(n("cart.added"),"success"),await K.load()}},async removeItem(e){b.cartUpdatingIds.add(String(e)),q.render();const t=await se.removeItem(e);b.cartUpdatingIds.delete(String(e)),t!==null?(T(n("cart.itemRemoved"),"success"),await K.load()):q.render()},async updateQuantity(e,t){const r=Math.max(1,Number(t||1));b.cartUpdatingIds.add(String(e)),q.render();const a=await se.updateQuantity(e,r);b.cartUpdatingIds.delete(String(e)),a!==null?(T(n("cart.quantityUpdated"),"success"),await K.load()):q.render()},async removeSelected(){var t;const e=q.getSelectedCartItems();if(e.length){e.forEach(r=>b.cartUpdatingIds.add(String(r.id))),q.render();for(const r of e)await se.removeItem(r.id),b.cartUpdatingIds.delete(String(r.id)),(t=b.cartSelectedIds)==null||t.delete(String(r.id));T(n("cart.itemRemoved"),"success"),await K.load()}},getTotals(){return q.getCartTotals()},getSelectedItems(){return q.getSelectedCartItems()}},He={pickDefaultVariant(e){return ie.pickDefaultVariant(e)},async loadDetailPage(e){var a;ga(),h.currentRoute="product",c.detailLoading=!0,c.detailError="",c.selectedDetailProduct=null,c.recommendedProducts=[],c.recommendedSimilar=[],c.recommendedOthers=[],c.recommendationsError="",A.renderDetailLoading(!0);const t=c.products.find(s=>String(s.id)===String(e))||{},r=await ie.loadProduct(e,t);if(c.detailLoading=!1,!r.id){c.detailError=h.lastApiError||"Mahsulot topilmadi.",A.renderProductDetailError();return}r.favorite=C.favoriteIds.has(String(r.id))||r.favorite,c.selectedDetailProduct=r,c.selectedVariantId=((a=He.pickDefaultVariant(r))==null?void 0:a.id)||null,c.selectedQuantity=1,c.pdpGalleryIndex=0,c.pdpActiveTab="description",c.reviewSearchQuery="",c.reviewFilterRating=0,document.title=`${r.name} - BEAUTY SKIN KOREA`,oe.addRecentProduct(r.id),mo(r.id),A.renderProductDetail(r),await He.loadReviews(r.id),await He.loadRecommendations(r)},async loadRecommendations(e){var r;c.recommendationsLoading=!0,c.recommendationsError="",A.renderProductDetail(e);const t=await ie.loadRecommendations(e,h.sessionId);if(t.mode==="api"){c.recommendationsLoading=!1,c.recommendedProducts=[],c.recommendedSimilar=t.similar,c.recommendedOthers=t.others,A.renderProductDetail(c.selectedDetailProduct);return}c.recommendationsLoading=!1,t.failed&&(c.recommendationsError=h.lastApiError||"Recommendations could not be loaded."),c.recommendedProducts=t.fallback.map(a=>({...a,favorite:C.favoriteIds.has(String(a.id))||a.favorite})),c.recommendedSimilar=[],c.recommendedOthers=[],((r=c.selectedDetailProduct)==null?void 0:r.id)!==void 0&&String(c.selectedDetailProduct.id)===String(e.id)&&A.renderProductDetail(c.selectedDetailProduct)},async loadReviews(e){var s,l;if(!e)return;const t=String(e);c.productReviewsLoading[t]=!0,c.productReviewsError[t]="",((s=c.selectedDetailProduct)==null?void 0:s.id)!==void 0&&String(c.selectedDetailProduct.id)===t&&A.renderProductDetail(c.selectedDetailProduct);const{reviews:r,error:a}=await ke.loadProductReviews(e);c.productReviewsLoading[t]=!1,r===null?c.productReviewsError[t]=a:c.productReviewsByProductId[t]=r,((l=c.selectedDetailProduct)==null?void 0:l.id)!==void 0&&String(c.selectedDetailProduct.id)===t&&A.renderProductDetail(c.selectedDetailProduct)},rerender(){c.selectedDetailProduct&&A.renderProductDetail(c.selectedDetailProduct)}};async function us(e){c.selectedBrand=e;const t=await ie.loadBrandProducts(e,c.sourceProducts,c.products),r=document.getElementById("brandViewContent");r&&(r.innerHTML=co(e,t,n,t.slice(0,12).map((a,s)=>Ke(a,{screen:"brand",position:s})).join("")),ge(r))}async function gt(){const e=window.location.hash||"#/",t=e.match(/^#\/product\/([^/?#]+)/),r=e.match(/^#\/brand\/([^/?#]+)/);if(t){ga(),await He.loadDetailPage(decodeURIComponent(t[1])),window.scrollTo({top:0,behavior:"smooth"});return}if(r){ms(),await us(decodeURIComponent(r[1])),window.scrollTo({top:0,behavior:"smooth"});return}Se()}function ps(){y.showLoginRequired()}function ms(){var e;h.currentRoute="brand",o.homeView.hidden=!0,o.productDetailPage.hidden=!0,(e=document.getElementById("brandView"))==null||e.removeAttribute("hidden")}function ha(){var e;(e=document.getElementById("brandView"))==null||e.setAttribute("hidden","")}function fe(){var r,a,s;const e=document.querySelector(".mobile-bottom-nav");if(!e)return;let t="home";(r=o.profileDrawer)!=null&&r.classList.contains("open")?t="loginButton":(a=o.favoritesDialog)!=null&&a.open?t="favoritesButton":(s=o.cartDrawer)!=null&&s.classList.contains("open")&&(t="cartButton"),e.querySelectorAll("[data-mobile-action]").forEach(l=>{l.classList.toggle("active",l.dataset.mobileAction===t)})}function Se(){h.currentRoute="home",o.homeView.hidden=!1,o.productDetailPage.hidden=!0,ha(),document.title="BEAUTY SKIN KOREA",fe()}function ga(){h.currentRoute="product",o.homeView.hidden=!0,o.productDetailPage.hidden=!1,ha(),window.scrollTo({top:0,behavior:"smooth"})}function Ut(){window.location.hash&&window.location.hash!=="#/"&&window.location.hash!=="#"?window.location.hash="#/":Se()}function Ie(e){if(!e)return;const t=`#/product/${encodeURIComponent(e)}`;window.location.hash===t?gt():window.location.hash=t}function hs(){if(!Y.isLoggedIn()){ps();return}o.cartDrawer.classList.add("open"),o.cartDrawer.setAttribute("aria-hidden","false"),_(),fe(),K.load()}function we(){o.cartDrawer.classList.remove("open"),o.cartDrawer.setAttribute("aria-hidden","true"),O(),fe()}function gs(){const e=document.getElementById("megaMenu");if(window.innerWidth>680&&e){const t=e.classList.toggle("open");e.setAttribute("aria-hidden",String(!t)),o.catalogButton.setAttribute("aria-expanded",String(t)),t&&(o.catalogDrawer.classList.remove("open"),o.catalogDrawer.setAttribute("aria-hidden","true"));return}o.catalogDrawer.classList.add("open"),o.catalogDrawer.setAttribute("aria-hidden","false"),o.catalogButton.setAttribute("aria-expanded","true"),_()}function ct(){const e=document.getElementById("megaMenu");e==null||e.classList.remove("open"),e==null||e.setAttribute("aria-hidden","true"),o.catalogDrawer.classList.remove("open"),o.catalogDrawer.setAttribute("aria-hidden","true"),o.catalogButton.setAttribute("aria-expanded","false"),O()}function _(){document.body.classList.add("locked")}function O(){var a;const e=(a=document.getElementById("compareDrawer"))==null?void 0:a.classList.contains("open"),t=o.cartDrawer.classList.contains("open")||o.catalogDrawer.classList.contains("open")||o.profileDrawer.classList.contains("open")||o.notificationsDrawer.classList.contains("open")||e,r=[o.detailDialog,o.authDialog,o.apiDialog,o.checkoutDialog,o.ordersDialog,o.favoritesDialog,o.supportDialog,o.privacyDialog,o.termsDialog,o.myReviewsDialog,o.writeReviewDialog,document.getElementById("compareDialog")].some(s=>s==null?void 0:s.open);!t&&!r&&document.body.classList.remove("locked")}function fs(){o.baseUrl.value=h.baseUrl,o.apiDialog.showModal(),_()}function vs(e){e.preventDefault(),h.baseUrl=vt(o.baseUrl.value||""),localStorage.setItem(S.storageKeys.baseUrl,h.baseUrl),o.apiDialog.close(),F.load({loadCart:()=>K.load()})}const y={isLoggedIn(){return Y.isLoggedIn()},saveAuth(e){Y.saveAuth(e,P)},clearAuth(){var e,t,r,a,s,l,d,u;Y.clearAuthState(P,c),Ht(),(t=(e=B.cart)==null?void 0:e.render)==null||t.call(e),Ot(),(a=(r=B.favorites)==null?void 0:r.updateUi)==null||a.call(r),(l=(s=B.notifications)==null?void 0:s.clearState)==null||l.call(s),(d=o.myReviewsDialog)!=null&&d.open&&o.myReviewsDialog.close(),(u=o.writeReviewDialog)!=null&&u.open&&o.writeReviewDialog.close(),y.updateUi()},showLoginRequired(){y.openDialog("login"),T(n("auth.loginRequired"),"warning")},async validateOnStartup(){var t,r,a,s;const e=await Y.validateAuthOnStartup();if(!e.authenticated){e.invalid?y.clearAuth():y.updateUi();return}P.user=e.profile,y.updateUi(),await Promise.allSettled([(r=(t=B.favorites)==null?void 0:t.load)==null?void 0:r.call(t),(s=(a=B.notifications)==null?void 0:a.loadUnreadCount)==null?void 0:s.call(a),y.preloadProfileData()])},async preloadProfileData(){var a,s,l,d,u;if(!Y.isLoggedIn())return;const{userResponse:e,orders:t,reviewsResult:r}=await Y.preloadProfileData();await((s=(a=B.home)==null?void 0:a.ensureRecentlyViewed)==null?void 0:s.call(a)),e&&(P.user=e,localStorage.setItem(S.storageKeys.user,JSON.stringify(e)),y.updateUi()),t!==null&&(h.orders=t),r.success&&(c.myReviews=r.items),(l=o.profileDrawer)!=null&&l.classList.contains("open")&&((u=(d=B.profile)==null?void 0:d.render)==null||u.call(d))},updateUi(){const e=o.loginButton.querySelector("span");if(e)if(Y.isLoggedIn()&&P.user){const t=String(P.user.fullName||"").trim().split(/\s+/)[0]||"";e.textContent=t||n("profile.myProfile"),o.loginButton.setAttribute("aria-label",n("profile.myProfile"))}else e.textContent=n("auth.login"),o.loginButton.setAttribute("aria-label",n("auth.login"))},openDialog(e="login"){y.setMode(e),y.clearErrors(),o.authDialog.showModal(),_()},setMode(e){P.authMode=e;const t=e==="login";o.authTitle.textContent=n(t?"auth.login":"auth.register"),o.loginFields.hidden=!t,o.registerFields.hidden=t,o.authSubmit.textContent=n(t?"auth.signIn":"auth.createAccount"),o.loginTab.classList.toggle("active",t),o.registerTab.classList.toggle("active",!t),o.loginTab.setAttribute("aria-selected",String(t)),o.registerTab.setAttribute("aria-selected",String(!t)),y.clearErrors()},clearErrors(){document.querySelectorAll(".field-error").forEach(e=>{e.textContent=""}),o.authMessage.textContent="",o.authMessage.className="form-message"},setFieldError(e,t){const r=document.getElementById(`${e}Error`);r&&(r.textContent=t)},setLoading(e){P.authLoading=e,o.authSubmit.disabled=e,o.googleLoginButton&&(o.googleLoginButton.disabled=e),o.authSubmit.textContent=e?n("home.loading"):P.authMode==="login"?n("auth.signIn"):n("auth.createAccount")},setFirebaseLoading(e){P.authLoading=e,o.authSubmit.disabled=e,o.googleLoginButton&&(o.googleLoginButton.disabled=e,o.googleLoginButton.classList.toggle("loading",e))},async submit(e){e.preventDefault(),!P.authLoading&&(P.authMode==="login"?await y.submitLogin():await y.submitRegister())},async submitLogin(){y.clearErrors();const e=Y.validateLoginForm(o.loginEmail.value.trim(),o.loginPassword.value);if(e.errors.forEach(({field:r,messageKey:a})=>y.setFieldError(r,n(a))),!e.valid)return;y.setLoading(!0);const t=await Y.submitLogin({email:o.loginEmail.value.trim(),password:o.loginPassword.value});if(y.setLoading(!1),!t.success){o.authMessage.textContent=t.error,o.authMessage.className="form-message error";return}await y.finishLogin(t.response)},async submitRegister(){y.clearErrors();const e=Y.validateRegisterForm({fullName:o.registerFullName.value.trim(),email:o.registerEmail.value.trim(),phone:o.registerPhone.value.trim(),password:o.registerPassword.value,confirmPassword:o.registerConfirmPassword.value});if(e.errors.forEach(({field:r,messageKey:a})=>y.setFieldError(r,n(a))),!e.valid)return;y.setLoading(!0);const t=await Y.submitRegister({fullName:o.registerFullName.value.trim(),email:o.registerEmail.value.trim(),phone:o.registerPhone.value.trim(),password:o.registerPassword.value});if(y.setLoading(!1),!t.success){o.authMessage.textContent=t.error,o.authMessage.className="form-message error";return}o.authMessage.textContent="Registered. Endi login qiling.",o.authMessage.className="form-message success",y.setMode("login"),o.loginEmail.value=t.email},async submitFirebase(){if(P.authLoading)return;y.clearErrors(),y.setFirebaseLoading(!0);let e;try{e=await Zo()}catch(r){y.setFirebaseLoading(!1);const a=Y.mapFirebaseError((r==null?void 0:r.code)||"");if(a.cancelled)return;o.authMessage.textContent=a.message,o.authMessage.className="form-message error";return}const t=await Y.submitFirebaseLogin(e);if(y.setFirebaseLoading(!1),!t.success){o.authMessage.textContent=t.error,o.authMessage.className="form-message error";return}await y.finishLogin(t.response)},async finishLogin(e){var r,a,s,l,d,u;y.saveAuth(e),await y.validateOnStartup(),o.authDialog.close();const t=String(e.fullName||"").trim().split(/\s+/)[0]||"User";T(`Welcome, ${t}.`),await((a=(r=B.cart)==null?void 0:r.load)==null?void 0:a.call(r)),await((l=(s=B.favorites)==null?void 0:s.load)==null?void 0:l.call(s)),await((u=(d=B.notifications)==null?void 0:d.loadUnreadCount)==null?void 0:u.call(d)),y.preloadProfileData()}},ys=()=>$("/api/receivers",{requireAuth:!0,showError:!1}),bs=e=>$("/api/receivers",{method:"POST",body:JSON.stringify(e),requireAuth:!0}),ws=e=>$(`/api/receivers/${e}`,{method:"DELETE",requireAuth:!0}),ks=()=>$("/api/addresses",{requireAuth:!0,showError:!1}),Ss=e=>$("/api/addresses",{method:"POST",body:JSON.stringify(e),requireAuth:!0}),Cs=e=>$(`/api/addresses/${e}`,{method:"DELETE",requireAuth:!0}),ee={resolveSelectedId(e,t,r){var s,l;const a=t||r||((s=e[0])==null?void 0:s.id)||null;return e.some(d=>String(d.id)===String(a))?a:((l=e[0])==null?void 0:l.id)||null},async loadReceivers(e,t){const r=await ys();if(r===null)return{success:!1,error:h.lastApiError||"Receivers could not be loaded."};const a=M(r);return{success:!0,receivers:a,selectedReceiverId:this.resolveSelectedId(a,e,t)}},async loadAddresses(e,t){const r=await ks();if(r===null)return{success:!1,error:h.lastApiError||"Addresses could not be loaded."};const a=M(r);return{success:!0,addresses:a,selectedAddressId:this.resolveSelectedId(a,e,t)}},validateReceiverInput({firstName:e,lastName:t,phone:r}){return!e||!t||!r?{valid:!1,error:"First name, last name va phone majburiy."}:{valid:!0}},validateAddressInput({title:e,address:t,latitude:r,longitude:a}){return!e||!t||!Number.isFinite(r)||!Number.isFinite(a)?{valid:!1,error:"Title, address, latitude va longitude majburiy."}:{valid:!0}},async createReceiver(e){const t=await bs(e);return t===null?{success:!1,error:h.lastApiError}:{success:!0,receiver:t}},async createAddress(e){const t=await Ss(e);return t===null?{success:!1,error:h.lastApiError}:{success:!0,address:t}},async deleteReceiver(e){return{success:await ws(e)!==null}},async deleteAddress(e){return{success:await Cs(e)!==null}},validatePrepareCheckout(e){return e.length?{valid:!0}:{valid:!1,reason:"empty_selection"}},validateConfirmCheckout({selectedAddressId:e,selectedReceiverId:t}){return e?t?{valid:!0}:{valid:!1,reason:"receiver_required",openReceiverPicker:!0}:{valid:!1,reason:"address_required",openAddressPicker:!0}},calculateCheckoutTotals(e,t,r=0){return se.calculateCheckoutTotals(e,t,r)},buildOrderPayload({receiverId:e,addressId:t,cartItems:r}){const a=r.map(s=>Number(s.id)).filter(s=>Number.isFinite(s)&&s>0);return{receiverId:Number(e),addressId:Number(t),cartItemIds:a}},validateOrderItems(e){if(!e.length)return{valid:!1,reason:"no_items"};const t=e.map(r=>Number(r.id)).filter(r=>Number.isFinite(r)&&r>0);return t.length?{valid:!0,cartItemIds:t}:{valid:!1,reason:"invalid_items"}}};function $s(){return q.syncCartSelection(),ee.calculateCheckoutTotals(b.cartItems,b.cartSelectedIds,b.cartCouponDiscount||0)}function Ps(){const e=De(),t=new Date(Date.now()+3*864e5),r=new Date(Date.now()+5*864e5),a=s=>s.toLocaleDateString(e,{day:"numeric",month:"long"});return`${a(t)} – ${a(r)}`}function fa(){return q.getSelectedCartItems().slice(0,6).map(e=>{var r;const t=e.image||((r=e.product)==null?void 0:r.image)||S.placeholderImage;return`<img src="${i(t)}" alt="" class="app-checkout-item-thumb" loading="eager" decoding="async" />`}).join("")}function va(){return g.receivers.length?`<div class="selectable-list">${g.receivers.map(e=>`
  ...
  `).join("")}</div>`:'<div class="checkout-empty">No receivers yet. Add one below.</div>'}function ya(){return`
  ...
  `}function ba(){return g.addresses.length?`<div class="selectable-list">${g.addresses.map(e=>`
  ...
  `).join("")}</div>`:'<div class="checkout-empty">No addresses yet. Add one below.</div>'}function wa(){return`
  ...
  `}function Ca(e,t){const r=(e==null?void 0:e.fullName)||"—",a=(t==null?void 0:t.address)||"—";return`
  ...
  `}function Es(e,t){const r=e&&t&&b.cartItems.length&&!g.orderSubmitting;return`
  ...
  `}function Is(){const e=g.orderSuccess;o.checkoutContent.innerHTML=`
  ...
  `}function qr(){if(g.checkoutLoading){o.checkoutContent.innerHTML=`
    ...
    `;return}const e=g.receivers.find(l=>String(l.id)===String(g.selectedReceiverId)),t=g.addresses.find(l=>String(l.id)===String(g.selectedAddressId)),r=$s(),a=t?`${i(t.title||"")} · ${i(t.address||"")}`:i(n("checkout.addressNotSelected")),s=e?`${i(e.fullName||"")} · ${i(e.phone||"")}`:i(n("checkout.receiverNotSelected"));o.checkoutContent.innerHTML=`
    <div class="app-checkout-page">
      <header class="app-checkout-header">
      ...
      <div class="app-checkout-scroll">
        ...
        <section class="app-checkout-card app-checkout-delivery-items">
          <h3>${i(n("checkout.deliveryOn",{dates:Ps()}))}</h3>
          <div class="app-checkout-item-thumbs">${fa()}</div>
        </section>
      ...
      ${g.checkoutConfirmOpen?Ca(e,t):""}
      ${g.orderSuccess?$a():""}
    </div>
  `,ge(o.checkoutContent)}const j={render:qr,renderCheckout:qr,renderCheckoutCartThumbs:fa,renderCheckoutPickerList:Vt,renderCheckoutConfirmIllustration:ka,renderCheckoutSuccessIllustration:Sa,renderCheckoutConfirmModal:Ca,renderCheckoutSuccessModal:$a,renderReceiverList:va,renderReceiverForm:ya,renderAddressList:ba,renderAddressForm:wa,renderOrderSummary:Es,renderOrderSuccess:Is};let ve=null;const H={getAbortController(){return ve},abortOrder(){ve==null||ve.abort(),ve=null},async prepare({showLoginRequired:e}={}){if(!Y.isLoggedIn()){e==null||e();return}await K.load();const t=q.getSelectedCartItems();if(!ee.validatePrepareCheckout(t).valid){T(n("cart.emptySelection")||"Select items to checkout","warning");return}g.orderSuccess=null,g.checkoutError="",g.checkoutStep=1,g.checkoutAddressPickerOpen=!1,g.checkoutReceiverPickerOpen=!1,g.checkoutCouponOpen=!1,g.checkoutConfirmOpen=!1,g.checkoutLoading=!0,j.render(),we(),o.checkoutDialog.showModal(),_(),await Promise.all([H.loadReceivers(),H.loadAddresses()]),g.checkoutLoading=!1,j.render()},async loadReceivers(e){const t=await ee.loadReceivers(e,g.selectedReceiverId);if(!t.success){g.checkoutError=t.error;return}g.receivers=t.receivers,g.selectedReceiverId=t.selectedReceiverId},async loadAddresses(e){const t=await ee.loadAddresses(e,g.selectedAddressId);if(!t.success){g.checkoutError=t.error;return}g.addresses=t.addresses,g.selectedAddressId=t.selectedAddressId},getTotals(){return q.getCartTotals()},openConfirm(){if(!q.getSelectedCartItems().length)return;const t=ee.validateConfirmCheckout({selectedAddressId:g.selectedAddressId,selectedReceiverId:g.selectedReceiverId});if(!t.valid){t.reason==="address_required"?(g.checkoutError=n("checkout.addressRequired"),g.checkoutAddressPickerOpen=!0):t.reason==="receiver_required"&&(g.checkoutError=n("checkout.receiverRequired"),g.checkoutReceiverPickerOpen=!0),g.checkoutConfirmOpen=!1,j.render();return}g.checkoutError="",g.checkoutConfirmOpen=!0,j.render()},async submitOrder(){var r;if(g.orderSubmitting)return;const e=q.getSelectedCartItems(),t=ee.validateOrderItems(e);if(!t.valid){g.checkoutError=t.reason==="invalid_items"?n("checkout.invalidItems"):n("checkout.noItems"),j.render();return}H.abortOrder(),ve=new AbortController,g.orderSubmitting=!0,g.checkoutError="",j.render();try{const a=ee.buildOrderPayload({receiverId:g.selectedReceiverId,addressId:g.selectedAddressId,cartItems:e}),s=await le.createOrder(a,{signal:ve.signal});if(!s.success){g.checkoutError=s.error||n("checkout.orderFailed"),T(g.checkoutError,"error");return}H.finishAndGoHome(),T(n("checkout.orderCreated"),"success"),K.load().then(()=>q.render())}catch(a){g.checkoutError=(a==null?void 0:a.message)||n("checkout.orderFailed"),T(g.checkoutError,"error")}finally{g.orderSubmitting=!1,ve=null,(r=o.checkoutDialog)!=null&&r.open&&j.render()}},finishAndGoHome(){var e,t;try{g.checkoutConfirmOpen=!1,g.orderSuccess=null,g.checkoutError="",(e=o.checkoutDialog)==null||e.close(),we(),O(),Se(),window.location.hash&&window.location.hash!=="#/"&&window.location.hash!=="#"&&(window.location.hash="#/"),window.scrollTo({top:0,behavior:"smooth"})}catch(r){console.error("finishAndGoHome failed:",r),g.checkoutConfirmOpen=!1,g.orderSubmitting=!1,(t=o.checkoutDialog)==null||t.close(),O()}},async createReceiver(){var d,u,p;const e=(d=document.getElementById("receiverFirstName"))==null?void 0:d.value.trim(),t=(u=document.getElementById("receiverLastName"))==null?void 0:u.value.trim(),r=(p=document.getElementById("receiverPhone"))==null?void 0:p.value.trim(),a=document.getElementById("receiverFormError"),s=ee.validateReceiverInput({firstName:e,lastName:t,phone:r});if(!s.valid){a&&(a.textContent=s.error);return}const l=await ee.createReceiver({firstName:e,lastName:t,phone:r});l.success&&(await H.loadReceivers(l.receiver.id),j.render(),T("Receiver added"))},async createAddress(){var u,p,m,f;const e=(u=document.getElementById("addressTitle"))==null?void 0:u.value.trim(),t=(p=document.getElementById("addressText"))==null?void 0:p.value.trim(),r=Number((m=document.getElementById("addressLatitude"))==null?void 0:m.value),a=Number((f=document.getElementById("addressLongitude"))==null?void 0:f.value),s=document.getElementById("addressFormError"),l=ee.validateAddressInput({title:e,address:t,latitude:r,longitude:a});if(!l.valid){s&&(s.textContent=l.error);return}const d=await ee.createAddress({title:e,address:t,latitude:r,longitude:a});d.success&&(await H.loadAddresses(d.address.id),j.render(),T("Address added"))},async deleteReceiver(e){(await ee.deleteReceiver(e)).success&&(String(g.selectedReceiverId)===String(e)&&(g.selectedReceiverId=null),await H.loadReceivers(),j.render())},async deleteAddress(e){(await ee.deleteAddress(e)).success&&(String(g.selectedAddressId)===String(e)&&(g.selectedAddressId=null),await H.loadAddresses(),j.render())},applyCoupon(e){const t=se.applyCoupon(e,q.getCartTotals().subtotal);t.valid?(b.cartCoupon=t.coupon,b.cartCouponDiscount=t.discount,T(n("cart.couponApplied"),"success")):t.invalid&&T(n("cart.couponInvalid"),"warning"),j.render(),q.render()}},As=()=>$("/api/favorites",{requireAuth:!0,showError:!1}),Ls=e=>$(`/api/favorites/${e}/toggle`,{method:"POST",requireAuth:!0}),Pa={async loadFavorites(){const e=await As();return e===null?be("Favorites could not be loaded."):{success:!0,products:M(e).map(mi)}},async toggle(e,t){const r=await Ls(e);return r===null?null:{isFavorite:typeof r=="object"&&"favorite"in r?!!r.favorite:!t,response:r}}};function Ts({product:e,categoryLabel:t="",favoritesTitle:r="Favorites"}){const a=w(e.ratingAvg),s=w(e.reviewCount);return`
  ...
  `}function Ds({products:e,renderCard:t}){return`
    <div class="app-favorites-grid">
      ${e.map(r=>t(r)).join("")}
    </div>
  `}function Rs({count:e=4}){return`
    <div class="app-favorites-grid">
  ...
  `}function Ye(e={}){var t;return!!(e.render||(t=o.favoritesDialog)!=null&&t.open)}const G={updateUi(){o.favoritesCount&&(o.favoritesCount.textContent=C.favoritesCount),o.favoritesSummary&&(o.favoritesSummary.textContent=`${C.favoritesCount} product${C.favoritesCount===1?"":"s"}`)},renderShell(e){return`
    ...
    `},renderCard(e){const t=e.category?de(e.category):e.brand||"";return Ts({product:e,categoryLabel:t,favoritesTitle:n("favorites.title")})},render(){if(o.favoritesContent){if(G.updateUi(),C.favoritesLoading){o.favoritesContent.innerHTML=G.renderShell(Rs());return}if(C.favoritesError){o.favoritesContent.innerHTML=G.renderShell(`
      ...
      `);return}o.favoritesContent.innerHTML=G.renderShell(Ds({products:C.favoriteProducts,renderCard:e=>G.renderCard(e)})),ge(o.favoritesContent)}},async load(e={},{isLoggedIn:t,onSessionExpired:r}={}){const{render:a=!1}=e;if(!(t!=null&&t())){Ot();return}C.favoritesLoading=!0,C.favoritesError="",Ye(e)&&G.render();try{const s=await Pa.loadFavorites();if(C.favoritesLoading=!1,!s.success){if(s.sessionExpired){Ot(),r==null||r(),Ye(e)&&G.render();return}C.favoritesError=s.error,G.updateUi(),Ye(e)&&G.render();return}go(s.products),c.products.length&&Q(o.grid,c.products,"Mahsulot topilmadi."),c.todayDeals.length&&Q(o.dealsGrid,c.todayDeals.slice(0,8),"Bugungi takliflar topilmadi."),Ye(e)&&G.render()}catch(s){console.error("[LOAD FAVORITES FAILED]",s),C.favoritesLoading=!1,C.favoritesError="Favorites could not be loaded.",G.updateUi(),Ye(e)&&G.render()}},handleClick(e,{close:t,reload:r,handleProductGridClick:a}={}){var s;if(e.target.closest("[data-favorites-close]")){t==null||t();return}if(e.target.closest("[data-favorites-retry]")){r==null||r();return}if(e.target.closest("[data-favorites-start]")){t==null||t(),(s=document.getElementById("products"))==null||s.scrollIntoView({behavior:"smooth",block:"start"});return}a==null||a(e)}},J={findKnownProduct(e){return[...c.products,...c.todayDeals,...C.favoriteProducts,c.selectedDetailProduct].filter(Boolean).find(t=>String(t.id)===String(e))},async open(){if(!y.isLoggedIn()){y.showLoginRequired();return}o.favoritesDialog.open||o.favoritesDialog.show(),_(),fe(),await J.load({render:!0})},close(){o.favoritesDialog.close(),O(),fe()},async load(e={}){return G.load(e,{isLoggedIn:y.isLoggedIn,onSessionExpired:()=>{o.favoritesDialog.open&&o.favoritesDialog.close()}})},updateUi(){G.updateUi()},async toggle(e){var d;if(!y.isLoggedIn()){y.showLoginRequired();return}const t=C.favoriteIds.has(String(e)),r=await Pa.toggle(e,t);if(r===null)return;const{isFavorite:a}=r,s=J.findKnownProduct(e);if(a){const u=s?{...s,favorite:!0}:null;u&&!C.favoriteProducts.some(p=>String(p.id)===String(e))&&(C.favoriteProducts=[u,...C.favoriteProducts])}else C.favoriteProducts=C.favoriteProducts.filter(u=>String(u.id)!==String(e));C.favoriteIds=new Set(C.favoriteProducts.map(u=>String(u.id))),C.favoritesCount=C.favoriteProducts.length,he(),J.updateUi(),c.products.length&&Q(o.grid,c.products,"Mahsulot topilmadi."),c.todayDeals.length&&Q(o.dealsGrid,c.todayDeals.slice(0,8),"Bugungi takliflar topilmadi."),((d=c.selectedDetailProduct)==null?void 0:d.id)!==void 0&&String(c.selectedDetailProduct.id)===String(e)&&A.renderProductDetail(c.selectedDetailProduct),o.favoritesDialog.open&&G.render();const l=document.querySelector(`[data-favorite="${e}"]`);l&&a&&os(l),T(n(a?"favorites.added":"favorites.removed"),"success"),a&&!s&&await J.load({render:o.favoritesDialog.open})}},Ms=()=>$("/api/notifications",{requireAuth:!0,showError:!1}),qs=()=>$("/api/notifications/unread-count",{requireAuth:!0,showError:!1}),Bs=e=>$(`/api/notifications/${e}/read`,{method:"POST",requireAuth:!0,showError:!1}),Os=e=>$("/api/notifications/token",{method:"POST",body:JSON.stringify({token:e}),requireAuth:!0}),Kt={async loadNotifications(){const e=await Ms();return e===null?be("Notifications could not be loaded."):{success:!0,notifications:yi(e).map(gi).filter(t=>t.id!==void 0)}},async loadUnreadCount(){const e=await qs();return e===null?{success:!1,sessionExpired:zt()}:{success:!0,count:vi(e)}},async markRead(e){return await Bs(e)===null?{success:!1,sessionExpired:zt()}:{success:!0}},async saveToken(e){const t=String(e||"").trim();if(!t)return{success:!1,error:"empty"};const r=await Os(t);return{success:r!==null,result:r}}};function xs({notification:e,updating:t=!1,labels:r={}}){const{unreadLabel:a="Unread",readLabel:s="Read",savingLabel:l="Saving...",markReadLabel:d="Mark read",typeLabel:u="",typeIcon:p="i"}=r;return`
  ...
  `}function Ns(e){return{ORDER:"O",PROMO:"%",SYSTEM:"i"}[e]||"i"}function Fs({itemsHtml:e=""}){return`
  ...
  `}const W={clearState({closeDrawer:e}={}){var t;D.notifications=[],D.notificationsLoading=!1,D.notificationsError="",D.unreadCount=0,D.unreadCountLoading=!1,D.notificationUpdatingIds=new Set,W.updateBadge(),(t=o.notificationsDrawer)!=null&&t.classList.contains("open")&&(e==null||e())},updateBadge(){o.notificationsCount.textContent=D.unreadCount,o.notificationsCount.hidden=D.unreadCount<=0,o.notificationsSummary.textContent=`${D.unreadCount} ${n("notifications.unread")}`},renderCard(e){return xs({notification:e,updating:D.notificationUpdatingIds.has(String(e.id)),labels:{unreadLabel:n("notifications.unread"),readLabel:n("notifications.read"),savingLabel:n("common.saving"),markReadLabel:n("notifications.markRead"),typeLabel:fi(e.type),typeIcon:Ns(e.type)}})},render(){if(W.updateBadge(),D.notificationsLoading){o.notificationsContent.innerHTML=zs();return}if(D.notificationsError){o.notificationsContent.innerHTML=Or({title:n("notifications.title"),message:D.notificationsError,retryLabel:n("common.tryAgain")});return}if(!D.notifications.length){o.notificationsContent.innerHTML=Or({title:n("notifications.none"),message:"Order, promo and system updates will appear here."});return}o.notificationsContent.innerHTML=Fs({itemsHtml:D.notifications.map(e=>W.renderCard(e)).join("")})},async loadUnreadCount({isLoggedIn:e,onSessionExpired:t}={}){if(!(e!=null&&e())){W.clearState();return}D.unreadCountLoading=!0;const r=await Kt.loadUnreadCount();if(D.unreadCountLoading=!1,!r.success){if(r.sessionExpired){W.clearState({closeDrawer:t});return}W.updateBadge();return}D.unreadCount=r.count,W.updateBadge()},async load({isLoggedIn:e,showLoginRequired:t,onSessionExpired:r}={}){if(!(e!=null&&e())){t==null||t();return}D.notificationsLoading=!0,D.notificationsError="",W.render();const a=await Kt.loadNotifications();if(D.notificationsLoading=!1,!a.success){if(a.sessionExpired){W.clearState({closeDrawer:r});return}D.notificationsError=a.error,W.render();return}D.notifications=a.notifications,W.render()}};function Hs({statusLabel:e,statusModifier:t}){return`
    <span class="app-orders-status app-orders-status--${t}">
      ${i(e)}
    </span>
  `}function Us({items:e=[]}){return e.length?e.slice(0,6).map(t=>`
    <img
      ...
      decoding="async"
    />
  `).join(""):'<span class="app-orders-thumb app-orders-thumb--empty" aria-hidden="true"></span>'}function Vs({order:e,statusBadgeHtml:t,thumbsHtml:r,orderLabel:a,itemsCountLabel:s,itemsLabel:l,totalLabel:d,addressLabel:u,viewDetailsLabel:p,lineCount:m,itemCount:f}){const k=e.createdAt?String(e.createdAt):"";return`
    <article class="app-orders-card">
      ...
      <div class="app-orders-card-total">
        <span>${i(d)}</span>
        <strong>${Zr(e.totalAmount)}</strong>
      </div>
  ...
  `}const Gt=[{key:"NEW",icon:"clock"},{key:"CONFIRMED",icon:"check"},{key:"PACKED",icon:"box"},{key:"SHIPPED",icon:"truck"},{key:"DELIVERED",icon:"car"}];function Ks(e){const t={clock:'<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>',check:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 12 4 4 10-10"/></svg>',box:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3 4 7v10l8 4 8-4V7z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>',truck:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 7h11v8H3z"/><path d="M14 10h4l3 3v2h-7z"/><circle cx="7.5" cy="17.5" r="1.5"/><circle cx="17.5" cy="17.5" r="1.5"/></svg>',car:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 11h14l-1-4H6z"/><path d="M4 16h16v3H4z"/><circle cx="7.5" cy="16.5" r="1.5"/><circle cx="16.5" cy="16.5" r="1.5"/></svg>'};return t[e]||t.clock}function Gs(e=""){const t=String(e||"").toUpperCase();if(t==="PENDING")return 0;const r=Gt.findIndex(a=>a.key===t);return r>=0?r:0}function js({status:e="",statusLabelFor:t}){const r=Gs(e),a=["CANCELED","CANCELLED"].includes(String(e||"").toUpperCase());return`
    <div class="app-orders-stepper ${a?"is-canceled":""}">
      ${Gt.map((s,l)=>{const d=Gt.length-1,u=!a&&r===d;return`
          <div class="app-orders-step ${!a&&(l<r||u&&l<=r)?"is-done":!a&&l===r&&!u?"is-active":""}">
            <span class="app-orders-step-icon">${Ks(s.icon)}</span>
            <span class="app-orders-step-label">${i(t(s.key))}</span>
          </div>
        `}).join("")}
    </div>
  `}function Ws({item:e}){return`
  ...
  `}function Ys({lineCount:e,itemCount:t,totalAmount:r,goodsLabel:a,totalAmountLabel:s}){return`
  ...
  `}function _s({status:e="NEW"}){const t=String(e||"NEW").toUpperCase();return`
    <span class="app-orders-detail-status-pill">
      <svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
      ${i(t)}
    </span>
  `}function Js(e=""){const r=`orders.statusMessage.${String(e||"").toUpperCase()}`,a=n(r);return a!==r?a:n("orders.statusMessage.default")}function Qs(e={}){const t=Number(e.latitude??e.addressLatitude),r=Number(e.longitude??e.addressLongitude);if(Number.isFinite(t)&&Number.isFinite(r))return`https://www.google.com/maps/search/?api=1&query=${t},${r}`;const a=encodeURIComponent(e.address||"");return a?`https://www.google.com/maps/search/?api=1&query=${a}`:""}const Zs={render({renderHeader:e,renderOrderCard:t}={}){if(h.orderDetailLoading)return`
      ...
      `;const r=h.selectedOrder,a=Array.isArray(r.items)?r.items.map(u=>Qt({...u,orderId:r.id})):[],s=le.getLineCount(r),l=le.getItemCount(r),d=Qs(r);return`
      <div class="app-orders-page">
        ...
        <div class="app-orders-scroll app-orders-detail">
          <article class="app-orders-detail-hero">
            <div class="app-orders-detail-hero-top">
              <div>
                ...
                <p class="app-orders-detail-date">${i($i(r.createdAt))}</p>
              </div>
              ${_s({status:r.status})}
            </div>
            ${js({status:r.status,statusLabelFor:da})}
            ${Ys({lineCount:n("orders.itemsCount",{count:s||l}),itemCount:l,totalAmount:r.totalAmount,goodsLabel:n("orders.goodsLabel"),totalAmountLabel:n("orders.totalAmount")})}
          </article>
          ...
          <section class="app-orders-detail-section">
            ...
            ${a.length?a.map(u=>Ws({item:u})).join(""):`<p class="app-orders-detail-muted">${i(n("orders.noItems"))}</p>`}
          </section>

          <section class="app-orders-detail-section">
            <h4>${i(n("orders.orderActions"))}</h4>
            <p class="app-orders-detail-muted">${i(Js(r.status))}</p>
          </section>
    ...
    `}};function Xs(){return'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m15 6-6 6 6 6"/></svg>'}function Be(e,t){return`
  ...
  `}function en(e=""){return Hs({statusLabel:ua(e),statusModifier:le.orderStatusModifier(e)})}function tn(e={}){const t=(Array.isArray(e.items)?e.items:[]).map(r=>Qt({...r,orderId:e.id}));return Us({items:t})}function Rt(e){const t=le.getItemCount(e),r=le.getLineCount(e);return Vs({order:e,statusBadgeHtml:en(e.status),thumbsHtml:tn(e),orderLabel:n("orders.order"),itemsCountLabel:n("orders.itemsCount",{count:r}),itemsLabel:n("orders.items",{count:t}),totalLabel:n("orders.totalLabel"),addressLabel:n("orders.addressLabel"),viewDetailsLabel:n("orders.viewDetails"),lineCount:r,itemCount:t})}const ae={renderHeader:Be,renderOrderCard:Rt,render(){if(h.ordersLoading){o.ordersContent.innerHTML=`
        <div class="app-orders-page">
      ...
      `;return}if(h.orderDetailLoading||h.selectedOrder||h.orderDetailError){o.ordersContent.innerHTML=Zs.render({renderHeader:Be,renderOrderCard:Rt});return}o.ordersContent.innerHTML=`
      <div class="app-orders-page">
        ${Be(n("orders.title"),"close")}
        <div class="app-orders-scroll">
    ...
    `,ge(o.ordersContent)},async load({onSessionExpired:e}={}){h.ordersLoading=!0,h.ordersError="",h.selectedOrder=null,h.selectedOrderHistory=[],h.orderHistoryWarning="",ae.render();const t=await le.loadOrders();if(h.ordersLoading=!1,!t.success){if(t.sessionExpired){e==null||e();return}h.ordersError=t.error,ae.render();return}h.orders=t.orders,ae.render()},async openDetail(e){h.orderDetailLoading=!0,h.orderDetailError="",h.orderHistoryWarning="",ae.render();const t=await le.loadOrderDetail(e);if(h.orderDetailLoading=!1,!t.success){h.orderDetailError=t.error,ae.render();return}h.selectedOrder=t.order,h.selectedOrderHistory=t.history,h.orderHistoryWarning=t.historyWarning,ae.render()}},z={clearState(){W.clearState({closeDrawer:z.close})},async loadUnreadCount(){return W.loadUnreadCount({isLoggedIn:y.isLoggedIn,onSessionExpired:z.close})},async open(){if(!y.isLoggedIn()){y.showLoginRequired();return}o.notificationsDrawer.classList.add("open"),o.notificationsDrawer.setAttribute("aria-hidden","false"),_(),await Promise.all([z.load(),z.loadUnreadCount()])},close(){o.notificationsDrawer.classList.remove("open"),o.notificationsDrawer.setAttribute("aria-hidden","true"),O()},async load(){return W.load({isLoggedIn:y.isLoggedIn,showLoginRequired:y.showLoginRequired,onSessionExpired:z.close})},async markRead(e,t={}){const r=D.notifications.find(s=>String(s.id)===String(e));if(!r||r.read)return!0;D.notificationUpdatingIds.add(String(e)),W.render();const a=await Kt.markRead(e);return D.notificationUpdatingIds.delete(String(e)),a.success?(r.read=!0,D.notifications=D.notifications.map(s=>String(s.id)===String(e)?{...s,read:!0}:s),D.unreadCount=Math.max(0,D.unreadCount-1),W.render(),await z.loadUnreadCount(),t.silent||T("Marked as read"),!0):a.sessionExpired?(z.clearState(),!1):(T(h.lastApiError||"Notification could not be updated."),W.render(),!1)},async handleCardClick(e){var r,a;const t=D.notifications.find(s=>String(s.id)===String(e));t&&(t.read||await z.markRead(e,{silent:!0}),t.type==="ORDER"&&t.refId&&(z.close(),await((a=(r=B.orders)==null?void 0:r.show)==null?void 0:a.call(r)),await ae.openDetail(t.refId)))}},Ae={async show(){if(!y.isLoggedIn()){y.showLoginRequired();return}o.ordersDialog.showModal(),_(),await Ae.load()},async load(){return ae.load({onSessionExpired:()=>o.ordersDialog.close()})},handleClick(e){var p,m,f,k,I,v,R;const t=e.target.closest("[data-orders-close]"),r=e.target.closest("[data-orders-back]"),a=e.target.closest("[data-order-detail]"),s=e.target.closest("[data-orders-retry]"),l=e.target.closest("[data-orders-start-shopping]"),d=e.target.closest("[data-order-write-review]"),u=e.target.closest("[data-order-feedback]");if(t){o.ordersDialog.close(),(m=(p=B.navigation)==null?void 0:p.unlockBodyIfNoOverlay)==null||m.call(p);return}if(r){h.selectedOrder=null,h.selectedOrderHistory=[],h.orderDetailError="",h.orderHistoryWarning="",ae.render();return}if(d){(k=(f=B.reviews)==null?void 0:f.openWrite)==null||k.call(f,{productId:d.dataset.orderWriteReview,orderId:d.dataset.reviewOrder,productName:d.dataset.reviewName});return}if(u){(v=B.toast)==null||v.call(B,(I=B.i18n)==null?void 0:I.t("profile.comingSoon"),"info");return}if(a){ae.openDetail(a.dataset.orderDetail);return}if(s){Ae.load();return}l&&(o.ordersDialog.close(),(R=document.getElementById("products"))==null||R.scrollIntoView({behavior:"smooth",block:"start"}))}},Ea="beauty_skin_theme",Ia=["light","dark","system"];let _e=null;function rn(){return window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function an(e){document.documentElement.setAttribute("data-theme",e),document.documentElement.style.colorScheme=e,on(e)}function on(e){const t=document.getElementById("themeToggle");if(!t)return;const r=e==="dark";t.setAttribute("aria-label",r?"Switch to light mode":"Switch to dark mode"),t.setAttribute("title",r?"Light mode":"Dark mode")}function nr(){const e=localStorage.getItem(Ea);return Ia.includes(e)?e:"system"}function sn(e){Ia.includes(e)&&(localStorage.setItem(Ea,e),cr())}function nn(){const e=nr(),t=e==="light"?"dark":e==="dark"?"system":"light";return sn(t),t}function cr(){const e=nr(),t=e==="system"?rn():e;an(t)}function xr(){nr()==="system"&&cr()}function cn(){var e;cr(),_e=window.matchMedia("(prefers-color-scheme: dark)"),_e.addEventListener?_e.addEventListener("change",xr):_e.addListener&&_e.addListener(xr),(e=document.getElementById("themeToggle"))==null||e.addEventListener("click",()=>{const t=nn();return{light:"Light",dark:"Dark",system:"System"}[t]})}const lr="beauty_skin_search_history",Aa=8,ln=["SNAIL CREAM","COSRX","SUNSCREEN","LIP TINT","VITAMIN C","COLLAGEN","K-BEAUTY SET","MOISTURIZER"];let Nr=null,Ce=null;function La(){try{return JSON.parse(localStorage.getItem(lr)||"[]").slice(0,Aa)}catch{return[]}}function Ue(e){const t=String(e||"").trim();if(!t||t.length<2)return;const r=La().filter(a=>a.toLowerCase()!==t.toLowerCase());r.unshift(t),localStorage.setItem(lr,JSON.stringify(r.slice(0,Aa)))}function dn(){localStorage.removeItem(lr),jt("")}function Fr(e,t="query"){const r=t==="history"?'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 8v5l3 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>':'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m21 21-4.3-4.3m1.3-5.2a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0Z"/></svg>';return`<button class="search-chip" type="button" data-search-chip="${i(e)}" data-chip-type="${t}">${r}${i(e)}</button>`}async function un(e){if(!e||e.length<2)return[];const t=await qt(e,{page:0,size:6});return M(t).map(V)}function pn(e){return`
  ...
  `}async function jt(e=""){const t=document.getElementById("searchPanel");if(!t)return;const r=e.trim(),a=La();let s="";if(r.length>=2){s=`<div class="search-panel-section"><div class="search-panel-label">${i(n("search.results"))}</div><div class="search-results-list">${Array(3).fill('<div class="ds-skeleton" style="height:56px;margin-bottom:8px;border-radius:10px"></div>').join("")}</div></div>`,t.innerHTML=s,t.classList.add("open");const d=await un(r),u=t.querySelector(".search-results-list");u&&(u.innerHTML=d.length?d.map(pn).join(""):`<p class="hint" style="padding:8px">${i(n("search.noResults"))}</p>`);return}const l=[];l.push(`
  ...
  `),a.length&&l.push(`
    ...
    <div class="search-panel-section">
      ...
      <div class="search-chips">${ln.map(d=>Fr(d,"trending")).join("")}</div>
    </div>
  `),t.innerHTML=l.join("")}function Oe(){var e;(e=document.getElementById("searchPanel"))==null||e.classList.remove("open")}function mn({onSearch:e,onProductSelect:t}={}){var l,d;Ce=e;const r=document.getElementById("searchInput"),a=document.getElementById("searchPanel"),s=document.querySelector(".search-wrap");!r||!a||(r.addEventListener("focus",()=>{jt(r.value),a.classList.add("open")}),r.addEventListener("input",()=>{clearTimeout(Nr),Nr=setTimeout(()=>jt(r.value),S.searchDebounceMs)}),a.addEventListener("click",u=>{const p=u.target.closest("[data-search-chip]"),m=u.target.closest("[data-search-product]");if(u.target.closest("[data-clear-search-history]")){dn();return}if(p){r.value=p.dataset.searchChip,Ue(p.dataset.searchChip),Oe(),Ce==null||Ce(p.dataset.searchChip);return}m&&(Oe(),t==null||t(m.dataset.searchProduct))}),document.addEventListener("click",u=>{s!=null&&s.contains(u.target)||Oe()}),r.addEventListener("keydown",u=>{u.key==="Escape"&&(Oe(),r.blur())}),(l=document.querySelector(".search-voice"))==null||l.addEventListener("click",()=>{if(!("webkitSpeechRecognition"in window)&&!("SpeechRecognition"in window))return;const u=window.SpeechRecognition||window.webkitSpeechRecognition,p=new u;p.lang=document.documentElement.lang||"en-US",p.onresult=m=>{const f=m.results[0][0].transcript;r.value=f,Ue(f),Ce==null||Ce(f),Oe()},p.start()}),(d=document.querySelector(".search-image"))==null||d.addEventListener("click",()=>{const u=document.createElement("input");u.type="file",u.accept="image/*",u.addEventListener("change",()=>{var p;(p=u.files)!=null&&p[0]&&(r.placeholder=n("search.imagePlaceholder"))}),u.click()}))}const ue={async open(){if(!y.isLoggedIn()){y.showLoginRequired();return}P.profileEditing=!1,P.profileMenuOpen=!1,o.profileDrawer.classList.add("open"),o.profileDrawer.setAttribute("aria-hidden","false"),_(),fe(),re.render(),await ue.loadSnapshot()},close(){P.profileMenuOpen=!1,P.profileLoadSeq+=1,o.profileDrawer.classList.remove("open"),o.profileDrawer.setAttribute("aria-hidden","true"),O(),fe()},async loadSnapshot(){var e;return re.loadSnapshot({isLoggedIn:y.isLoggedIn,loadUnreadCount:(e=B.notifications)==null?void 0:e.loadUnreadCount,updateAuthUi:y.updateUi})},async handleAction(e){var t,r,a,s,l,d,u,p,m,f;return re.handleAction(e,{closeProfile:ue.close,showOrders:(t=B.orders)==null?void 0:t.show,openOrderDetail:ae.openDetail,clearAuth:y.clearAuth,showToast:T,openFavorites:(r=B.favorites)==null?void 0:r.open,openMyReviews:(a=B.reviews)==null?void 0:a.open,openNotifications:(s=B.notifications)==null?void 0:s.open,setLanguage:(l=B.i18n)==null?void 0:l.setLanguage,applyTranslations:(d=B.i18n)==null?void 0:d.applyTranslations,openPrivacy:(u=B.support)==null?void 0:u.openPrivacy,openTerms:(p=B.support)==null?void 0:p.openTerms,openSupport:(m=B.support)==null?void 0:m.open,prepareCheckout:(f=B.checkout)==null?void 0:f.prepare})},async submitEdit(e){var d,u,p;e.preventDefault();const t=P.user||{},r={id:t.id,email:t.email,fullName:(d=document.getElementById("profileFullName"))==null?void 0:d.value.trim(),phone:(u=document.getElementById("profilePhone"))==null?void 0:u.value.trim(),profileImage:(p=document.getElementById("profileImage"))==null?void 0:p.value.trim()},a=document.getElementById("profileMessage"),s=Pe.validateProfileUpdate(r);if(!s.valid){a&&(a.textContent=s.error,a.className="form-message error");return}const l=await Pe.updateProfile(r);if(!l.success){a&&(a.textContent=l.error,a.className="form-message error");return}l.user&&(P.user=l.user,localStorage.setItem(S.storageKeys.user,JSON.stringify(l.user))),P.profileEditing=!1,y.updateUi(),re.render(),T("Profile updated.")}},hn={async render(e,{showHomeView:t}={}){const r=e.trim();if(h.currentSearchQuery=r,h.currentGridScreen=r?"search":"home",h.currentRoute==="product"&&(window.location.hash="#/",t==null||t()),!r){c.selectedCategory="ALL",te.renderCategories(),o.title.textContent=n("home.popular"),await F.loadProducts();return}o.title.textContent=`"${r}" qidiruvi`,o.status.textContent=n("home.loading"),Ne(o.grid,10);const a=await ia.search(r);c.products=a,he(),ne(c.products,n("home.noProducts"),{screen:"search"}),o.status.textContent=""}},me={handleInput(e){clearTimeout(h.searchTimer),h.searchTimer=setTimeout(()=>{const t=e.target.value;me.search(t).catch(()=>{pe(o.grid,"Qidiruv vaqtida xatolik yuz berdi."),o.status.textContent=""}),t.trim().length>=2&&Ue(t)},S.searchDebounceMs)},async search(e){return hn.render(e,{showHomeView:Se})},handleCategoryClick(e){const t=e.target.closest("[data-category]");t&&(ct(),te.renderCategoryProducts(t.dataset.category,{showHomeView:Se}).catch(()=>{pe(o.grid,"Kategoriya mahsulotlari yuklanmadi."),o.status.textContent=""}),window.setTimeout(()=>{var r;(r=document.getElementById("products"))==null||r.scrollIntoView({behavior:"smooth",block:"start"})},0))}};async function $t(){if(c.compareIds=Ge(),oo(c.compareIds.length),!c.compareIds.length){c.compareProducts=[],Pr([],n);return}const e=c.compareIds.map(r=>J.findKnownProduct(r)).filter(Boolean),t=c.compareIds.filter(r=>!e.find(a=>String(a.id)===String(r)));if(t.length){const r=await ie.loadProductsByIds(t);c.compareProducts=[...e,...r].slice(0,Ve)}else c.compareProducts=e.slice(0,Ve);Pr(c.compareProducts,n)}async function Ta(e){const t=Oi(e);if(t.full){T(n("compare.full",{max:Ve}),"warning");return}c.compareIds=t.ids,await $t(),T(t.added?n("compare.added"):n("compare.removed"),"success")}function gn(){var e,t;(e=document.getElementById("compareDrawer"))==null||e.classList.add("open"),(t=document.getElementById("compareDrawer"))==null||t.setAttribute("aria-hidden","false"),_()}function fn(){var e,t;(e=document.getElementById("compareDrawer"))==null||e.classList.remove("open"),(t=document.getElementById("compareDrawer"))==null||t.setAttribute("aria-hidden","true"),O()}function vn(){var e;ra(c.compareProducts,n),(e=document.getElementById("compareDialog"))==null||e.showModal(),_()}function yn(){Ni(),$t(),ra(c.compareProducts,n)}function bn(e){xi(e),$t()}function wn(e,t,r){return K.add(e,t,r,{showLoginRequired:()=>y.showLoginRequired()})}function kn(e){if(e.key!=="Enter"&&e.key!==" ")return;const t=e.target.closest("[data-product]");if(!t)return;e.preventDefault();const r=t.dataset.product;r&&(st(r),Ie(r))}function ze(e){const t=e.target.closest("[data-show-all]"),r=e.target.closest("[data-favorite]"),a=e.target.closest("[data-add]"),s=e.target.closest("[data-detail]"),l=e.target.closest("[data-quick-view]"),d=e.target.closest("[data-compare]"),u=e.target.closest("[data-product]");if(t){e.stopPropagation(),F.load({loadCart:()=>K.load()});return}if(d){e.stopPropagation(),Ta(d.dataset.compare);return}if(l){e.stopPropagation(),st(l.dataset.quickView),Ie(l.dataset.quickView);return}if(r){e.stopPropagation(),J.toggle(r.dataset.favorite);return}if(a){e.stopPropagation(),wn(a.dataset.add,null,1);return}if(s){e.stopPropagation();const p=s.dataset.detail;if(!p)return;st(p),Ie(p);return}if(u&&!e.target.closest("button, a")){e.preventDefault(),e.stopPropagation();const p=u.dataset.product;if(!p)return;st(p),Ie(p)}}let zr=null;function Sn(){var l,d,u,p;cn(),ns(),cs(),ls(),mn({onSearch:m=>{o.searchInput.value=m,Ue(m),Oe(),me.search(m).catch(()=>{pe(o.grid,n("common.serverFailed")),o.status.textContent=""})},onProductSelect:m=>{Ue(o.searchInput.value),Ie(m)}});const e=o.megaMenu;e==null||e.addEventListener("click",m=>{var k;m.target.closest("[data-category]")&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"),(k=o.catalogButton)==null||k.setAttribute("aria-expanded","false"),me.handleCategoryClick(m))}),(l=o.popularSearchesChips)==null||l.addEventListener("click",m=>{const f=m.target.closest("[data-search-chip]");f&&(o.searchInput.value=f.dataset.searchChip,Ue(f.dataset.searchChip),me.search(f.dataset.searchChip).catch(()=>{}))}),(d=document.querySelector(".mobile-bottom-nav"))==null||d.addEventListener("click",m=>{var I,v,R,E;const f=m.target.closest("[data-mobile-action]");if(!f)return;const k=f.dataset.mobileAction;if(k==="home"){(I=o.cartDrawer)!=null&&I.classList.contains("open")&&we(),(v=o.favoritesDialog)!=null&&v.open&&J.close(),(R=o.profileDrawer)!=null&&R.classList.contains("open")&&ue.close(),window.location.hash&&window.location.hash!=="#/"&&window.location.hash!=="#"?window.location.hash="#/":Se(),window.scrollTo({top:0,behavior:"smooth"}),fe();return}(E=document.getElementById(k))==null||E.click()});const t=document.getElementById("mobileDrawer"),r=document.getElementById("mobileMenuToggle"),a=document.getElementById("closeMobileMenu");r==null||r.addEventListener("click",()=>{t==null||t.classList.add("open"),t==null||t.setAttribute("aria-hidden","false"),r.setAttribute("aria-expanded","true"),_()});const s=()=>{t==null||t.classList.remove("open"),t==null||t.setAttribute("aria-hidden","true"),r==null||r.setAttribute("aria-expanded","false"),O()};a==null||a.addEventListener("click",s),t==null||t.addEventListener("click",m=>{m.target===t&&s()}),(u=document.getElementById("mobileNavLinks"))==null||u.addEventListener("click",m=>{var I;const f=m.target.closest("[data-category]"),k=m.target.closest("[data-mobile-action]");if(f){s(),me.handleCategoryClick(m);return}k&&(s(),(I=document.getElementById(k.dataset.mobileAction))==null||I.click())}),(p=document.getElementById("currencySelect"))==null||p.addEventListener("change",m=>{T(`${n("header.currency")}: ${m.target.value}`,"info")}),document.addEventListener("click",m=>{const f=m.target.closest(".primary-button");f&&!f.disabled&&ds(m,f)}),Cn()}function Cn(){var e,t,r,a,s,l,d,u,p,m,f,k,I,v,R,E,N;if(Xi(),c.compareIds=Ge(),$t(),wt(n),!h.flashSaleEnd){const x=new Date;x.setHours(23,59,59,999),h.flashSaleEnd=x.getTime()}En(),(e=document.getElementById("sortSelect"))==null||e.addEventListener("change",x=>{c.filters.sort=x.target.value,$e(),ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen})}),(t=document.getElementById("gridViewBtn"))==null||t.addEventListener("click",()=>{c.filters.viewMode="grid",$e(),Bt(o.grid,"grid")}),(r=document.getElementById("listViewBtn"))==null||r.addEventListener("click",()=>{c.filters.viewMode="list",$e(),Bt(o.grid,"list")}),Hr(document.getElementById("filterSidebar")),Hr(document.getElementById("filterSheetContent")),(a=document.getElementById("mobileFilterBtn"))==null||a.addEventListener("click",()=>Ur("filterSheet")),(s=document.getElementById("mobileSortBtn"))==null||s.addEventListener("click",()=>{const x=document.getElementById("sortSheetOptions"),U={popular:n("sort.popular"),"price-asc":n("sort.priceAsc"),"price-desc":n("sort.priceDesc"),rating:n("sort.rating"),newest:n("sort.newest"),discount:n("sort.discount")};x&&(x.innerHTML=Object.entries(U).map(([X,rt])=>`
        <button class="mobile-nav-link" type="button" data-sort-option="${X}">${i(rt)}</button>
      `).join("")),Ur("sortSheet")}),(l=document.getElementById("closeFilterSheet"))==null||l.addEventListener("click",()=>Mt("filterSheet")),(d=document.getElementById("applyFilterSheet"))==null||d.addEventListener("click",()=>{Mt("filterSheet"),ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen})}),(u=document.getElementById("sortSheetOptions"))==null||u.addEventListener("click",x=>{const U=x.target.closest("[data-sort-option]");if(!U)return;c.filters.sort=U.dataset.sortOption;const X=document.getElementById("sortSelect");X&&(X.value=c.filters.sort),$e(),Mt("sortSheet"),ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen})}),(p=document.getElementById("filterChipsRow"))==null||p.addEventListener("click",x=>{const U=x.target.closest("[data-remove-chip]");U&&$n(U.dataset.removeChip)}),(m=document.getElementById("compareFab"))==null||m.addEventListener("click",gn),(f=document.getElementById("closeCompare"))==null||f.addEventListener("click",fn),(k=document.getElementById("openComparePage"))==null||k.addEventListener("click",vn),(I=document.getElementById("clearCompare"))==null||I.addEventListener("click",yn),(v=document.getElementById("compareDrawerContent"))==null||v.addEventListener("click",x=>{const U=x.target.closest("[data-remove-compare]");U&&bn(U.dataset.removeCompare)}),(R=document.getElementById("closePdpFullscreen"))==null||R.addEventListener("click",Vr),(E=document.getElementById("pdpFullscreen"))==null||E.addEventListener("click",x=>{x.target.id==="pdpFullscreen"&&Vr()}),(N=o.cartExtras)==null||N.addEventListener("click",In)}function Hr(e){e&&(e.addEventListener("click",t=>{var a;if(t.target.closest("[data-clear-filters]")){io(),wt(n),pt(n),ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen});return}const r=t.target.closest(".filter-group-toggle");r&&((a=r.closest(".filter-group"))==null||a.classList.toggle("collapsed"))}),e.addEventListener("change",t=>{const r=c.filters;if(t.target.matches("[data-filter-brand]")){const a=t.target.dataset.filterBrand;r.brands=t.target.checked?[...new Set([...r.brands,a])]:r.brands.filter(s=>s!==a)}if(t.target.matches("[data-filter-color]")){const a=t.target.dataset.filterColor;r.colors=t.target.checked?[...new Set([...r.colors,a])]:r.colors.filter(s=>s!==a)}if(t.target.matches("[data-filter-size]")){const a=t.target.dataset.filterSize;r.sizes=t.target.checked?[...new Set([...r.sizes,a])]:r.sizes.filter(s=>s!==a)}if(t.target.matches("[data-filter-origin]")){const a=t.target.dataset.filterOrigin;r.origin=t.target.checked?[...new Set([...r.origin,a])]:r.origin.filter(s=>s!==a)}if(t.target.matches("[data-filter-seller]")){const a=t.target.dataset.filterSeller;r.seller=t.target.checked?[...new Set([...r.seller,a])]:r.seller.filter(s=>s!==a)}t.target.matches("[data-filter-toggle]")&&(r[t.target.dataset.filterToggle]=t.target.checked),t.target.matches("[data-filter-rating]")&&(r.minRating=Number(t.target.value)),t.target.matches("[data-filter-price]")&&(r.maxPrice=Number(t.target.value)),$e(),pt(n),e.id!=="filterSheetContent"&&ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen})}))}function $n(e){const t=c.filters;e==="onSale"?t.onSale=!1:e==="inStock"?t.inStock=!1:e==="rating"?t.minRating=0:e.startsWith("brand:")?t.brands=t.brands.filter(r=>r!==e.slice(6)):e.startsWith("color:")?t.colors=t.colors.filter(r=>r!==e.slice(6)):e.startsWith("size:")&&(t.sizes=t.sizes.filter(r=>r!==e.slice(5))),$e(),wt(n),pt(n),ne(c.sourceProducts.length?c.sourceProducts:c.products,n("home.noProducts"),{screen:h.currentGridScreen})}function Ur(e){const t=document.getElementById(e);t==null||t.classList.add("open"),t==null||t.setAttribute("aria-hidden","false")}function Mt(e){var t,r;(t=document.getElementById(e))==null||t.classList.remove("open"),(r=document.getElementById(e))==null||r.setAttribute("aria-hidden","true")}function Pn(e){const t=document.getElementById("pdpFullscreenImg"),r=document.getElementById("pdpFullscreen");t&&r&&e&&(t.src=e,r.classList.add("open"),r.setAttribute("aria-hidden","false"))}function Vr(){var e,t;(e=document.getElementById("pdpFullscreen"))==null||e.classList.remove("open"),(t=document.getElementById("pdpFullscreen"))==null||t.setAttribute("aria-hidden","true")}function En(){if(zr!==null)return;const e=()=>{const t=document.querySelector("#todayDeals .flash-countdown-wrap");t&&h.flashSaleEnd&&(t.innerHTML=no(h.flashSaleEnd))};e(),zr=window.setInterval(e,1e3)}function In(e){if(e.target.closest("[data-apply-coupon]")){const r=document.getElementById("cartCouponInput"),a=((r==null?void 0:r.value)||"").trim(),s=se.applyCoupon(a,q.getCartTotals().subtotal);s.valid?(b.cartCoupon=s.coupon,b.cartCouponDiscount=s.discount,T(n("cart.couponApplied"),"success")):s.invalid&&T(n("cart.couponInvalid"),"warning"),q.render();return}const t=e.target.closest("[data-restore-saved]");if(t){_i(t.dataset.restoreSaved),T(n("cart.restored"),"info"),q.render();return}ze(e)}function An({item:e,starsHtml:t}){const r=e.review;return`
  ...
  `}function Ln({itemsHtml:e=""}){return`<div class="my-reviews-list">${e}</div>`}const ye={email:"ismoiljoraxonov1@gmail.com",phone:"+821065110757",phoneDisplay:"+82 10 6511 0757"},Tn=["delivery","cancel","return"];function Dn(e,t){const r=h.supportFaqOpen===t;return`
  ...
  `}function Kr(e){return`<ul class="app-support-doc-list">${e.map(t=>`<li>${i(n(t))}</li>`).join("")}</ul>`}const Re={render(){o.supportContent.innerHTML=`
      ...
      <div class="app-support-page">
        ...
        <div class="app-support-scroll">
          ...
          <section class="app-support-doc-section">
            ...
            ${Kr(["privacy.s1a","privacy.s1b","privacy.s1c","privacy.s1d"])}
          </section>

          <section class="app-support-doc-section">
            <h3>${i(n("privacy.s2title"))}</h3>
            <p>${i(n("privacy.s2intro"))}</p>
            ${Kr(["privacy.s2a","privacy.s2b","privacy.s2c","privacy.s2d"])}
          </section>
    ...
    `},handleClick(e,{close:t}={}){const r=e.target.closest("[data-support-faq]");if(e.target.closest("[data-support-close]")){t==null||t();return}if(r){const a=Number(r.dataset.supportFaq);h.supportFaqOpen=h.supportFaqOpen===a?-1:a,Re.render()}},handlePrivacyClick(e,{close:t}={}){e.target.closest("[data-privacy-close]")&&(t==null||t())},handleTermsClick(e,{close:t}={}){e.target.closest("[data-terms-close]")&&(t==null||t())}};function Rn(e,t,r){return K.add(e,t,r,{showLoginRequired:()=>y.showLoginRequired()})}function Mn(){return H.prepare({showLoginRequired:()=>y.showLoginRequired()})}function qn(){var e,t,r,a,s,l,d,u,p,m,f,k,I;(e=o.languageSelect)==null||e.addEventListener("change",v=>Jr(v.target.value)),o.searchForm.addEventListener("submit",v=>v.preventDefault()),o.searchInput.addEventListener("input",v=>me.handleInput(v)),o.categoryToolbar.addEventListener("click",v=>me.handleCategoryClick(v)),o.quickCategoryGrid.addEventListener("click",v=>me.handleCategoryClick(v)),o.catalogList.addEventListener("click",v=>me.handleCategoryClick(v)),o.banners.addEventListener("click",Bn),(t=o.homeView)==null||t.addEventListener("click",ze),(r=o.homeView)==null||r.addEventListener("keydown",kn),(a=o.brandViewContent)==null||a.addEventListener("click",ze),o.detailContent.addEventListener("click",Gr),o.productDetailPageContent.addEventListener("click",v=>{Gr(v)||ze(v)}),o.productDetailPageContent.addEventListener("input",v=>{v.target.matches("[data-review-search]")&&(c.reviewSearchQuery=v.target.value,A.renderProductDetail(c.selectedDetailProduct))}),o.productDetailPageContent.addEventListener("change",v=>{v.target.matches("[data-review-sort]")&&(c.reviewSort=v.target.value,A.renderProductDetail(c.selectedDetailProduct)),v.target.matches("[data-review-filter-rating]")&&(c.reviewFilterRating=Number(v.target.value),A.renderProductDetail(c.selectedDetailProduct))}),o.cartItems.addEventListener("click",xn),o.cartItems.addEventListener("change",On),o.catalogButton.addEventListener("click",gs),o.closeCatalog.addEventListener("click",ct),o.cartButton.addEventListener("click",hs),o.closeCart.addEventListener("click",we),o.loginButton.addEventListener("click",()=>{y.isLoggedIn()?ue.open():y.openDialog("login")}),o.favoritesButton.addEventListener("click",()=>J.open()),o.notificationsButton.addEventListener("click",()=>z.open()),o.apiButton.addEventListener("click",fs),o.loginTab.addEventListener("click",()=>y.setMode("login")),o.registerTab.addEventListener("click",()=>y.setMode("register")),o.authForm.addEventListener("submit",v=>y.submit(v)),(s=o.googleLoginButton)==null||s.addEventListener("click",()=>y.submitFirebase()),o.apiForm.addEventListener("submit",vs),o.checkoutButton.addEventListener("click",Mn),o.checkoutForm.addEventListener("submit",Nn),o.checkoutContent.addEventListener("click",Fn),o.checkoutContent.addEventListener("submit",zn),o.ordersContent.addEventListener("click",v=>Ae.handleClick(v)),o.refreshOrders.addEventListener("click",()=>Ae.load()),o.closeOrders.addEventListener("click",()=>o.ordersDialog.close()),o.favoritesContent.addEventListener("click",Hn),o.refreshFavorites.addEventListener("click",()=>J.load({render:!0})),o.closeFavorites.addEventListener("click",()=>J.close()),o.notificationsContent.addEventListener("click",Un),o.refreshNotifications.addEventListener("click",()=>{z.load(),z.loadUnreadCount()}),o.closeNotifications.addEventListener("click",()=>z.close()),o.myReviewsContent.addEventListener("click",tc),o.refreshMyReviews.addEventListener("click",Pt),o.closeMyReviews.addEventListener("click",dr),o.writeReviewForm.addEventListener("submit",ec),o.closeWriteReview.addEventListener("click",ft),o.reviewRatingSelector.addEventListener("click",rc),(l=o.closeProfile)==null||l.addEventListener("click",()=>ue.close()),o.profileContent.addEventListener("click",v=>{ze(v)||ue.handleAction(v)}),o.profileContent.addEventListener("submit",v=>ue.submitEdit(v)),o.ordersButton.addEventListener("click",()=>Ae.show()),(d=o.supportButton)==null||d.addEventListener("click",Da),(u=o.supportContent)==null||u.addEventListener("click",Kn),(p=o.supportDialog)==null||p.addEventListener("close",O),(m=o.privacyContent)==null||m.addEventListener("click",Wn),(f=o.privacyDialog)==null||f.addEventListener("close",O),(k=o.termsContent)==null||k.addEventListener("click",Jn),(I=o.termsDialog)==null||I.addEventListener("close",O),o.refreshHome.addEventListener("click",()=>F.load({loadCart:()=>K.load()})),o.loadMore.addEventListener("click",()=>te.loadMoreProducts()),window.addEventListener("hashchange",gt),o.catalogDrawer.addEventListener("click",v=>{v.target===o.catalogDrawer&&ct()}),o.cartDrawer.addEventListener("click",v=>{v.target===o.cartDrawer&&we()}),o.profileDrawer.addEventListener("click",v=>{v.target===o.profileDrawer&&ue.close()}),o.notificationsDrawer.addEventListener("click",v=>{v.target===o.notificationsDrawer&&z.close()}),document.addEventListener("keydown",v=>{v.key==="Escape"&&(ct(),we(),ue.close(),z.close(),o.ordersDialog.open&&o.ordersDialog.close(),o.favoritesDialog.open&&o.favoritesDialog.close(),o.myReviewsDialog.open&&o.myReviewsDialog.close(),o.writeReviewDialog.open&&o.writeReviewDialog.close())}),o.detailDialog.addEventListener("close",O),o.authDialog.addEventListener("close",O),o.apiDialog.addEventListener("close",O),o.checkoutDialog.addEventListener("close",()=>{H.abortOrder(),g.checkoutConfirmOpen=!1,g.orderSubmitting=!1,g.orderSuccess=null,g.checkoutError="",O()}),o.ordersDialog.addEventListener("close",O),o.favoritesDialog.addEventListener("close",()=>{O(),fe()}),o.myReviewsDialog.addEventListener("close",O),o.writeReviewDialog.addEventListener("close",O),document.querySelectorAll("[data-close-dialog]").forEach(v=>{v.addEventListener("click",()=>{var R;return(R=v.closest("dialog"))==null?void 0:R.close()})})}function Bn(e){const t=e.target.closest("[data-banner-dot]");if(t){F.scrollToBanner(Number(t.dataset.bannerDot)),F.resetBannerAutoSlide();return}const r=e.target.closest("[data-banner-nav]");if(r){r.dataset.bannerNav==="next"?F.nextBanner():F.prevBanner(),F.resetBannerAutoSlide();return}const a=e.target.closest("[data-banner-link-type]");if(!a)return;const s=a.dataset.bannerLinkType,l=a.dataset.bannerLinkId;if(s==="PRODUCT"&&l){Ie(l);return}if(s==="CATEGORY"&&l){const d=c.categories.find(u=>String(u)===String(l))||(Wr[l]?l:"");d?(Ut(),te.renderCategoryProducts(d,{showHomeView:Se})):T("Category banner is not available yet.","info")}}function Gr(e){const t=e.target.closest("[data-route-home]"),r=e.target.closest(".product-detail-page [data-category]"),a=e.target.closest("[data-brand]"),s=e.target.closest("[data-close-detail]"),l=e.target.closest("[data-variant]"),d=e.target.closest("[data-qty]"),u=e.target.closest("[data-detail-add]"),p=e.target.closest("[data-detail-favorite]"),m=e.target.closest("[data-compare]"),f=e.target.closest("[data-reviews-retry]"),k=e.target.closest("[data-pdp-thumb]"),I=e.target.closest("[data-pdp-tab]"),v=e.target.closest("[data-pdp-zoom]"),R=e.target.closest("[data-pdp-fullscreen]"),E=e.target.closest("[data-review-helpful]");if(t)return e.stopPropagation(),Ut(),!0;if(a&&a.dataset.brand)return e.stopPropagation(),window.location.hash=`#/brand/${encodeURIComponent(a.dataset.brand)}`,!0;if(r)return e.stopPropagation(),Ut(),te.renderCategoryProducts(r.dataset.category,{showHomeView:Se}),!0;if(s)return e.stopPropagation(),o.detailDialog.close(),O(),!0;if(k)return e.stopPropagation(),c.pdpGalleryIndex=Number(k.dataset.pdpThumb),A.renderProductDetail(c.selectedDetailProduct),!0;if(v)return e.stopPropagation(),v.classList.toggle("zoomed"),!0;if(R){e.stopPropagation();const N=document.getElementById("pdpMainImage");return Pn(N==null?void 0:N.src),!0}if(I)return e.stopPropagation(),c.pdpActiveTab=I.dataset.pdpTab,A.renderProductDetail(c.selectedDetailProduct),!0;if(m)return e.stopPropagation(),Ta(m.dataset.compare),!0;if(l)return e.stopPropagation(),c.selectedVariantId=l.dataset.variant,A.renderProductDetail(c.selectedDetailProduct),!0;if(d)return e.stopPropagation(),c.selectedQuantity=Math.max(1,c.selectedQuantity+(d.dataset.qty==="plus"?1:-1)),A.renderProductDetail(c.selectedDetailProduct),!0;if(p)return e.stopPropagation(),J.toggle(p.dataset.detailFavorite),!0;if(f)return e.stopPropagation(),He.loadReviews(f.dataset.reviewsRetry),!0;if(E){e.stopPropagation();const N=E.dataset.reviewHelpful;return c.reviewHelpfulIds.has(N)?c.reviewHelpfulIds.delete(N):c.reviewHelpfulIds.add(N),A.renderProductDetail(c.selectedDetailProduct),!0}if(u){e.stopPropagation();const N=document.getElementById("quantityInput");return c.selectedQuantity=Math.max(1,Number((N==null?void 0:N.value)||c.selectedQuantity)),Rn(c.selectedDetailProduct.id,c.selectedVariantId,c.selectedQuantity),!0}return!1}function On(e){const t=e.target;if(!t.matches("[data-cart-select-all], [data-cart-item-check]"))return;const r=q.getCartSelectedIds();if(t.matches("[data-cart-select-all]")){t.checked?b.cartItems.forEach(s=>r.add(String(s.id))):r.clear(),q.render();return}const a=String(t.dataset.cartItemCheck||"");a&&(t.checked?r.add(a):r.delete(a),q.render())}function xn(e){var u;const t=e.target.closest("[data-cart-retry]"),r=e.target.closest("[data-start-shopping]"),a=e.target.closest("[data-cart-qty]"),s=e.target.closest("[data-remove]"),l=e.target.closest("[data-save-later]"),d=e.target.closest("[data-cart-delete-selected]");if(t&&K.load(),r&&(we(),(u=document.getElementById("products"))==null||u.scrollIntoView({behavior:"smooth",block:"start"})),d&&!d.disabled){K.removeSelected();return}if(l){const p=b.cartItems.find(m=>String(m.id)===String(l.dataset.saveLater));p&&(Yi(p),K.removeItem(p.id));return}if(a){const p=b.cartItems.find(m=>String(m.id)===String(a.dataset.cartId));p&&K.updateQuantity(p.id,p.quantity+(a.dataset.cartQty==="plus"?1:-1))}s&&K.removeItem(s.dataset.remove)}function Nn(e){e.preventDefault(),H.openConfirm()}async function Fn(e){var x,U;const t=e.target.closest("[data-checkout-close]"),r=e.target.closest("[data-checkout-toggle-address]"),a=e.target.closest("[data-checkout-toggle-receiver]"),s=e.target.closest("[data-checkout-toggle-coupon]"),l=e.target.closest("[data-apply-coupon]"),d=e.target.closest("[data-select-receiver]"),u=e.target.closest("[data-select-address]"),p=e.target.closest("[data-delete-receiver]"),m=e.target.closest("[data-delete-address]"),f=e.target.closest("[data-place-order]"),k=e.target.closest("[data-checkout-confirm-cancel]"),I=e.target.closest("[data-checkout-confirm-submit]"),v=e.target.closest("[data-checkout-success-dismiss]"),R=e.target.closest("[data-checkout-success-card]"),E=e.target.closest("[data-success-orders]"),N=e.target.closest("[data-success-continue]");if(t){H.abortOrder(),g.checkoutConfirmOpen=!1,g.orderSubmitting=!1,g.orderSuccess=null,g.checkoutError="",o.checkoutDialog.close(),O();return}if(r){g.checkoutAddressPickerOpen=!g.checkoutAddressPickerOpen,g.checkoutError="",j.render();return}if(a){g.checkoutReceiverPickerOpen=!g.checkoutReceiverPickerOpen,g.checkoutError="",j.render();return}if(s){g.checkoutCouponOpen=!g.checkoutCouponOpen,j.render();return}if(l){const X=document.getElementById("checkoutCouponInput");H.applyCoupon(((X==null?void 0:X.value)||"").trim());return}if(p){e.stopPropagation(),await H.deleteReceiver(p.dataset.deleteReceiver);return}if(m){e.stopPropagation(),await H.deleteAddress(m.dataset.deleteAddress);return}if(d){g.selectedReceiverId=d.dataset.selectReceiver,g.checkoutReceiverPickerOpen=!1,g.checkoutError="",j.render();return}if(u){g.selectedAddressId=u.dataset.selectAddress,g.checkoutAddressPickerOpen=!1,g.checkoutError="",j.render();return}if(f){H.openConfirm();return}if(k){H.abortOrder(),g.checkoutConfirmOpen=!1,g.orderSubmitting=!1,g.checkoutError="",j.render();return}if(I){await H.submitOrder();return}if(v&&!R){H.finishAndGoHome(),(x=document.getElementById("products"))==null||x.scrollIntoView({behavior:"smooth",block:"start"});return}if(E){o.checkoutDialog.close(),await Ae.show();return}N&&(o.checkoutDialog.close(),we(),(U=document.getElementById("products"))==null||U.scrollIntoView({behavior:"smooth",block:"start"}))}async function zn(e){const t=e.target.closest("[data-add-receiver-form]"),r=e.target.closest("[data-add-address-form]");!t&&!r||(e.preventDefault(),t&&await H.createReceiver(),r&&await H.createAddress())}function Hn(e){G.handleClick(e,{close:()=>J.close(),reload:()=>J.load({render:!0}),handleProductGridClick:ze})}function Un(e){const t=e.target.closest("[data-notifications-retry]"),r=e.target.closest("[data-notification-read]"),a=e.target.closest("[data-notification-card]");if(t){z.load(),z.loadUnreadCount();return}if(r){e.stopPropagation(),z.markRead(r.dataset.notificationRead);return}a&&z.handleCardClick(a.dataset.notificationCard)}function Da(){h.supportFaqOpen=0,Re.render(),o.supportDialog.showModal(),_()}function Vn(){o.supportDialog.close(),O()}function Kn(e){Re.handleClick(e,{close:Vn})}function Gn(){Re.renderPrivacy(),o.privacyDialog.showModal(),_()}function jn(){o.privacyDialog.close(),O()}function Wn(e){Re.handlePrivacyClick(e,{close:jn})}function Yn(){Re.renderTerms(),o.termsDialog.showModal(),_()}function _n(){o.termsDialog.close(),O()}function Jn(e){Re.handleTermsClick(e,{close:_n})}async function Qn(){if(!y.isLoggedIn()){y.showLoginRequired();return}o.myReviewsDialog.showModal(),_(),await Pt()}async function Pt(){if(!y.isLoggedIn()){y.showLoginRequired();return}c.myReviewsLoading=!0,c.myReviewsError="",lt();const e=await ke.loadMyReviews();if(c.myReviewsLoading=!1,!e.success){if(e.sessionExpired){dr(),ft();return}c.myReviewsError=e.error,lt();return}c.myReviews=e.items,lt()}function lt(){if(o.myReviewsSummary.textContent=c.myReviews.length?`${c.myReviews.length} item${c.myReviews.length===1?"":"s"}`:"Purchased products and written reviews",c.myReviewsLoading){o.myReviewsContent.innerHTML=`
    ...
    `;return}o.myReviewsContent.innerHTML=Ln({itemsHtml:c.myReviews.map(e=>Zn(e)).join("")})}function Zn(e){var t;return An({item:e,starsHtml:(t=e.review)!=null&&t.rating?ma(e.review.rating):""})}function Ra(e={}){if(!y.isLoggedIn()){y.showLoginRequired();return}const t=e.productId,r=e.orderId;if(!t||!r){T("Product and order are required for review.");return}c.reviewDraft={productId:t,orderId:r,productName:e.productName||"Product"},c.reviewRating=5,o.writeReviewProduct.textContent=`${c.reviewDraft.productName} · Order #${r}`,o.reviewContent.value="",o.reviewImages.value="",o.reviewImageFiles.value="",o.reviewUploadStatus.textContent="",Qe(""),Ma(),o.writeReviewDialog.showModal(),_()}function Ma(){o.reviewRatingSelector.innerHTML=Array.from({length:5},(e,t)=>{const r=t+1;return`
      <button class="rating-choice ${r<=c.reviewRating?"active":""}" data-review-rating="${r}" type="button" aria-label="Rating ${r} out of 5">
        ★
      </button>
    `}).join("")}function dr(){o.myReviewsDialog.open&&o.myReviewsDialog.close(),O()}function ft(){o.writeReviewDialog.open&&o.writeReviewDialog.close(),O()}function Qe(e,t=""){o.reviewFormMessage.textContent=e,o.reviewFormMessage.className=`form-message ${t}`.trim()}async function Xn(e){return ke.uploadReviewImages(e,{onProgress:t=>{o.reviewUploadStatus.textContent=t}})}async function ec(e){var u;if(e.preventDefault(),c.reviewSubmitting)return;const t=c.reviewDraft||{},r=o.reviewContent.value.trim(),a=ke.validateSubmitReview({productId:t.productId,orderId:t.orderId,rating:c.reviewRating,content:r,manualImageUrlsText:o.reviewImages.value,files:o.reviewImageFiles.files});if(!a.valid){Qe(a.errors[0],"error");return}c.reviewSubmitting=!0,c.uploadingReviewImages=!!a.fileValidation.files.length,o.submitReviewButton.disabled=!0,o.submitReviewButton.textContent="Submitting...",Qe("");let s=[];try{s=a.fileValidation.files.length?await Xn(a.fileValidation.files):[]}catch(p){c.reviewSubmitting=!1,c.uploadingReviewImages=!1,o.submitReviewButton.disabled=!1,o.submitReviewButton.textContent="Submit review",Qe(p.message||"Image upload failed.","error");return}const l=[...s,...a.manualImageUrls].slice(0,5),d=await ke.submitReview({productId:t.productId,orderId:t.orderId,rating:c.reviewRating,content:r,imageUrls:l});if(c.reviewSubmitting=!1,c.uploadingReviewImages=!1,o.submitReviewButton.disabled=!1,o.submitReviewButton.textContent="Submit review",o.reviewUploadStatus.textContent="",!d.success){if(d.sessionExpired){dr(),ft();return}Qe(d.error,"error");return}T("Review submitted"),ft(),await Pt(),((u=c.selectedDetailProduct)==null?void 0:u.id)!==void 0&&String(c.selectedDetailProduct.id)===String(t.productId)&&await He.loadReviews(t.productId)}function tc(e){const t=e.target.closest("[data-my-reviews-retry]"),r=e.target.closest("[data-write-review]");if(t){Pt();return}r&&Ra({productId:r.dataset.writeReview,orderId:r.dataset.reviewOrder,productName:r.dataset.reviewName})}function rc(e){const t=e.target.closest("[data-review-rating]");t&&(c.reviewRating=Number(t.dataset.reviewRating),Ma())}function ac(){Jt(Wt()),te.renderCategories(),Fe(),h.currentRoute==="product"&&c.selectedDetailProduct?A.renderProductDetail(c.selectedDetailProduct):(Q(o.grid,c.products,n("home.noProducts"),{screen:h.currentGridScreen}),Q(o.dealsGrid,c.todayDeals.slice(0,8),n("home.noProducts")),c.homeApiSections&&F.renderHomeApiSections(c.homeApiSections)),o.cartDrawer.classList.contains("open")&&q.render(),o.profileDrawer.classList.contains("open")&&re.render(),o.favoritesDialog.open&&G.render(),o.ordersDialog.open&&ae.render(),o.notificationsDrawer.classList.contains("open")&&W.render(),o.myReviewsDialog.open&&lt(),y.updateUi()}async function ic(){if(!oe.getRecentProductIds().length){c.recentlyViewed=[];return}c.recentlyViewed=await oe.loadRecentlyViewed()}function oc(){Ci({cart:{load:()=>K.load(),render:()=>q.render()},favorites:{load:e=>J.load(e),open:()=>J.open(),updateUi:()=>J.updateUi()},notifications:{open:()=>z.open(),load:()=>z.load(),loadUnreadCount:()=>z.loadUnreadCount(),clearState:()=>z.clearState()},home:{ensureRecentlyViewed:ic},profile:{render:()=>re.render()},orders:{show:()=>Ae.show()},reviews:{open:Qn,openWrite:Ra},support:{open:Da,openPrivacy:Gn,openTerms:Yn},checkout:{prepare:()=>H.prepare({showLoginRequired:y.showLoginRequired})},i18n:{t:n,setLanguage:Jr,applyTranslations:()=>Jt(Wt())},navigation:{unlockBodyIfNoOverlay:O},toast:T})}async function sc(){oc(),ri(ac),Ya({onUnauthorized:()=>{y.clearAuth(),y.openDialog("login"),T(n("auth.sessionExpired"))},onLoginRequired:()=>y.showLoginRequired(),showToast:(e,t="error")=>T(e,t)});try{qn(),Sn(),Jt(Wt())}catch(e){console.error("Init event binding failed:",e),o.status.textContent=`UI ishga tushishda xatolik yuz berdi: ${e.message}`,T("UI ishga tushishda xatolik yuz berdi.");return}y.updateUi(),y.validateOnStartup().catch(e=>{console.error("Auth startup failed:",e)}),F.load({loadCart:()=>K.load()}).then(()=>gt()).catch(e=>{console.error("Home loading failed:",e),c.demoProducts=!1,c.demoDeals=!1,o.status.textContent="",o.dealsStatus.textContent="",pe(o.grid,n("common.serverFailed"),n("common.tryAgain")),Fe(),gt()})}function nc(){Ua(),Va(),h.baseUrl=vt(localStorage.getItem(S.storageKeys.baseUrl)||""),Ga(),ot()&&(console.assert(document.getElementById("productGrid"),"productGrid missing"),console.assert(document.getElementById("dealsGrid"),"dealsGrid missing"),console.assert(document.getElementById("productStatus"),"productStatus missing"),console.assert(document.getElementById("dealsStatus"),"dealsStatus missing"),console.assert(document.getElementById("quickCategoryGrid"),"quickCategoryGrid missing")),sc()}nc();
